...
namespace dnsDBUtil.Manager.DirectDB
{
    public class MySQLManager : DBManager
    {
        ...
        {
            return string.Format("Server={0};Database={1};Uid={2};Pwd={3};CharSet={4};", strDbHost, strDBName, strDbID, strDbPw, CharSet);
        }

        public static string[] RunQuery(string dbName, string query, MySQLManager transactionOwner, string strDbHost, string strDbID, string strDbPw)
        {
            string[] results = null;
        ...
        public static string[] RunStoredProcedure(string dbName, string procedureName, List<string> fieldNames, List<string> fieldValues, MySQLManager transactionOwner, string strDbHost, string strDbID, string strDbPw)
        {
            string[] results = null;
        ...
        public static MySQLManager BeginTransaction(string dbName, string strDbHost, string strDbID, string strDbPw, out string strErrorMessage)
        {
            strErrorMessage = "";
            string strConnection = GetConnectionString(dbName, strDbHost, strDbID, strDbPw);
