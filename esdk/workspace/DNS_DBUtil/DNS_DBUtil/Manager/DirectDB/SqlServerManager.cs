...
namespace dnsDBUtil.Manager.DirectDB
{
    public class SqlServerManager : DBManager
    {
        ...
        public static string[] RunQuery(string dbName, string query, SqlServerManager transactionOwner, string strDbHost, string strDbID, string strDbPw)
        {
            string[] results = null;
        ...
        public static string[] RunStoredProcedure(string dbName, string procedureName, List<string> fieldNames, List<string> fieldValues, SqlServerManager transactionOwner, string strDbHost, string strDbID, string strDbPw)
        {
            string[] results = null;
        ...
        public static SqlServerManager BeginTransaction(string dbName, string strDbHost, string strDbID, string strDbPw, out string strErrorMessage)
        {
            strErrorMessage = "";
            string strConnection = GetConnectionString(dbName, strDbHost, strDbID, strDbPw);
