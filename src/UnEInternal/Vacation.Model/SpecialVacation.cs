...
namespace Vacation.Model
{
    ...
    public class SpecialVacation : Table
    {
        public enum Fields { ID, MemberID, Days, CreateTime, ManagerIDs, RequestID, Description };
        public enum WriteFields { ID, MemberID, Days, CreateTime, ManagerIDs, RequestID, Description };
        ...
        public SpecialVacation Clone()
        {
            return (SpecialVacation)this.MemberwiseClone();
        }
    }
}
