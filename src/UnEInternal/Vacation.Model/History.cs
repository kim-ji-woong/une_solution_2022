...
namespace Vacation.Model
{
    ...
    public class History : Table
    {
        ...
        public enum WriteFields { MemberID, Year, TotalDays, UsedDays, WaitingDays, RequestIDs, NextVacationDay };
        ...
        private string m_strRequestIDs = "";
        ...
        {
            get { return m_strRequestIDs; }
            set { m_strRequestIDs = value; }
        }
        ...
        {
            return string.Format("MemberID = {0} and Year = {1}", MemberID, Year);
        }
