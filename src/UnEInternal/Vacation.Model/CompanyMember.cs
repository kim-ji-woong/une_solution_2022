...
{
    public class CompanyMember : Table, IComparable
    {
        public enum Fields { ID, Name, JobLevelID, StartDate, TeamID, IsTeamLeader, IsAdmin, UserID, UserPW, PasswordCode, PhoneNumber };
        public enum WriteFields { ID, Name, JobLevelID, StartDate, TeamID, IsTeamLeader, IsAdmin, UserID, UserPW, PasswordCode, PhoneNumber };
        ...
        {
            return (CompanyMember)this.MemberwiseClone();
        }
    }
}
