            ...
            <div className={styles.columnContents}>
                ...
                <div>
                {
                    this.state.selectedMember && this.state.selectedMemberHistory && (
                            <MyVacations loginUser={this.state.selectedMember} history={this.state.selectedMemberHistory} year={this.state.year} month={this.state.month} onChangeYear={this.onChangeYear} onChangeMonth={this.onChangeMonth} getNextYearHistory={this.props.getNextYearHistory} getLastYearHistory={this.props.getLastYearHistory} />
                )}
                </div>
            </div>
        );
