...
export class MyVacations extends Component {
    ...
    render() {
        ...
        const [usedDays, reservationDays, waitingDays, remainDays, svDays] = VacationManager.getHistoryData(history);
        ...
        return (
            ...
            {/* <div className={styles.divv}> */ }
                ...
                <Calendar fromTo={fromTo} year={this.props.year} month={this.props.month} vacations={history.usedVacations} onChangeYear={this.props.onChangeYear} onChangeMonth={this.onChangeMonth} />
            {/* </div> */}
            </>
        );
    }
