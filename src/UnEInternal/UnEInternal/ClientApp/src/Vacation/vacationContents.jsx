...
export class VacationContents extends Component {
    ...
    getContents() {
        if (this.props.selectedMenu === VacationMenus.MyVacations) {
            ...
            return <CompleteResponse loginUser={this.props.loginUser} onLogin={this.props.onLogin} onLogout={this.props.onLogout} options={this.props.options} managerRequest={this.props.managerRequest} membersHistory={this.props.membersHistory} />;
        }
            ...
            return <TeamVacations loginUser={this.props.loginUser} onLogin={this.props.onLogin} onLogout={this.props.onLogout} options={this.props.options} managerRequest={this.props.managerRequest} membersHistory={this.props.membersHistory} />;
        }
        else if (this.props.selectedMenu === VacationMenus.RequestSpecialHistory) {
            return <RequestSpecialVacation loginUser={this.props.loginUser} onLogin={this.props.onLogin} onLogout={this.props.onLogout} options={this.props.options} membersHistory={this.props.membersHistory} addVacationHistory={this.props.addVacationHistory} />;
        }
        else if (this.props.selectedMenu === VacationMenus.CancelHistory) {
            return <CancelVacation loginUser={this.props.loginUser} onLogin={this.props.onLogin} onLogout={this.props.onLogout} updateHistory={this.props.updateHistory} />;
        }
