...
export class Request extends Component {
    ...
    async showRequest() {
        ...
        const remainDays = VacationManager.getHistoryData(this.props.history)[3];
...
/*        const confirmBox = useMediaQuery({
        ...
        return (
            <div>
                ...
                <Calendar fromTo={fromTo} year={this.props.year} month={this.props.month} vacations={history.usedVacations} editable="true" onClickDay={this.onClickDay} onChangeYear={this.props.onChangeYear} onChangeMonth={this.props.onChangeMonth} />
