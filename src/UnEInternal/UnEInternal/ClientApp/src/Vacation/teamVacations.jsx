            ...
            <div className={styles.teamArea}> 
             ...
             <div className={styles.columnContents}>
                ...
                <div>
                {
                    ...
                    <TeamCalendar fromTo={fromTo} year={this.state.year} month={this.state.month} onChangeYear={this.onChangeYear} onChangeMonth={this.onChangeMonth} memberDatas={this.state.memberDatas} membersHistory={this.props.membersHistory} showReservation={this.state.showReservation} showUsed={this.state.showUsed} showWait={this.state.showWait} />
                )}
                </div>
             </div>
            </div>
