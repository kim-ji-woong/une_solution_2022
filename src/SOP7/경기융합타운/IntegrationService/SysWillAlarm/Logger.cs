...
namespace SysWillAlarm
{
    class Logger
    {
        ...
        public Logger(string strLogFolder)
        {
            m_strLogFolder = strLogFolder;
            m_strLogTag = "AlarmMonitor";
        ...
        public void Write(string strLog)
        {
            ...
            string strFilePath = m_strLogFolder.EndsWith("/") || m_strLogFolder.EndsWith("\\") ? m_strLogFolder : m_strLogFolder + "\\";
            strFilePath += string.Format("{0}{1:00}{2:00}.log", dtNow.Year, dtNow.Month, dtNow.Day);
