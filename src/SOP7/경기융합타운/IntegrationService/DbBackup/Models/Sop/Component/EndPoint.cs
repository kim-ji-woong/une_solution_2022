...
namespace DbBackup.Models.Sop.Component
{
	public class EndPoint : Table
	{
		...
		public enum WriteFields { ID, GridID, GridRowIndex, GridColumnIndex, width, height, text, ComponentID, isBegin, StepMemberID, valign, halign, FontName, FontStyle, FontSize, LineSpace, FontColor, SectionNumber };
		...
		public static string TableName { get { return "SopComponentEndPoint"; } }
