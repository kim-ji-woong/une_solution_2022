...
namespace DbBackup.Models.Sop.Component
{
	public class Decision : Table
	{
		...
		public enum WriteFields { ID, GridID, GridRowIndex, GridColumnIndex, width, height, text, TeamID, TeamType, ComponentID, StepMemberID, valign, halign, FontName, FontStyle, FontSize, LineSpace, FontColor, autoRunScript, autoRunScriptVariableTypes, SectionNumber, Description };
		...
		public string autoRunScriptVariableTypes { get; set; }
		public int? SectionNumber { get; set; }
		public string Description { get; set; }

		public static string TableName { get { return "SopComponentDecision"; } }
