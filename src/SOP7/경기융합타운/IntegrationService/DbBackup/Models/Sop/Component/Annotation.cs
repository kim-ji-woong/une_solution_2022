...
namespace DbBackup.Models.Sop.Component
{
	public class Annotation : Table
	{
		...
		public enum WriteFields { ID, GridID, GridRowIndex, GridColumnIndex, width, height, text, ComponentID, StepMemberID, valign, halign, FontName, FontStyle, FontSize, LineSpace, FontColor, SectionNumber };
		...
		public static string TableName { get { return "SopComponentAnnotation"; } }
