...
{
	public class InternalTransmission : Table
	{
		...
		public enum WriteFields { ID, GridID, GridRowIndex, GridColumnIndex, width, height, text, ComponentID, useSMS, useBroadcast, useEmail, StepMemberID, Message, TeamList, onlyTeamLeader, valign, halign, FontName, FontStyle, FontSize, LineSpace, FontColor, AutoRun, useSiren, SectionNumber };
		...
		public static string TableName { get { return "SopComponentInternalTransmission"; } }
