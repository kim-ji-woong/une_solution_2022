...
namespace CCTVMonitor
{
    ...
    class TrayManager
    {
        ...
        private NetworkManager m_netMgr = new NetworkManager();
        ...
        {
            string strPath;
            ConfigManager.Read(out strPath);
        }

        private void OnTimer(object sender, EventArgs e)
        {
            m_netMgr.CheckProcess();
        }
        ...
        private void CreateNotifyicon()
        {
            ...
            m_icon.Icon = global::CCTVMonitor.Resources.SDMS_BLUE;
