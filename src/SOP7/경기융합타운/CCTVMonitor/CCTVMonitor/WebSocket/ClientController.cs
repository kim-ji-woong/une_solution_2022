...
namespace CCTVMonitor.WebSocket
{
    class ClientController
    {
        ...
        private IClientOwner m_owner = null;
        ...
        public ClientController(TcpClient client, IClientOwner owner)
        {
            // 완전한 연결이 아닌 연결중...
        ...
        private void OnReceive(IAsyncResult ar)
        {
            ...
            catch (Exception e)
            {
                ...
                NetworkManager.WriteLog("OnReceiveError : " + e.Message);
        ...
        private bool ProcessClientRequest(int dataSize, byte[] bytes)
        {
            ...
            else if (msglen == 127)
            {
                ...
                NetworkManager.WriteLog("Error: over int16 size");
                return true;
            }
            ...
            if (mask)
            {
                ...
                switch (opcode)
                {
                    case PayloadDataType.Text:
                        if (m_owner != null)
                            m_owner.OnReceive(Encoding.UTF8.GetString(decoded), this);
                        else
                            NetworkManager.WriteLog("m_owner is null");
                        break;
        ...
        public bool SendData(string strData, PayloadDataType opcode)
        {
            ...
            {
                System.Diagnostics.Trace.WriteLine("SendData Error : " + ex.Message);
                return false;
            }
