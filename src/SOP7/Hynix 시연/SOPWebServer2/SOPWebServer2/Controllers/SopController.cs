...
namespace SOPWebServer2.Controllers
{
    ...
    public class SopController : ControllerBase
    {
        ...
        public SopController(SDMS.IDAL.IDataManager sdmsDataManager, Common.IDAL.IDataManager commonDataManager, TeamEditor.IDAL.IDataManager teamDataManager, Hynix.IDAL.IDataManager hynixDataManager)
        {
