...
namespace HynixAlarmSimulator.Data.ViewModels
{
    public class PSM : Table
    {
		...
		public enum WriteFields { ID, Name, PositionName, X, Y, Z, CurrentData, EquipZoneID, Department, DepartmentPhoneNumber, Enabled, Status, UniqueKey, ZoneID, MaterialType, LimitBase, LimitType, LimitValue };

		public enum Limit_Type { Normal = 1, OnOff, Distri, Range }
