...
namespace IntegrationServer.Servers.Elevator.Hyundai
{
    ...
    class HDProvider : ClientServiceProvider
    {
        private int m_nPingCount = 0;
        private HDManager m_netMgr = null;
        ...
        public HDProvider(HDManager netMgr)
        {
            m_netMgr = netMgr;
        ...
        public void ProcessData(byte[] bytes)
        {
            ...
            if (results != null)
            {
                ...
                List<Elevator> elevators = MessageParser.Parse(results, dicElevators, maxElevatorID, minElevatorID);

                if (elevators != null)
                    m_netMgr.UpdateElevators(elevators);
            }
        }
