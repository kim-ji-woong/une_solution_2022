...
namespace SafetyServer.BLL.Process
{
    public class ProcessManager : BaseProcessManager
    {
        ...
        public override void NewAlarm(AlarmData alarm, List<int> alarmSensorZoneIDs)
        {
            ...
            int nAlarmType = alarm.Status == (int)SDMS.Model.History.SensorReactionHistory.ReactionTypes.NOTIFY_SIGNAL ? (int)CurrentAlarm.AlarmTypes.Report : (int)CurrentAlarm.AlarmTypes.Detect;
