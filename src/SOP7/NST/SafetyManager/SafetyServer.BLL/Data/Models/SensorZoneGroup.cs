...
namespace SafetyServer.BLL.Data.Models
{
    ...
    public class SensorZoneGroup
    {
        ...
        private int m_nSensorType = (int)Facility.FacilityType.NONE;
        ...
        private void SetID()
        {
            ...
            long low = ((long)m_nSensorType) & 0xffffffff;
        ...
        public static long ToID(EquipmentZone equipZone, int sensorType)
        {
            int nEquipZoneID = equipZone == null ? -1 : equipZone.ID;
            return ToID(nEquipZoneID, sensorType);
        }

        public static long ToID(int nEquipZoneID, int sensorType)
        {
