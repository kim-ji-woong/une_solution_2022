...
namespace SafetyManager.Controllers
{
    ...
    public class SafetyController : ControllerBase
    {
        ...
        private Safety.IDAL.IDataManager m_safetyDataManager = null;

        public SafetyController(IDataManager dataManager, Common.IDAL.IDataManager commonDataManager, TeamEditor.IDAL.IDataManager teamDataManager, Safety.IDAL.IDataManager safetyDataManager)
        {
        ...
        public IActionResult ReportNoEquipmentAlarm(ReportNoEquipmentAlarm alarm)
        {
            ...
            MessageResult result = m_mainManager.SensorManager.ProcessNoEquipmentAlarm(m_safetyDataManager, alarm.UserID, alarm.CameraID, time, alarm.Helmet, alarm.Shoes, alarm.Belt, alarm.Level, alarm.Notifications);
            return Ok(result);
        }
