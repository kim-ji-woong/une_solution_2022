...
namespace WebSOPApp.Areas.SDMS.Controllers
{
    ...
    public class SDMSController : Controller
    {
        ...
        private IActionResult RequestGltfDataList(RequestGltfDataList data)
        {
            ResponseGltfDataList result = m_processManager.GetLoadManager().RequestGltfModelList(data.UserID, data.SiteIDs);
            return Ok(result);
        }
        ...
        private IActionResult RequestBuildingGroupList()
        {
            ...
            siteIDs.Add(m_processManager.SdmsDataManager.SiteID);

            ResponseBuildingGroupList result = m_processManager.GetLoadManager().RequestBuildingGroupList(siteIDs);
            return Ok(result);
        }
