...
namespace WebSOPApp.Areas.SDMS.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
            ...
            if (data.Value != "" || data.Key != "")
            {
                try
                {
                    ...
                    if (nIndex > 0)
                    {
                        ...
                        result = m_processManager.GetAccountManager().Login(strID, strPW, data.Key, true, Startup.ExternalLogin, false, null);
        ...
        private IActionResult GetAccountUsers()
        {
            ...
            result = m_processManager.GetAccountManager().GetAccountUsers(null);
        ...
        {
            MessageResult result = new MessageResult(false, "현재 지원하지 않는 기능입니다.");
            /*MessageResult result = null;
        ...
        private IActionResult CheckLoginSession(CheckLoginSession data)
        {
            ...
            result = m_processManager.GetAccountManager().CheckLoginSession(data.UserID, data.SessionKey);
            return Ok(result);
        }
        ...
        private IActionResult RequestLoginKey(RequestLoginKey data)
        {
            ...
            string strSalt = m_processManager.GetAccountManager().RequestSalt(data, out strErrorMessage);
            ...
            if (strSalt == null || strSalt.Length == 0)
            {
                ...
                if (strErrorMessage != null)
                    ...
                    result.Message = "ID 또는 비밀번호를 잘못 입력하였습니다.";
            }
            else
            {
                result.Success = true;
        ...
        {
            if (Startup.ExternalLogin != null && Startup.ExternalLogin.Length > 0)
                return true;
