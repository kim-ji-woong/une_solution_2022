...
export class SdmsJsonManager {
    ...
    static makeRequestSaveIndoorModelViewport(modelName/*: string*/, cameraData/*: Frontend.PerspectiveCameraData2*/, zoneID)/*: string*/ {
        const json = {
    ...
    static makeRequestPSMSensors() {
        const json = {
            "requestSensorPSM": true
        };
