...
class WarningAlarmInfo extends Component {
    ...
    componentDidMount() {
        ...
        $(function () {
            $('.' + styles.btnMd4).mouseenter(function () {
                $('.' + styles.sopBtn).show();
            });
            $('.' + styles.btnMd4).mouseleave(function () {
                $('.' + styles.sopBtn).hide();
            });
        });
    ...
    async onSituationNotice() {
        ...
        if (alarm.sopStatus === 2) {
            alert('SOP가 이미 종료되었습니다.');
            return;
        }
                    ...
                    <section className={styles.popupContainer + " " + styles.popupHasTitle}>
                        ...
                        <div className={styles.popupFooter}>
                            <div className={styles.btnGroup + " " + styles.btnFull + " " + styles.btnMargin}>
                                <div className={styles.btn + " " + styles.btnMd4} onClick={() => this.onSituationNotice()}><span className={styles.sopBtn}>SOP</span></div>
                                <div className={styles.btn + " " + styles.btnMd1} onClick={() => this.onMoveSelectedAlarm()}><span className={styles.screenChange}>화면전환</span></div>
                                {
                                    (this.props.alarmSound)
                                        ? <div className={styles.btn + " " + styles.btnMd22} onClick={this.onSound}><span className={styles.alarmOff}>소리 ON</span></div>
