...
class WorkerInfo extends Component {
    ...
    getWorkerInfo = () => {
        ...
        return [name, regular, jobLevel, location, zoneName, worker.helmet, worker.belt, worker.shoes];
    }

    render() {
        const [name, regular, jobLevel, location, zoneName, helmet, belt, shoes] = this.getWorkerInfo();

        const helmetClassName = helmet ? styles.safetyHelmetAct : styles.safetyHelmetDis;
        const beltClassName = belt ? styles.safetyBeltAct : styles.safetyBeltDis;
        const shoesClassName = shoes ? styles.safetyShoesAct : styles.safetyShoesDis;
                ...
                <div className={styles.viewDashboard + " " + styles.viewDashboardPerson}>
                    ...
                    <div className={styles.viewDashboardPersonview}>
                        ...
                        <ul className={styles.equipmentIcon}>
                            <li><i className={helmetClassName}></i>안전모</li>
                            <li><i className={styles.safetyTeamAct}></i><span>안전조끼</span></li>
                            <li><i className={styles.maskAct}></i><span>마스크</span></li>
                            <li><i className={shoesClassName}></i><span>안전화</span></li>
                            <li><i className={beltClassName}></i><span>안전대</span></li>
