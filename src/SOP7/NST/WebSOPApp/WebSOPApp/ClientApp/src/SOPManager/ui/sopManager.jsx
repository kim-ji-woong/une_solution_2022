...
class SopManager extends Component {
    ...
    async saveDB(sopData) {
        ...
        const userID = userInfo.id;//this.state.loginUser ? this.state.loginUser.id : -1;
    ...
    render() {
        return (
            <div id="subPage">
                <input ref={this.refFileDialog} className={styles.hidden} type='file' accept='.sop' onChange={this.onSelectFile} />
