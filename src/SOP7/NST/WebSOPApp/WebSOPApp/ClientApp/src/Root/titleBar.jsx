...
class TitleBar extends Component {
    ...
    isSdms() {
        ...
        if (url.endsWith("sdms") || url.endsWith("sdms/")) {
            return true;
        }
    ...
    onClickNavPanel(menu) {
        ...
        else if (menu === TitleBar.NavMenu.SensorStatus) {
            this.props.menuEvent.handler(SDMSMainMenu.Menu_ToggleSensorStatus, null);
        }
        else if (menu === TitleBar.NavMenu.SOP) {
            this.props.menuEvent.handler(SDMSMainMenu.Menu_ToggleSOP, null);
        }
        else if (menu === TitleBar.NavMenu.SOPEdit) {
            this.props.menuEvent.handler(SDMSMainMenu.Menu_ToggleSOPEdit, null);
        }
        else if (menu === TitleBar.NavMenu.TeamEditor) {
            this.props.menuEvent.handler(SDMSMainMenu.Menu_ToggleTeamEditor, null);
        }
    ...
    getUserInfo() {
        ...
        if (ProjectResource.SiteID) {
            userInfo = JSON.parse(window.localStorage.getItem(SessionString.Key.account + "_" + ProjectResource.SiteID.toString()));
                    ...
                    <div ref={this.refNavPanel} className={title.navPanel}>
                        <div className={title.tabDrawer}>
                            <ul>
                                ...
                                <li className="tabMenu" onClick={() => this.onClickNavPanel(TitleBar.NavMenu.SensorStatus)}><div className="tabMenu"><i className="tabMenu"></i>{TitleBar.NavMenu.SensorStatus}</div></li>
                                <li className="tabMenu" onClick={() => this.onClickNavPanel(TitleBar.NavMenu.SOP)}><div className="tabMenu"><i className="tabMenu"></i>SOP 실행</div></li>
                                <li className="tabMenu" onClick={() => this.onClickNavPanel(TitleBar.NavMenu.SOPEdit)}><div className="tabMenu"><i className="tabMenu"></i>SOP 편집</div></li>
                                <li className="tabMenu" onClick={() => this.onClickNavPanel(TitleBar.NavMenu.TeamEditor)}><div className="tabMenu"><i className="tabMenu"></i>조직관리</div></li>
                                <li className="tabMenu"><div className="tabMenu"><i className="tabMenu"></i></div></li>
                            </ul>
                        </div>
                    </div>
