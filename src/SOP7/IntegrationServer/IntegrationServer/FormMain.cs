...
namespace IntegrationServer
{
    ...
    public partial class FormMain : Form, IManager
    {
        ...
        private void InitGridView()
        {
            ...
            foreach (ID.ServerTypes value in Enum.GetValues(typeof(ID.ServerTypes)))
            {
                colTypeItems.Add(new ComboBoxItem() { ID = (int)value, Name = ID.GetServerText(value) });
            }
        ...
        private void DataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ID.ServerTypes enumServer = (ID.ServerTypes)dataGridView1.SelectedRows[0].Cells[nColumnIndex_ServerName].Value;
            ...
            string strServerName = ID.GetServerText(enumServer);
