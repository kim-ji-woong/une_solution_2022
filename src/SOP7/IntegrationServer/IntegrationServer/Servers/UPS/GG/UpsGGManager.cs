...
namespace IntegrationServer.Servers.UPS.GG
{
    public class UpsGGManager : IServer
    {
        ...
        public ID.ServerTypes ServerType { get { return ID.ServerTypes.UPS_GG; } }
        ...
        private void RequestThread()
        {
            ...
            while (m_runThread)
            {
                ...
                try
                {
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_1 UpsSmartBatteryCapacity3 Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else                    
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_1 UpsSmartBatteryCapacity3: " + strValue_100kva_1);                    
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_1 UpsSmartInputLineVoltageR Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_1 UpsSmartInputLineVoltageR: " + strUpsSmartInputLineVoltageR_100kva_1);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_1 UpsSmartInputLineVoltageS Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_1 UpsSmartInputLineVoltageS: " + strUpsSmartInputLineVoltageS_100kva_1);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_1 UpsSmartInputLineVoltageT Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_1 UpsSmartInputLineVoltageT: " + nUpsSmartInputLineVoltageT_100kva_1);
                    // 동작 상태
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_1 UpsSmartInputState Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_1 UpsSmartInputState: " + strState_100kva_1);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_2 UpsSmartBatteryCapacity3 Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_2 UpsSmartBatteryCapacity3: " + strValue_100kva_2);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_2 UpsSmartInputLineVoltageR Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_2 UpsSmartInputLineVoltageR: " + nUpsSmartInputLineVoltageR_100kva_2);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_2 UpsSmartInputLineVoltageS Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_2 UpsSmartInputLineVoltageS: " + nUpsSmartInputLineVoltageS_100kva_2);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_2 UpsSmartInputLineVoltageT Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_2 UpsSmartInputLineVoltageT: " + nUpsSmartInputLineVoltageT_100kva_2);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_2 UpsSmartInputState Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_2 UpsSmartInputState: " + strState_100kva_2);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_3 UpsSmartBatteryCapacity3 Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_3 UpsSmartBatteryCapacity3: " + strValue_100kva_3);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_3 UpsSmartInputLineVoltageR Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_3 UpsSmartInputLineVoltageR: " + strUpsSmartInputLineVoltageR_100kva_3);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_3 UpsSmartInputLineVoltageS Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_3 UpsSmartInputLineVoltageS: " + strUpsSmartInputLineVoltageS_100kva_3);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_3 UpsSmartInputLineVoltageT Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_3 UpsSmartInputLineVoltageT: " + strUpsSmartInputLineVoltageT_100kva_3);
                    // 동작 상태
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "100kva_3 UpsSmartInputState Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 100kva_3 UpsSmartInputState: " + strState_100kva_3);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "200kva UpsSmartBatteryCapacity3 Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 200kva UpsSmartBatteryCapacity3: " + strValue_200kva);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "200kva UpsSmartInputLineVoltageR Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 200kva UpsSmartInputLineVoltageR: " + strUpsSmartInputLineVoltageR_200kva);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "200kva UpsSmartInputLineVoltageS Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 200kva UpsSmartInputLineVoltageS: " + strUpsSmartInputLineVoltageS_200kva);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "200kva UpsSmartInputLineVoltageT Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 200kva UpsSmartInputLineVoltageT: " + strUpsSmartInputLineVoltageT_200kva);
                    // 동작 상태
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "200kva UpsSmartInputState Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 200kva UpsSmartInputState: " + strState_200kva);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_1 UpsSmartBatteryCapacity3 Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartBatteryCapacity3: " + strValue_500kva_1);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_1 UpsSmartInputLineVoltageR Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartInputLineVoltageR: " + strUpsSmartInputLineVoltageR_500kva_1);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_1 UpsSmartInputLineVoltageS Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartInputLineVoltageS: " + strUpsSmartInputLineVoltageS_500kva_1);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_1 UpsSmartInputLineVoltageT Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartInputLineVoltageT: " + strUpsSmartInputLineVoltageT_500kva_1);
                    // 동작 상태
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_1 UpsSmartInputState Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartInputState: " + strState_500kva_1);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_2 UpsSmartBatteryCapacity3 Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartBatteryCapacity3: " + strValue_500kva_2);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_2 UpsSmartInputLineVoltageR Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartInputLineVoltageR: " + strUpsSmartInputLineVoltageR_500kva_2);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_2 UpsSmartInputLineVoltageS Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartInputLineVoltageS: " + strUpsSmartInputLineVoltageS_500kva_2);
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_2 UpsSmartInputLineVoltageT Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartInputLineVoltageT: " + strUpsSmartInputLineVoltageT_500kva_2);
                    // 동작 상태
                    ...
                    {
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "500kva_2 UpsSmartInputState Error: " + strErrorMessage);
                        Thread.Sleep(m_nThreadDeley);
                        continue;
                    }
                    else
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "GetSNMP 500kva_1 UpsSmartInputState: " + strState_500kva_2);
                    ...
                    if (SendBatteryAlarm(nValue_100kva_1, UniqueKey_100kva1, ref nMaxDepth, out strErrorMessage) == false)
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "SendBatteryAlarm 100kva_1 Error: " + strErrorMessage);
                    if (SendBatteryAlarm(nValue_100kva_2, UniqueKey_100kva2, ref nMaxDepth, out strErrorMessage) == false)
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "SendBatteryAlarm 100kva_2 Error: " + strErrorMessage);
                    if (SendBatteryAlarm(nValue_100kva_3, UniqueKey_100kva3, ref nMaxDepth, out strErrorMessage) == false)
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "SendBatteryAlarm 100kva_3 Error: " + strErrorMessage);

                    if (SendBatteryAlarm(nValue_200kva, UniqueKey_200kva, ref nMaxDepth, out strErrorMessage) == false)
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "SendBatteryAlarm 200kva Error: " + strErrorMessage);

                    if (SendBatteryAlarm(nValue_500kva_1, UniqueKey_500kva1, ref nMaxDepth, out strErrorMessage) == false)
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "SendBatteryAlarm 500kva_1 Error: " + strErrorMessage);
                    if (SendBatteryAlarm(nValue_500kva_2, UniqueKey_500kva2, ref nMaxDepth, out strErrorMessage) == false)
                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "SendBatteryAlarm 500kva_2 Error: " + strErrorMessage);
                    ...
                    {   // 기존 정전 알람 단계와 현재 알람 단계가 다르다면 발생
                        ...
                        if (nBlackoutDepth != nMaxDepth)
                        {
                            if (m_nBlackoutID.HasValue)
                            {
                                ...
                                if (sensorTag == null)
                                    Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, $"해당 SensorTag 값이 없습니다. ServerSeqNo: {m_nServerSeqNo.ToString()}, SensorID: {m_nBlackoutID.Value.ToString()}");
                                else
                                {
                                    if (SendSensorData(sensorTag, (int)dnsData.Sensor.Facility.FacilityType.BLACKOUT, true, nMaxDepth) == false)
                                        Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, $"SendSensorData Error (TagID: {sensorTag.ID}, SensorZoneID: {sensorTag.SensorZoneID}, IsAlarm: True)");
                                ...
                                Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, $"BlackoutID 값이 없습니다. ServerSeqNo: {m_nServerSeqNo.ToString()}");
                    ...
                    {   // 정전 알람 해제
                        ...
                        else
                        {
                            if (SendSensorData(sensorTag, (int)dnsData.Sensor.Facility.FacilityType.BLACKOUT, false, (int)AlarmDepths.None) == false)
                                Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, $"SendSensorData Error (TagID: {sensorTag.ID}, SensorZoneID: {sensorTag.SensorZoneID}, IsAlarm: False)");
                ...
                {
                    Logger.Write(LogTypes.Info, ID.ServerTypes.UPS_GG, m_nServerSeqNo, "RequestThread Error: " + e.Message);
                }               
