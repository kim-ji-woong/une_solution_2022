...
namespace IntegrationServer.Servers.ContactSignal.Sollae
{
    public class ContactManager : IServer
    {
        ...
        public ID.ServerTypes ServerType { get { return ID.ServerTypes.ContactSignal; } }
        ...
        public void CheckContactSignal(ContactData data)
        {
            ...
            {
                // 알람 발생 신호
                Logger.Write(LogTypes.Info, ID.ServerTypes.ContactSignal, m_nServerSeqNo, "Contact 알람 발생");
            ...
            {
                // 알람 해제 신호
                Logger.Write(LogTypes.Info, ID.ServerTypes.ContactSignal, m_nServerSeqNo, "Contact 알람 해제");
