...
namespace IntegrationServer
{
    public class Service
    {
        ...
        private void LoadSetting()
        {
            ...
            {
                Logger.Instance.Write(LogTypes.Error, dnsSopID.ID.ServerTypes.None, -1, "LoadSetting");
                return;
            }

            int nCount = m_serverSetting == null || m_serverSetting.ServerDatas == null ? 0 : m_serverSetting.ServerDatas.Count;
            Logger.Instance.Write(LogTypes.Info, dnsSopID.ID.ServerTypes.None, -1, "LoadSetting : " + nCount);
        }
        ...
        public bool Start()
        {
            ...
            Logger.Instance.Write(LogTypes.Info, dnsSopID.ID.ServerTypes.None, -1, "Start Server");
        ...
        public void Stop()
        {
            ...
            Logger.Instance.Write(LogTypes.Info, dnsSopID.ID.ServerTypes.None, -1, "Stop Server");
        }
    }
}
