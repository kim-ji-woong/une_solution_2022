...
namespace IntegrationServer.ViewModels.Sdms
{
    public class CCTV : Table
    {
        ...
        public enum WriteFields { CameraName, PositionName, UniqueKey, X, Y, Z, ZoneID, IsIndoor, Type, Channel, UserID, Password, URL, BigURL, SmallURL, Enabled, CameraIP, CameraCompanyName, CameraModelName, Description };
        ...
        public static string TableName = "SdmsCCTV";
