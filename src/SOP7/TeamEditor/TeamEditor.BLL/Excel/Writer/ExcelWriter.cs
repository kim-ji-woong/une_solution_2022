...
namespace TeamEditor.BLL.Excel.Writer
{
    public abstract class ExcelWriter
    {
        protected TeamEditor.IDAL.IDataManager m_teamDataManager = null;

        public ExcelWriter(TeamEditor.IDAL.IDataManager teamDataManager)
        {
        ...
        public static ExcelWriter MakeInstance(DataMode mode, TeamEditor.IDAL.IDataManager teamDataManager)
        {
            if (mode == DataMode.RegularTeamData)
                return new RegularMemberWriter(teamDataManager);
