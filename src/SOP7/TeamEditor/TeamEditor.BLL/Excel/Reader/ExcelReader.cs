...
namespace TeamEditor.BLL.Excel.Reader
{
    public abstract class ExcelReader
    {
        ...
        protected TeamEditor.IDAL.IDataManager m_dataManager = null;

        public ExcelReader(string strFilePath, TeamEditor.IDAL.IDataManager dataManager)
        {
        ...
        public static ExcelReader MakeInstance(DataMode mode, string strFilePath, TeamEditor.IDAL.IDataManager teamDataManager, SOPManager.IDAL.IDataManager sopDataManager)
        {
            if (mode == DataMode.RegularTeamData)
                return new RegularMemberReader(strFilePath, null, teamDataManager, sopDataManager);
