...
namespace TeamEditor.IDAL
{
    public interface ISelect
    {
        ...
        ArrayList JoinRegularRegularMember(string strAdditionalConditions, out string strErrorMessage);
        ArrayList JoinRegularRegularMember(string strAdditionalConditions, int? topNCount, out string strErrorMessage);
