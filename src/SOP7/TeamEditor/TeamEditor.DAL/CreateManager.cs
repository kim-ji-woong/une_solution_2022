...
namespace TeamEditor.DAL
{
    public class CreateManager : QueryManager, ICreate
    {
        ...
        public bool AddRegular(Regular regular, out string strErrorMessage)
        {
            ...
            dicFieldDatas[Regular.Fields.SiteID] = regular.SiteID;
        ...
        public bool AddRegular(int? nID, int? nParentTeamID, string strTeamName, int nSiteID, out string strErrorMessage)
        {
            strErrorMessage = "";
            ...
            dicFieldDatas[Regular.Fields.SiteID] = nSiteID;
        ...
        public bool AddTemporary(Temporary temporary, out string strErrorMessage)
        {
            ...
            string strSQL = string.Format("Insert into SopTeamTemporary (ID, ParentTeamID, TeamName, IsNormal, SiteID) values ({0}, {1}, '{2}', {3}, {4})"
                , temporary.ID, temporary.ParentTeamID == null ? "null" : temporary.ParentTeamID.ToString(), temporary.TeamName, temporary.IsNormal ? 1 : 0, temporary.SiteID);
