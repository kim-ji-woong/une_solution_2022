...
namespace TeamEditor.DAL
{
    public class UpdateManager : QueryManager, IUpdate
    {
        ...
        {
            m_dataMgr = dataMgr;
            m_dbManager = m_dataMgr.GetDBManager() as DirectDBManager;
        ...
        public bool UpdateRegularMember(Dictionary<RegularMember.Fields, object> dicSets, Dictionary<RegularMember.Fields, object> dicConditions, string strAdditionalCondition, out string strErrorMessage)
        {
            ...
            if (strAdditionalCondition != null && strAdditionalCondition.Length > 0)
            {
                if (strCondition.Length > 0)
                    strCondition += " and " + strAdditionalCondition;
                else
                    strCondition = strAdditionalCondition;
            }
        ...
        public bool UpdateRegular(Dictionary<Regular.Fields, object> dicSets, Dictionary<Regular.Fields, object> dicConditions, string strAdditionalCondition, out string strErrorMessage)
        {
            strErrorMessage = null;
        ...
        public bool UpdateRegular(Regular regular, out string strErrorMessage)
        {
            ...
            sb.AppendFormat(", SiteID = {0} ", (regular.SiteID == null) ? "null" : regular.SiteID.ToString());
        ...
        public bool UpdateTemporary(Dictionary<Temporary.Fields, object> dicSets, Dictionary<Temporary.Fields, object> dicConditions, string strAdditionalCondition, out string strErrorMessage)
        {
            strErrorMessage = null;
        ...
        public bool UpdateTemporaryMember(Dictionary<TemporaryMember.Fields, object> dicSets, Dictionary<TemporaryMember.Fields, object> dicConditions, string strAdditionalCondition, out string strErrorMessage)
        {
            strErrorMessage = null;
