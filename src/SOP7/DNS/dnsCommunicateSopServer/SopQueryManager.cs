...
namespace dnsCommunicateSopServer
{
    public class SopQueryManager
    {
        ...
        /// <returns></returns>
        public bool SendAlarmQuery(ArrayList arrDatas, string strMethodType, out string strErrorMessage, string strURL = "", ArrayList arrDatas2 = null)
        {
        ...
        {
            return SendAlarmQuery(arrDatas, strMethodType, out string strError, strURL, arrDatas2);
        }
        ...
        private string AddSensorParam(ArrayList arrDatas, int nSensorType)
        {
            ...
            else if (nSensorType == (int)dnsData.Sensor.Facility.FacilityType.H2
                ...
                || nSensorType == (int)dnsData.Sensor.Facility.FacilityType.Flow)
            {
                ...
                {
                    int nRiskID = (int)arrDatas[0];
                    value += string.Format(",\"{0},{1}\"",
                        dnsSopID.DATA_TYPE.INT, nRiskID);
                }
            }
