    ...
    public abstract class Facility
    {
        ...
        public static string GetFacilityTypeString(FacilityType nType)
        {
            if (nType == Facility.FacilityType.FIRE_SENSOR ||
                ...
                return "침수";
            else if (nType == Facility.FacilityType.Anomaly)
                return "이상탐지";
            else if (nType == Facility.FacilityType.Risk)
                return "위험성 평가 예측";
            else if (nType == Facility.FacilityType.H2Low_Senko)
                return "수소 저농도";
            else if (nType == Facility.FacilityType.O2_Senko)
                return "산소";
            else if (nType == Facility.FacilityType.H2JAG)
                return "수소 가스";
            else if (nType == Facility.FacilityType.O2JAG)
                return "산소 가스";
        ...
        public static bool IsAnomalySensorType(FacilityType type)
        {
            return type == FacilityType.Anomaly;
        }

        public static bool IsH2LowSensorType(FacilityType type)
        {
            return type == FacilityType.H2Low_Senko;
        }

        public static bool IsO2SensorType(FacilityType type)
        {
            return type == FacilityType.O2_Senko;
        }

        public static bool IsH2JAGSensorType(FacilityType type)
        {
            return type == FacilityType.H2JAG;
        }

        public static bool IsO2JAGSensorType(FacilityType type)
        {
            return type == FacilityType.O2JAG;
        }
        ...
        public static List<int> GetEnvironmentTypeAllNumberToList()
        {
            List<int> types = new List<int>();
            types.Add((int)FacilityType.Environment);

            return types;
        }

        public static List<int> GetManufactureTypeAllNumberToList()
        {
            List<int> types = new List<int>();
            types.Add((int)FacilityType.Manufacture);

            return types;
        }

        public static List<int> GetHydrogenTypeAllNumberToList()
        {
            List<int> types = new List<int>();
            ...
            types.Add((int)FacilityType.O2_Senko);
            types.Add((int)FacilityType.H2Low_Senko);
            types.Add((int)FacilityType.H2JAG);
            types.Add((int)FacilityType.O2JAG);
            types.Add((int)FacilityType.Anomaly);
        ...
        public static List<int> GetH2LowTypeAllNumberToList()
        {
            List<int> types = new List<int>();
            types.Add((int)FacilityType.H2Low_Senko);
        ...
        public static List<int> GetO2TypeAllNumberToList()
        {
            List<int> types = new List<int>();
            types.Add((int)FacilityType.O2_Senko);
        ...
        public static List<int> GetH2JAGTypeAllNumberToList()
        {
            List<int> types = new List<int>();
            types.Add((int)FacilityType.H2JAG);
        ...
        public static List<int> GetO2JAGTypeAllNumberToList()
        {
            List<int> types = new List<int>();
            types.Add((int)FacilityType.O2JAG);
