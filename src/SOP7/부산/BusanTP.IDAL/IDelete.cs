...
namespace BusanTP.IDAL
{
	public interface IDelete
	{
		...
		bool DeleteBusanUserMemo(Dictionary<UserMemo.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
		
		bool DeleteUser(int userID, string strAdditionalConditions, out string strErrorMessage);
	}
}
