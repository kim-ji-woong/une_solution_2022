    ...
    public class HistoryController : Controller
    {
        ...
        private IActionResult RequestSensorDetectHistories(RequestSensorDetectHistories data)
        {
            ...
            ResponseSensorDetectHistories result = m_processManager.GetLoadManager().DisplaySensorDetectHistories(
                beginTime, endTime, data.FacilityType, data.BuildingGroupID, data.BuildingID, data.ZoneID, data.LastSensorZoneHistoryID, data.RowCount, data.IsDesc, data.SiteID, false);
        ...
        private IActionResult RequestSensorDetectAnalysis(RequestSensorDetectAnalysis data)
        {
            ...
            ResponseSensorDetectAnalysis result = m_processManager.GetLoadManager().DisplaySensorDetectAnalysis(beginTime, endTime, data.FacilityType, data.BuildingGroupID, data.BuildingID, data.ZoneID, data.SiteID, false);
            return Ok(result);
        }
