...
import { SprContDecision, SprTop, SprtTitle, SskChk, LabelInput, SprMidDecision, SprmCont, SopEdtTb } from '../../../SOPManager/styled/componentsStyled';
import { ScrollWrapper, ScrollContent, ScrollContentModify, ScrollContentDecision, ScrollContentJudgment, TableTitle, SprBot, ScrollWrapperDecision } from '../../../SOPManager/styled/componentsStyled';
				...
				<SprTop>
					<SprtTitle>
						...
						<p>
							<label>
								<LabelInput>
								<input type="checkbox" name="sskChk" id={DecisionProperty.cssStyles.sskChk} checked={this.state.useVariables} onChange={this.onCheckUseVariables}/>
								</LabelInput>
								수식사용
							</label>
						</p>
									...
									<table>
										...
										<tbody>
											<tr onClick={this.onClickToggle}>
												<td>time</td>
												<td>문자열</td>
												<td className={commonStyles.tal}><p className={'nwrp'}>상황발생 시간 상황발생 시간 상황발생 시간</p></td>
											</tr>
											<tr onClick={this.onClickToggle}>
												<td>location</td>
												<td>문자열</td>
												<td className={commonStyles.tal}><p className={'nwrp'}>상황발생 위치 상황발생 위치 상황발생 위치</p></td>
											</tr>
											<tr>
												<td>-</td>
												<td>-</td>
