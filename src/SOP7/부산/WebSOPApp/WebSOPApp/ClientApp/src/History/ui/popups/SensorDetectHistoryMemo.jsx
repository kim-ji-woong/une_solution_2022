...
//import { SensorDetectHistoryMemoComponent } from '../../../SDMS/styled/sdmsPopupsStyled';
    ...
    render() {
		...
		return (
			<SensorDetectHistoryMemoComponent>
                <div id={hsMmoName} className={hsMmoClassName}>
                    {
                        (!this.props.fromHistoryMenu) ?                        
                        <>
                            <div className={'popupSizingAreaRight'} onMouseDown={(e) => this.popupResizeMousePress(e, 'h-r')} ></div>
                            <div className={'popupSizingAreaLeft'} onMouseDown={(e) => this.popupResizeMousePress(e, 'h-l')}></div>
                            <div className={'popupSizingAreaBottom'} onMouseDown={(e) => this.popupResizeMousePress(e, 'v-b')}></div>
                            <div className={'popupSizingAreaTop'} onMouseDown={(e) => this.popupResizeMousePress(e, 'v-t')}></div>
                            <div className={'popupSizingAreaRightTopPoint'} onMouseDown={(e) => this.popupResizeMousePress(e, 'd-rt')}></div>
                            <div className={'popupSizingAreaRightBottomPoint'} onMouseDown={(e) => this.popupResizeMousePress(e, 'd-rb')}></div>
                            <div className={'popupSizingAreaLeftTopPoint'} onMouseDown={(e) => this.popupResizeMousePress(e, 'd-lt')}></div>
                            <div className={'popupSizingAreaLeftBottomPoint'} onMouseDown={(e) => this.popupResizeMousePress(e, 'd-lb')}></div>
                        </>
                        : null
                    }
					
                        <div className={'dslTopMemo' + " " + 'dslGrd'}>
                            <h5 className={'squareTitle'} onMouseDown={(e) => this.popupDragMousePress(e)}>
                                ㆍ메모
                            </h5>
                            <a className={'dslX'} onClick={() => this.props.setPopupMemo(false)}></a>
                        </div>
						<div className={'memoContents'}>
                            <textarea name="" id="" cols="30" rows="17" className={"scroll-wrapper" + 'memoTxt' + "scrollbar scroll-textareaCss"} onChange={(e) => this.onChangeMemo(e)}
                                value={(this.state.displayMemo && this.state.displayMemo.length > 0) ? this.state.displayMemo : ''} readonly>
							</textarea>
						</div>
