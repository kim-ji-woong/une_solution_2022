...
class Monitoring3D extends Component {
    ...
    getAutoRotationSetting = () => {
        ...
        if (idleTimeMinute === 15)
            ...
            defaultValue = SettingsResource.autoRotation.none;
    ...
    getSensorEventSetting = () => {
        ...
        if (dicUseReceives) {
            ...
            if (dicUseReceives["UseReceiveElectricity"]) {
                electricityChekced = true;
            }
        }
        ...
        return (
            <div>
                ...
                <div>
                    <input type='checkbox' checked={atmosChecked} id={SdmsResource.SensorType.atmosphere}
                           onChange={(e) => this.onChangeUseReceive(e)}/>
                    <label htmlFor='sensor_1'>대기센서</label>
                </div>
                <div>
                    <input type='checkbox' checked={kWeatherChecked} id={SdmsResource.SensorType.kWeather}
                           onChange={(e) => this.onChangeUseReceive(e)}/>
                    <label htmlFor='sensor_1'>면오염원</label>
                </div>
                <div>
                    <input type='checkbox' checked={electricityChekced} id={SdmsResource.SensorType.electricity}
                           onChange={(e) => this.onChangeUseReceive(e)}/>
                    <label htmlFor='sensor_1'>전류CT센서</label>
                </div>
                {/*<div>*/}
