export class JsonManager {
    ...
    static makeRequestSensorDataHistories(beginTime, endTime, buildingIDs, materials, periodType) {
        const json = {
            "RequestSensorDataHistories": {
                "BeginDate": beginTime, // TimeStamp
                "EndDate": endTime, // TimeStamp
                "BuildingIDs": buildingIDs, // int ( Entire: [-1] )
                "MaterialIDs": materials, // int[] ( Entire: [-1] )
                "PeriodType": periodType // bool ( false: Hourly, true: 5Min )
            }
        }
    ...
    static makeRequestWeatherHistory(zoneID) {
        const json = {
