...
import contentBoxEl_red from '../images/contentBoxEl_red.svg'; poi_ct
...
import poi_ct from '../images/poi_ct.svg';
...
import spread_disable_icon from '../images/spread_disable_icon.svg';
...
export const StatusInfoComponent = styled(PopupsCommon)`
    ...
    .contentBox {
        ...
        .visibleElectricCT,
        .disableElectricCT {
            background: url(${poi_ct}) no-repeat center center;
            width: 24px;
            height: 24px;
            border-radius: 2px;
        }
...
/**********************************************************************/
// 화면 상단 위치정보
export const PositionInfoComponent = styled.div`
    position: absolute;
    top: 80px;
    left: 50%;
    transform: translate(-50%, 0);
...
/**********************************************************************/
// 확산 시뮬레이션
export const SpreadSimulationComponent = styled(PopupsCommon)`
    position: absolute;
    width: 300px;
    height: 516px;

    .spreadRange input[type=range] {
        width: 50px;
        height: 3px;
        background-color: ${(props) => props.theme.primary};
        cursor: pointer; 
    ...
    .spreadRange input[type=range]:focus {
        outline: none;
    }

    .spreadRange input[type=range]::-webkit-slider-thumb {
        -webkit-appearance: none;
        background: ${(props) => props.theme.primary};
        cursor: pointer;
        height: 8px;
