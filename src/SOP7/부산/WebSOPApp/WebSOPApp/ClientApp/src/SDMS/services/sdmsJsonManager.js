export class SdmsJsonManager {   
    ...
    static makeRequestElevators() {
        const json = {
            "requestElevators": true
        };
        return JSON.stringify(json);
    }
    ...
    static makeRequestExternalSensors() {
        const json = {
            "requestExternalSensors": true
        };
        return JSON.stringify(json);
    }
    ...
    static makeRequestExternalSensorTypes() {
        const json = {
            "requestExternalSensorTypes": true
        };
        return JSON.stringify(json);
    }
    
    static makeRequestExternalMaterials() {
        const json = {
            "requestExternalMaterials": true
        };
        return JSON.stringify(json);
    }

    static makeRequestAlarmMemo() {
        const json = {
            "requestAlarmMemo": true
        };
        return JSON.stringify(json);
    }

    static makeRequestBusanSdmsOption() {
        const json = {
            "requestBusanSdmsOptions": true
        };
        return JSON.stringify(json);
    }
    
    static makeRequestBusanExternalPOIInfo() {
        const json = {
            "requestExternalPOIInfo": true
        }
        
        return JSON.stringify(json);
    }
    
    static makeRequestViewport() {
        const json = {
    ...
    static makeRequestSaveBusanViewport(data) {
        const json = {
            "requestSaveViewport": {
    ...
    static makeRequestUserMemos() {
        const json = {
            "requestUserMemos": true
        }
        
        return JSON.stringify(json);
    }
    
    static makeRequestSaveUser(userID, userMemo, accountLevelID) {
        const json = {
            "requestSaveUser": {
                "userID": userID,
                "userLevel": accountLevelID,
                "memo": userMemo
            }
        }
