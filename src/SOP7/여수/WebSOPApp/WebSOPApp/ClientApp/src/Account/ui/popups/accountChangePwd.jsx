...
class accountChangePwd extends Component {
    ...
    render() {
		...
		return (
			<>
                <div id={contents.popupConts} className={contents.loginPopup + " " + SdmsResource.UISection}>
                    <div className={contents.passwordConts}>
                        ...
                        <div className={contents.passwordBox}>
                            ...
                            <table /* className={contents.tblNone} */>
                                ...
                                <tbody id="userInfo">
                                    <tr style={{ display: 'flex', flexDirection: 'column' , margin: '0px 10px 8px 10px' }}>
                                        {/* <td>・ {AcoountResource.ID.textTitlePwdConfirm}</td> */}
                                        <td className={contents.passwordText}>비밀번호</td>
                                    ...
                                    <tr id="rowPassword" style={{ display: 'flex', flexDirection: 'column', margin: '0px 10px 8px 10px' }}>
                                        {/* <td>・ {AcoountResource.ID.textTitlePwd}</td> */}
                                        <td className={contents.newPasswordText}>새 비밀번호</td>
                                    ...
                                    <tr id="rowRepassword" style={{ display: 'flex', flexDirection: 'column' , margin: '0px 10px 8px 10px' }}>
                                        {/* <td>・{AcoountResource.ID.textTitleRePwd}</td> */}
                                        <td className={contents.newPasswordConfirm}>새 비밀번호 확인</td>
                            ...
                            <div className={contents.btnBoxArea}>
                              <a onClick={this.onClickCancle} className={contents.btnWhiteBtn}>취소</a>
                              <a onClick={this.onClick} className={contents.btnBlueBtn}>확인</a>
                            </div>
                        </div>

                    </div>
                </div>
                <div className={contents.dim + " " + SdmsResource.UISection}></div>
                {
                    /* alert창 대신 사용 */
