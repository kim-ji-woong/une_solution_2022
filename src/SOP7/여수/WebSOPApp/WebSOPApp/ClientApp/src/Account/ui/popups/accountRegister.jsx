...
class AccountRegister extends Component {
 ...
 //       }
    ...
    render() {
		...
		return (
			<>
                <div id={contents.popupConts} /* className="overScrollY" */ className={SdmsResource.UISection}>

                    <div className={contents.popupBox} style={{ padding: "25px 30px" }}>
                        <div className={contents.popupBoxTitle}>{AcoountResource.ID.popupMode.register}</div>
