	...
	getCheckBox() {
		if (this.props.useCheckBox === TreeNode.CheckBox_NormalUse) {
			if (this.props.teamTreeData.checked === TreeNode.CHECKED_ALL) {
				return <input type="checkbox" checked={true} onChange={this.onChecked} style={{ border: 'solid 1px #aaa', marginTop : '6px' }} />;
			}
			else {
				return <input type="checkbox" checked={false} onChange={this.onChecked} style={{ border: 'solid 1px #aaa', marginTop : '6px' }} />;
			}
		}
					...
					(this.props.editNodeID === this.props.teamTreeData.ID || this.state.nodeEdit) ?
						...
						<a className={selectNodeClass} id={team.wordIength} onClick={(e) => this.onTreeNodeChanged(e)} onContextMenu={(e) => this.onTreeNodeChanged(e)}>
							...
							<span className={team.editArea}>
								...
								<span /* className={team.treePlus} */ className={team.addText} onClick={this.props.addTeam}></span>
								<span /* className={team.treeMinus} */ className={team.deleteText} onClick={this.props.removeTeam}></span>
							</span>
						</a>
				}
			</>
