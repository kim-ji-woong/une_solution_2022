...
export class TeamEditController {
    ...
    static async requestTemporaryMembers() {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/RequestData', {
                method: 'post',
                headers: {
    ...
    static async DisplayRegular() {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/DisplayRegular');
	...
	static async DisplayTemporary(isNormal) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/DisplayTemporary', {
                method: 'POST',
                headers: {
    ...
    */
    ...
    static async DisplayRegularMember() {
        const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/DisplayRegularMember');
        if (response.ok) {
    ...
    static async GetJobLevels() {
        const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/GetJobLevels');
        if (response.ok) {
    ...
    static async GetJobPositions() {
        const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/GetJobPositions');
        if (response.ok) {
    ...
    static async displayTemporaryMember(TemporaryID, isNormal) {
        ...
        const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/DisplayTemporaryMember', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json;charset=utf-8'
            },
    ...
    static async saveAddRegularTeam(isRedo, cmd) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/SaveAddRegularTeam', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async saveRemoveRegularTeam(isRedo, cmd) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/SaveRemoveRegularTeam', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async saveChangeRegularTeamInfo(isRedo, cmd) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/SaveChangeRegularTeamInfo', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async saveChangeRegularMemeberInfo(isRedo, cmd) {
        try {                                                                        
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/SaveChangeRegularMemeberInfo', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async saveRemoveRegularMemeber(isRedo, cmd) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/SaveRemoveRegularMemeber', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async UpdateRegularMember(member) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/UpdateRegularMember', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async RemoveRegularMembers(members) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/RemoveRegularMembers', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async UpdateTemporaryMember(member) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/UpdateTemporaryMember', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async RemoveTemporaryMembers(members) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/RemoveTemporaryMembers', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async UpdateRegularTeam(regular) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/UpdateRegularTeam', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async RemoveRegularTeams(teamIDs) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/RemoveRegularTeams', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async UpdateTemporaryTeam(temporary) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/UpdateTemporaryTeam', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async RemoveTemporaryTeams(teamIDs) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/RemoveTemporaryTeams', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async saveUpdateData(updateData) {
        ...
        try {
            const response = await fetch(ProjectResource.baseUrl + '/TeamEditor/TeamEdit/SaveUpdateData', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
