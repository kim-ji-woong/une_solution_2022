...
import { SettingCommon, StgTab, DashboardSetCont } from '../../styled/SettingStyled';
        ...
        return (
            <>
				<StgTab className={'stgTab single'}>
					<li><a href="#" className={'on'}>일반</a></li>
				</StgTab>
				<DashboardSetCont className={'stgList'}>
					<div className={'stgName'}>
						<h5>표출 데이터 기간 설정</h5>
						<span className={'stgTltp'} data-tooltip="표출 데이터 기간을 설정 합니다."></span>
						<ul className={'stgProd'}>
							<li>
								<div className={'datepicker'}>
									<DatePicker name="datepicker01" id="datepicker01" className={'dsrTxt'}
							...
							<li>
								<div className={'datepicker'}>
									<DatePicker name="datepicker02" id="datepicker02" className={'dsrTxt'}
										dateFormat="yyyy-MM-dd"
										locale={ko}
										maxDate={new Date()}
