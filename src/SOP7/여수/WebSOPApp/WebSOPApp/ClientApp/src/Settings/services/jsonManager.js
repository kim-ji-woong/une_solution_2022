export default class JsonManager{
    ...
    static makeRequestYeosuSettings() {
        const json = {
            "requestYeosuSettings": true
        };
    ...
    static makeYeosuSaveSettings(yeosuSaveData) {
        const json = {
            "requestYeosuSaveSettings":
            {
                useReceiveAtmosphere: yeosuSaveData.useReceiveAtmosphere,
                useReceiveWater: yeosuSaveData.useReceiveWater,
                useReceiveVOC: yeosuSaveData.useReceiveVOC,
                useReceiveOU: yeosuSaveData.useReceiveOU
            }
        };
