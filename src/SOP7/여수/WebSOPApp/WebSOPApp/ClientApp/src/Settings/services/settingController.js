...
export class SettingController {
    ...
    static StartWatchTimer() {
        ...
        let timerSettings = setTimeout(async function tick() {
            ...
            timerSettings = setTimeout(tick, 3000);
        }, 3000);
    }
    ...
    static async requestYeosuSettings() {
        try {
            const jsonData = JsonManager.makeRequestYeosuSettings();
    ...
    static async requestSaveSettingsYeosu(saveData) {
        try {
            const jsonData = JsonManager.makeYeosuSaveSettings(saveData);
    ...
    static async requestSaveSetting(propertyName, propertyValue) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/Settings/Settings/SaveSOPSetting', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestUploadBuildingFile(file) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/Settings/Settings/UploadBuildingFile', {
                method: 'post',
                body: formData
            });
    ...
    static async requestUploadBuildingGroupFile(file) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/Settings/Settings/UploadBuildingGroupFile', {
                method: 'post',
                body: formData
            });
    ...
    static async requestUploadFacilityFile(file) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/Settings/Settings/UploadFacilityFile', {
                method: 'post',
                body: formData
            });
    ...
    static async requestDownloadBuilding(siteID) {
        try {
            const jsonData = JsonManager.makeRequestDownloadBuilding(siteID);
    ...
    static async requestDownloadBuildingGroup(siteID) {
        try {
    ...
    static async requestDownloadFacility(siteID) {
        try {
            const jsonData = JsonManager.makeRequestDownloadFacility(siteID);
