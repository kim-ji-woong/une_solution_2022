        ...
        return (
			<>
				<div id={uneStyles.hsback}>
					<div id={newStyles.hsty} className={SdmsResource.UISection}>

						<div id={newStyles.hsLft}>
							<ul className={newStyles.hslMenu}>								
								<li><span className={newStyles.leftBorder}></span><a onClick={() => this.props.changeContent(HistoryResource.ID.menu.sensorDetectHistory)}>센서 탐지 이력</a></li>
								<li><span className={newStyles.leftBorder}></span><a onClick={() => this.props.changeContent(HistoryResource.ID.menu.sensorDetectAnalysis)}>센서 탐지 분석</a></li>
								<li><span className={newStyles.leftBorder}></span><a onClick={() => this.props.changeContent(HistoryResource.ID.menu.sopHistory)}>SOP 이력</a></li>
								{/* <li><span className={newStyles.leftBorder}></span><a onClick={() => this.props.changeContent(HistoryResource.ID.menu.userHistory)} className={newStyles.on}>데이터 수정 이력</a></li> */}
