...
import { SOPHistoryUI } from '../styled/HistoryStyled';
...
class SOPHistory extends Component {
	...
	async loadDisasterCategory() {
		...
		const disasterCategories = await HistoryController.LoadDisasterCategories(siteID);
	...
	render() {
		...
		return (
			<>
				<SOPHistoryUI id={'hsback'} className={SdmsResource.UISection}>
					...
					<div id={'hsty'}>
						...
						<div className={'hsScr hsScr'}>
							<span className={'detectTitle'}>SOP 이력</span>
							<div id={'hsCont'}>
								<form action="">
									<div className={'hscSch'}>
										<ul className={'hscsHalf'}>
											<li>
												<dl>
													{/* <dt>재난타입</dt> */}
													<dd className={'disasterTypeBox'} style={{ width: '470px' }}>
														<p className={'disasterTypeTitle'}>재난타입</p>
														<select name="" id="" onChange={(e) => this.onChangeDisasterType(e.target.value)} className={'disasterSelect'} /* className={newStyles.selWh} */>
															{categories}
														</select>
													</dd>
												</dl>
											...
											<li>
												<dl>
													{/* <dt>위기단계</dt> */}
													<dd className={'dangerTypeBox'}>
														<p className={'dangerTypeTitle'}>위기단계</p>
														<select name="" id="" onChange={(e) => this.onChangeStep(e.target.value)} className={'dangerTypeSelect'}>
											...
											<li>
												<dl>
													{/* <dt>모드</dt> */}
													<dd className={'modeBox'}>
														<p className={'modeTitle'}>모드</p>
														<select name="" id="" onChange={(e) => this.onChangeRealMode(e.target.value)} className={'modeSelect'}>
															<option value="전체">전체</option>
										...
										<dl>
											{/* <dt>시작시간</dt> */}
											<dd className={'startTimeBox'}>
												<p className={'startTimeTitle'}>시작시간</p>
								...
								</form>
								{
									this.state.loadingIndicator === true ?
										...
										:
										<ul className={'hscExl'}>
											<li><span className={'downIcon'}></span><a onClick={() => this.onClickDownload(true)} className={'exl'}>선택 다운로드</a></li>
											<li><span className={'downIcon'}></span><a onClick={() => this.onClickDownload(false)} className={'all'}>전체 다운로드</a></li>
										</ul>
								}
								<div className={'hscTb'}>
									<div className={'scrTb'}>
										<table>
											...
											<thead>
												<tr>
													<th className={'whiteCheckBox'}><input type="checkbox" /></th>
													<th>번호</th>
													<th>SOP유형</th>
													<th>SOP이름</th>
													<th>위기경보단계</th>
