...
import { AppContainerWrapSop, YeosuLogoBox, AppContainer, TabAreaS } from '../styled/SopStyled';
    ...
    render() {
        ...
        return (
            <>                
                ...
                <AppContainerWrapSop className={'appContainerWrapSop'}>
                    <YeosuLogoBox></YeosuLogoBox>
                    <AppContainer className={'appContainer pgProgress'}>

                        <TabAreaS className={'tabArea'}>
