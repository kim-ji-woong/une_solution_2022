...
export default class SopSimulatorController {
    static async DisplaySopRun() {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/DisplaySopRun', {
                method: 'POST',
                headers: {
    ...
    */
    ...
    static async excuteSOP(beginTime, actionStepID, position, userID, sensorZoneHistoryID) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/ExcuteSOP', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async closeSOP(actionStepHistoryID, endTime, accessedUserID) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/CloseSOPByUser', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async progressSOP(actionStepHistoryID, componentID, componentType, accessedUserID, status, text) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/ProgressSOP', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async runSection(sopKey, actionStepID, actionStepHistoryID, section, accessedUserID, decisionValue, isSkip) {
        try {
            ...
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/RunSection', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async monitorComponentHistory() {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/MonitorComponentHistory');
            const datas = await response.json();
    ...
    static async progressMission(sopKey, actionStepHistoryID, componentType, componentID, dataIndex, componentStatus, userID, checked) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/ProgressMission', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async progressSpread(sopKey, actionStepHistoryID, componentType, componentID, dataIndex, componentStatus, userID, isSMS, isEmail, isBroadcast, isSiren, message) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/ProgressSpread', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async excuteExternalProgram(sopKey, actionStepHistoryID, componentType, componentID, dataIndex, componentStatus, userID) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/ExcuteExternalProgram', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async requestSensorName(sensorZoneHistoryID) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/RequestSensorName', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    static async requestSensorMaterials(sensorZoneHistoryID) {
        try {
            const response = await fetch(ProjectResource.baseUrl + '/SOPSimulator/SOPSimulator/RequestSensorMaterials', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
