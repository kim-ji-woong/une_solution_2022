...
import EndPopup from '../../SOPSimulator/ui/popup/endPopup';

import { SubSectionTaskListWrap } from '../styled/MissionListStyled.js';
    ...
    setMissionUI() {
        ...
        for (let i = 0; i < sectionsLength; i++) {            
            if (this.props.sections[i].componentType === 0) {
                ...
                if (this.props.sections[i].isBegin) {
                    isBegin = true;
                } else {
                    isBegin = false;
                }
        ...
        return (
            <>
                ...
                <SubSectionTaskListWrap className={'taskListWrap'}>
                    ...
                    <div className={'innerSectionnnn innerscrollbar'}>
