...
import { ProcessSectionBox, ProcessArea, Tooltip, BtnArea } from '../../styled/MissionListStyled';
...
class Process extends Component {
        ...
        if (onClickType === this.onClickSMSType) {            
            ...
            if (containsNormalMission) {
                if (this.props.commonSettings.UseSMS === 'false' && this.props.commonSettings.UseEmail === 'true') {
                    ...
                    strMessage = '문자메시지와 메일을 모두 전송할까요? (이메일 서비스 없음)';
                }
            }
            else {
    ...
    onProgressSpreadAll() {
        ...
        this.props.onProgressSpread(this.props.sectionData, -1, true, false, false, false);
    }
    ...
    getMissionListUI() {
        ...
        if (this.props.currentSection?.id === this.props.sectionData?.id && this.props.currentSection?.componentType === this.props.sectionData?.componentType) {
            btnMessageClassName = 'btnAreaDisable btnMessageActive';
            ...
            btnMessageClassName = 'btnAreaDisable btnMessageDisable';
        }
                ...
                if (mission.missionType === Process.missionType.External) {
                    ...
                    missionList.push(
                        <dd className={'borderSide'} key={i}>
                            ...
                            <p className={'tit'}>{missionText}</p>
                            <p><button type="button" onClick={() => this.showConfirmDialog(this.onClickSMSType, mission)}><i className={btnMessageClassName}></i></button></p>
    ...
    render() {
        ...
        return (
            <ProcessSectionBox className={'sectionBox' + boxClassName} id={this.props.id}>
                <div className={'processArea tit clfix' + textClassName}>
                    <strong>
                ...
                <dl className={'taskDetail'}>
                    <dt>
                        <span>
                            ...
                            {/* </p> */}
                            <span className={'behaviorText'}>행동요령</span>
                        </span>
