...
import { WeatherInfoPops } from './../../styled';
import { WeatherTimeBox } from './../../styled';
import { WeatherYear } from './../../styled';
import { WeatherTime } from './../../styled';

import { WeatherIcon } from './../../styled';
import { WeatherTem } from './../../styled';
import { WeatherCelsius1 } from './../../styled';
import { WeatherCelsius2 } from './../../styled';
...
class WeatherInfo extends Component {
    ...
    getWeatherInfo() {
        ...
        if (this.state.weatherInfo.datas.length < 1) {
        ...
        return [curDate, curTime, this.getStateImage(data.state), tempHigh, tempLow]
    ...
    render() {
        ...
        const [curDate, curTime, stateImg, tempHigh, tempLow] = this.getWeatherInfo();

        return (
            <div id={this.props.popupType} className={/* content.viewDashboardBoxD + ' ' + */ content.viewDashboardWeather + " " + SDMSResource.UISection}>
                <PopupDraggable
                ...
                >
                    ...
                    <WeatherInfoPops>
                        <WeatherTimeBox>
                            {/*<WeatherYear>2022.11.14</WeatherYear>*/}
                            {/*<WeatherTime>15 : 20 : 00</WeatherTime>*/}

                            <WeatherYear>{curDate}</WeatherYear>
                            <WeatherTime>{curTime}</WeatherTime>
                        </WeatherTimeBox>
                        {/*<WeatherIcon>*/}
                        {/*    */}{/*<img className={content.weatherImage} src={stateImg} />*/}
                        {/*</WeatherIcon>*/}
