...
class StatusInfoBuildingGroup extends Component {
    ...
    render() {
        ...
        const buildingGroupName = this.props.buildingGroup.displayText ? this.props.buildingGroup.displayText : SDMSResource.ID.buildingInfo.outdoor;
        const movable = this.isMovable();//this.props.buildingGroup.textCenter !== null;

        return (
            <li>
                <div className={content.viewListHeadWrap + " " + SDMSResource.UISection} id={this.props.id}>
