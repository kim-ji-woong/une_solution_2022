export class SdmsJsonManager {
    static makeRequestTestSMS(data) {
        const json = {
            "requestTestSMS": {
                message: data,
            }
    ...
    static makeRequestAllSensors() {
        const json = {
            "requestAllSensors": true
        };

        return JSON.stringify(json);
    }

    static makeRequestSaveViewport2(locationX, locationY, locationZ, rotationX, rotationY, rotationZ) {
        const json = {
            "requestSaveViewport":
            {
                "locationX": locationX,
    ...
    static makeRequestSaveIndoorModelViewport(modelName, cameraData, zoneID) {
        const json = {
    ...
    static makeRequestWeatherInfo2() {
        const json = {
            "requestWeatherInfo2": true
        };
    ...
    static makeRequestSensorDatas() {
        const json = {
            "requestSensorDatas": true,
        };

        return JSON.stringify(json);
    }

    static makeRequestSensorDataHistory() {
        const json = {
            "requestSensorDataHistory": true
        }

        return JSON.stringify(json);
    }
    
    static makeRequestSensorDataHistoryForWeather() {
        const json = {
            "requestSensorDataHistoryForWeather": true
        }
        
        return JSON.stringify(json);
    }

    static makeRequestSensorDataHistoryByConditions(sensorType, zoneIDs, materials, dataPeriodType, beginDate, endDate) {
        const json = {
            "requestSensorDataHistoryByConditions": {
                SensorType: sensorType,
                ZoneIDs: zoneIDs,
                Materials: materials,
    ...
    static makeRequestSensorZoneHistories() {
        const json = {
            "requestSensorZoneHistories": true
        }

        return JSON.stringify(json);
    }

    static makeReqeustSensorLink() {
        const json = {
            "requestSensorLink": true
        }
        return JSON.stringify(json);
    }

    static makeRequestDownloadSensor() {
        const json = {
            "requestDownloadSensor": true
        }
        return JSON.stringify(json);
    }

    static makeUpdateSensorCoordinates(datas) {
        const json = {
