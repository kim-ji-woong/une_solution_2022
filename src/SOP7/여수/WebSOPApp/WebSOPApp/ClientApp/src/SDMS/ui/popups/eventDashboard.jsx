...
class EventDashboard extends Component {
    ...
    componentDidMount() {
        document.getElementsByClassName(content.viewDashboardBoxD + ' ' + content.viewDashboardCurrent)[0].style.opacity = 1;
    }
    ...
    render() {
        ...
        return (
            <div id={this.props.popupType} className={content.viewDashboardBoxD + ' ' + content.viewDashboardCurrent + " " + SdmsResource.UISection}>
