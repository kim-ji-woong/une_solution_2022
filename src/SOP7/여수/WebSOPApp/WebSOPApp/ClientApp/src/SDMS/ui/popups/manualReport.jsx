...
class ManualReport extends Component {
    ...
    render() {
        ...
        // GS인증 관련
        let facilityTypeUI = null;

        if (ProjectResource.isGSMode !== true) {
            facilityTypeUI = <React.Fragment>
		...
		return (
            <div id={this.props.popupType} className={content.viewDashboardBoxD + " " + content.viewDashboardManuel + " " + SDMSResource.UISection}>
                {/* 수동신고 내부 객체 사이즈 조절이 안되어 외부 사이즈 조절 불필요 */}
