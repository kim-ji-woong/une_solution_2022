								...
								<dl className={InternalProperty.cssStyles.sprmAcdn}>
									...
									<dd className={this.getReceiversClassName()}>
										<div className={InternalProperty.cssStyles.sprmSms}>
											<label className={InternalProperty.cssStyles.clickable}>
												<input type="checkbox" name="sprmSms" className={bodyStyles.labelInputS} id={InternalProperty.cssStyles.sprmSms01} checked={this.state.sectionData?.isSMS} onChange={(event) => this.onChangeMode(event, InternalProperty.SMS_Type)} />
												문자발송
											</label>
											<label className={InternalProperty.cssStyles.clickable}>
												<input type="checkbox" name="sprmSms" className={bodyStyles.labelInputS} id={InternalProperty.cssStyles.sprmSms02} checked={this.state.sectionData?.isBroadcast} onChange={(event) => this.onChangeMode(event, InternalProperty.Broadcast_Type)} />
												방송전파
											</label>
											<label className={InternalProperty.cssStyles.clickable}>
												<input type="checkbox" name="sprmSms" className={bodyStyles.labelInputS} id={InternalProperty.cssStyles.sprmSms02} checked={this.state.sectionData?.isEmail} onChange={(event) => this.onChangeMode(event, InternalProperty.Email_Type)} />
												이메일
											</label>
										</div>
										<div className={InternalProperty.cssStyles.sprmTeam}>
											<ul className={InternalProperty.cssStyles.sprmRdo}>
												<li>
													<label className={InternalProperty.cssStyles.clickable}>
														<input type="radio" name="sprmRdo" className={bodyStyles.labelInputS} id={InternalProperty.cssStyles.sprmRdo01} checked={this.state.teamType === Receiver.RegularTeam} onChange={() => this.onChangeTeamMode(Receiver.RegularTeam)} />
														정규조직
													</label>
												</li>
												<li>
													<label className={InternalProperty.cssStyles.clickable}>
														<input type="radio" name="sprmRdo" className={bodyStyles.labelInputS} id={InternalProperty.cssStyles.sprmRdo02} checked={this.state.teamType === Receiver.TemporaryNormalTeam} onChange={() => this.onChangeTeamMode(Receiver.TemporaryNormalTeam)} />
														평일 비상조직
													</label>
												</li>
												<li>
													<label className={InternalProperty.cssStyles.clickable}>
														<input type="radio" name="sprmRdo" className={bodyStyles.labelInputS} id={InternalProperty.cssStyles.sprmRdo03} checked={this.state.teamType === Receiver.TemporaryEmergencyTeam} onChange={() => this.onChangeTeamMode(Receiver.TemporaryEmergencyTeam)} />
														야간/휴일 비상조직
													</label>
												</li>
											</ul>
