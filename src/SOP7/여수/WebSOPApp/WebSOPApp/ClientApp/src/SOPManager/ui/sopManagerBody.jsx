...
class SopManagerBody extends Component {
	...
	getBodyContents() {
		if (this.props.menu === SopManager.menu.editSOP ||
			...
			//return <SaveSOPOptions sopData={this.props.menuDatas} content={this.props.content} loginUser={this.props.loginUser} onCloseConfirmDialog={this.props.onCloseConfirmDialog} />;
