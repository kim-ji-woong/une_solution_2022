...
class EndpointProperty extends Component {
    ...
    saveSectionData(shouldUpdate) {
        const sectionData = { ...this.state.sectionData };
        if (sectionData === this.refTitle.current.value) {
            return;
        }
                        ...
                        <ul className={EndpointProperty.cssStyles.sprmStend}>
                            <li>
                                <label className={EndpointProperty.cssStyles.clickable}>
                                    <input type="radio" name="sprmStend" className={bodyStyles.labelInputS} id={EndpointProperty.cssStyles.sprmStend01} checked={this.state.sectionData?.isBegin} onChange={() => this.onChange(true)} />
                                    시작
                                </label>
                            </li>
                            <li>
                                <label className={EndpointProperty.cssStyles.clickable}>
                                    <input type="radio" name="sprmStend" className={bodyStyles.labelInputS} id={EndpointProperty.cssStyles.sprmStend02} checked={!this.state.sectionData?.isBegin} onChange={() => this.onChange(false)} />
                                    종료
                                </label>
                            </li>
							</ul>
