...
class SopManagerContent extends Component {
	...
	render() {
		...
		let saveDisabledClassName = SopManagerContent.cssStyles.menuClickDisable;

		if (this.props.sopData) {
			saveDisabledClassName = SopManagerContent.cssStyles.menuClickable;
		}
				...
				<div className={SopManagerContent.cssStyles.aslWrap + " " + SopManagerContent.cssStyles.typeC}>
					...
					<div className={SopManagerContent.cssStyles.salMenu + " " + SopManagerContent.cssStyles.on}>
						...
						<dl className={SopManagerContent.cssStyles.salCont}>
							<dd><a className={SopManagerContent.cssStyles.menuClickable} onClick={(e) => this.onClickMenu(e.target)}>{SopManager.menu.newSOP}</a></dd>
							<dd><a className={SopManagerContent.cssStyles.menuClickable} onClick={(e) => this.onClickMenu(e.target)}>{SopManager.menu.open}</a></dd>
							<dd><a className={saveDisabledClassName} onClick={(e) => this.onClickMenu(e.target)}>{SopManager.menu.save}</a></dd>
							{/*<dd><a className={SopManagerContent.cssStyles.clickable} onClick={(e) => this.onClickMenu(e.target)}>{SopManager.menu.saveAs}</a></dd>*/}
							<dd><a className={SopManagerContent.cssStyles.menuClickable} onClick={(e) => this.onClickMenu(e.target)}>{SopManager.menu.delete}</a></dd>
							<dd><a className={SopManagerContent.cssStyles.menuClickable} onClick={(e) => this.onClickMenu(e.target)}>{SopManager.menu.openXML}</a></dd>
							<dd><a className={saveDisabledClassName} onClick={(e) => this.onClickMenu(e.target)}>{SopManager.menu.saveXML}</a></dd>
						</dl>
					</div>
				</div>
			</div>
