...
export default class SopController {
    /*static async openDB(disasterID = null) {
        if (disasterID) {
            ...
            await fetch(ProjectResource.baseUrl + '/SOPManager/SOP/Open?disasterID=' + disasterID)
            ...
            await fetch(ProjectResource.baseUrl + '/SOPManager/SOP/DisasterCategories')
                .then(function (response) {
                    return response.json();
                })
    ...
    /*static async saveDB(sopData) {
        ...
        const response = await fetch(ProjectResource.baseUrl + '/SOPManager/SOP/Save', {
            method: 'POST',
            headers: {
    ...
    static async requestOpenXML(file) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/SOPManager/SOP/OpenXML', {
                method: 'post',
                body: formData
            });
