...
namespace WebSOPApp.Areas.Account.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public IActionResult RequestData([FromBody] AccountData data)
        {
            ...
            else if (data.RequestCheckBrowserID != null)
                return CheckBrowserID(data.RequestCheckBrowserID);

            return BadRequest();
        }

        private IActionResult CheckBrowserID(CheckBrowserID data)
        {
            ...
            result = m_processManager.GetAccountManager().CheckBrowserID(userID, sessionKey);
