...
namespace WebSOPApp.Areas.SOPSimulator.Controllers
{
    ...
    public class SOPSimulatorController : Controller
    {
       ...
       [HttpPost]
        ...
        [HttpPost]
        public IActionResult RequestSensorMaterials([FromBody] RequestSensorMaterials data)
        {
            ResponseSensorMaterials result = m_processManager.GetLoadManager().RequestSensorMaterials(data.SensorZoneHistoryID);
            return Ok(result);
        }
    }
}
