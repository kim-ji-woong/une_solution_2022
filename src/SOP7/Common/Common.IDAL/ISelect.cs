...
namespace Common.IDAL
{
    ...
    public interface ISelect
    {
        ...
        List<Options> SelectOption(Options.OptionTarget eTargetName, string strPropertyName, int nSiteID, out string strErrorMessage);
        ...
        BroadcastHistory SelectBroadcastHistory(int actionStepHistoryID, int componentID, out string strErrorMessage);
        List<BroadcastHistory> SelectBroadcastHistories(Dictionary<BroadcastHistory.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        List<BroadcastHistory> SelectBroadcastHistories(Dictionary<BroadcastHistory.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage);
        ...
        ArrayList JoinActionStepHistoryActionStepDisaster(Dictionary<ActionStepHistory.Fields, object> dicConditions1, Dictionary<ActionStep.Fields, object> dicConditions2, Dictionary<Disaster.Fields, object> dicConditions3, string strAdditionalConditions, out string strErrorMessage);
        ArrayList JoinActionStepHistoryActionStepDisaster(Dictionary<ActionStepHistory.Fields, object> dicConditions1, Dictionary<ActionStep.Fields, object> dicConditions2, Dictionary<Disaster.Fields, object> dicConditions3, string strAdditionalConditions, int? topNCount, out string strErrorMessage);
    }
}
