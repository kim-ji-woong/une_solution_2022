...
namespace Common.IDAL
{
    ...
    public interface IDelete
    {
        ...
        bool DeleteBroadcastHistory(int actionStepHistoryID, int componentID, out string strErrorMessage);
        bool DeleteBroadcastHistory(Dictionary<BroadcastHistory.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
