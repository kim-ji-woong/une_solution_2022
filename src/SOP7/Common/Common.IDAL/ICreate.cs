...
namespace Common.IDAL
{
    ...
    public interface ICreate
    {
        ...
        /// </summary>
        /// <param name="nActionStepHistoryID"></param>
        /// <param name="nComponentID">InternalTransmission에 대한 참조(내부상황전파의 ID)</param>
        /// <param name="eventTime"></param>
        /// <param name="status">
        /// 0 : 방송실행, 1 : 방송완료, 2 : 방송중지, 3 : 일시정지, 4 : Error
        /// </param>
        /// <returns></returns>
        BroadcastHistory CreateBroadcastHistory(int nActionStepHistoryID, int nComponentID, DateTime eventTime, int status, out string strErrorMessage);
