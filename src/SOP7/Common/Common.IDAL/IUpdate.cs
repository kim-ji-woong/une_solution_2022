...
namespace Common.IDAL
{
    ...
    public interface IUpdate
    {
        ...
        bool UpdateBroadcastHistory(BroadcastHistory obj, out string strErrorMessage);
        bool UpdateBroadcastHistory(Dictionary<BroadcastHistory.Fields, object> dicSets, Dictionary<BroadcastHistory.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        // strCondition : where를 제외한 조건문
