namespace Common.DAL
{
    ...
    public class UpdateManager : QueryManager, IUpdate
    {
        ...
        public bool UpdateBroadcastHistory(BroadcastHistory obj, out string strErrorMessage)
        {
            Dictionary<BroadcastHistory.Fields, object> dicSets = new Dictionary<BroadcastHistory.Fields, object>();
            dicSets[BroadcastHistory.Fields.EventTime] = obj.EventTime;
            dicSets[BroadcastHistory.Fields.Status] = obj.Status;

            Dictionary<BroadcastHistory.Fields, object> dicConditions = new Dictionary<BroadcastHistory.Fields, object>();
            dicConditions[BroadcastHistory.Fields.ActionStepHistoryID] = obj.ActionStepHistoryID;
            dicConditions[BroadcastHistory.Fields.ComponentID] = obj.ComponentID;

            return UpdateBroadcastHistory(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateBroadcastHistory(Dictionary<BroadcastHistory.Fields, object> dicSets, Dictionary<BroadcastHistory.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<BroadcastHistory.Fields>(ref strSets, dicSets, BroadcastHistory.GetFieldName, BroadcastHistory.TableName, ref strErrorMessage) == false)
                return false;
            ...
            return UpdateFromCondition(BroadcastHistory.TableName, strSets, strCondition, strAdditionalConditions, out strErrorMessage);
        }
