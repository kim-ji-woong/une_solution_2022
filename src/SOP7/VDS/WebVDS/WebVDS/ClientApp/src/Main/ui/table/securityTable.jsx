...
class SecurityTable extends Component {
    ...
    onChangeInputText = (data, column, value) => {
        ...
        } else if (column === "basic_EquipType" && data.basic_EquipType !== value) {
            this.props.isModifiy(true);
            data.basic_EquipType = value;
    ...
    onChangeCheck = (target, data) => {
        ...
        if (target.checked) {
            // 체크한 경우
            checkList.push(data.securityID);
    ...
    getTableDataUI2 = () => {
        ...
        if (displayData?.length > 0) {
            ...
            for (let i = beginNum; i < endNum; i++) {
                ...
                tableDataUI1.push(
                    <tr key={data.securityID + "_1_" + rowIndex} className={main.tableTr}>
                ...
                tableDataUI2.push(
                    <tr key={data.securityID + "_2_" + rowIndex} className={main.tableTr}>
                ...
                tableDataUI3.push(
                    <tr key={data.securityID + "_3_" + rowIndex} className={main.tableTr}>
                ...
                tableDataUI4.push(
                    <tr key={data.securityID + "_4_" + rowIndex} className={main.tableTr}>
                        ...
                        <td onKeyDown={(e) => this.onTabClick(e, this.refTable5, rowIndex + 2)}><InputText type="text" value={data.hW_IP} onChange={(value) => this.onChangeInputText(data, "hW_IP", value)} editMode={this.props.editMode} /></td>
                    </tr>
                );
                tableDataUI5.push(
                    <tr key={data.securityID + "_5_" + rowIndex} className={main.tableTr}>
                ...
                tableDataUI6.push(
                    <tr key={data.securityID + "_6_" + rowIndex} className={main.tableTr}>
                        <td></td>
                    </tr>
                );
    ...
    getItemData() {
        ...
        for (let i = 0; i < count; i++) {
            ...
            if (!itemData.basic_Name || itemData.basic_Name.trim().length === 0) {
                return [null, `No(${i+1}) 보안장비명은 필수요소입니다. 비워둘수 없습니다.`, null];
            }
            ...
            if (!itemData.basic_ItemLevel || itemData.basic_ItemLevel.trim().length === 0) {
                return [null, `No(${i+1}) 보안등급은 필수요소입니다. 비워둘수 없습니다.`, null];
            }
        ...
        return [itemDatas, null, InventoryManagement.itemType.Security];
    }
    ...
    render() {
        ...
        return (
            <>
                <div className={main.securityTable}>
                    <table ref={this.refTable1} border="1" style={{ minWidth: '8%' }}>
                        <thead>
                            <tr style={{ height: '78px' }}>
                                ...
                                <th rowspan="3" style={{ position: 'relative' }}><span className={main.essentialBorder}></span>보안장비명<span className={main.bottomArrowIcon} onClick={() => this.onClickSort("basic_Name")}></span></th>
                            </tr>
                        </thead>
                        <tbody>
                            {tableDataUI1}
                    ...
                    <table ref={this.refTable2} border="1" className="generalTable" style={{ minWidth: '70%' }}>
                        <thead>
                            <tr>
                                <th colspan="15">기본정보<span className={main.gleftArrowIcon} onClick={() => this.props.onClickCheck("generalCheckbox")}></span></th>
                            </tr>
                            <tr>
                                ...
                                <th rowspan="2">보안장비구분<span className={main.downArrowIcon} onClick={() => this.onClickSort("basic_EquipType")}></span></th>
                                <th rowspan="2">보안장비상세분류<span className={main.downArrowIcon} onClick={() => this.onClickSort("basic_EquipDetailClass")}></span></th>
                                ...
                                <th rowspan="2" style={{ position: 'relative' }}><span className={main.essentialBorder}></span>보안 등급<span className={main.downArrowIcon} onClick={() => this.onClickSort("basic_ItemLevel")}></span></th>
                    ...
                    <table ref={this.refTable3} border="1" className="maintenanceTable" style={{ minWidth: '44%' }}>
                        <thead>
                    ...
                    <table ref={this.refTable4} border="1" className="hardwareTable" style={{ minWidth: '18%' }}>
                        <thead>
                            <tr style={{ height: '26px' }}>
                                <th colspan="5">하드웨어정보<span className={main.hleftArrowIcon} onClick={() => this.props.onClickCheck("hardwareCheckbox")}></span></th>
                            </tr>
                            <tr style={{ height: '52px' }}>
                                ...
                                <th rowspan="2">IP<span className={main.downArrowIcon} onClick={() => this.onClickSort("hW_IP")}></span></th>
                            </tr>
                        </thead>
                        <tbody>
                            {tableDataUI4}
                    ...
                    <table ref={this.refTable5} border="1" className="connectTable" style={{ minWidth: '10%' }}>
                        <thead>
                            <tr style={{ height: '26px' }}>
