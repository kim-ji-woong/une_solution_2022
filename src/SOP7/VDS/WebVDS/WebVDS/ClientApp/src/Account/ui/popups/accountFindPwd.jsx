            ...
            <>
                ...
                <div id={contents.popupConts} className={contents.loginPopup}>
                    ...
                    <div className={contents.indexLoginTitle}><img className={accounts.logoSizeYeosu} src={Ylogo} alt="여수" /></div>
                        <span className={contents.loginTitleYeosu}>Virtual Data System</span>

                    <div className={contents.indexLoginBoxY}>
                        {/* yeosu */}
                        <ul>
                            <li><input type="text" className={contents.indexLoginYeosu} /* onKeyPress={(e) => this.onKeyPressLogin(e)} */ placeholder="이름을 입력하세요." /></li>
                            <li><input type="password" className={contents.indexLoginPwYeosu} /* onKeyPress={(e) => this.onKeyPressLogin(e)} */ placeholder="핸드폰 번호를 입력하세요." /></li>
                        </ul>

                        <div className={uis.btnArea}>
                          <a className={contents.btnLoginYeosu} onClick={this.onClickSetPwd}>비밀번호 찾기</a>
