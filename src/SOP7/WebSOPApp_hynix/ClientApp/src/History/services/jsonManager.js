export default class JsonManager{    
    ...
    static makeRequestSensorDetectHistoryQuery(condition, lastSensorZoneHistoryID, rowCount, siteID) {
        const json = {
            "condition": condition,
            "lastSensorZoneHistoryID": lastSensorZoneHistoryID,
            "rowCount": rowCount,
    ...
    static makeRequestSensorDetectAnalysisQuery(condition, siteID) {
        const json = {
            "condition": condition,
            "siteID": siteID
        };
    ...
    static makeRequestSensorDetectCondition(beginTime, endTime, facilityType, buildingGroupID, buildingID, zoneID) {
        const json = {
            "beginTime": beginTime,
            "endTime": endTime,
            "facilityType": facilityType,
