...
export default class HistoryController {
    ...
    static async DisplaySensorDetectHistoryQuery(condition, lastSensorZoneHistoryID, rowCount, siteID) {
        try {
            const jsonData = JsonManager.makeRequestSensorDetectHistoryQuery(condition, lastSensorZoneHistoryID, rowCount, siteID);

            const res = await fetch('History/History/RequestSensorDetectHistoryQuery', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async DisplaySensorDetectAnalysisQuery(condition, siteID) {
        try {
            const jsonData = JsonManager.makeRequestSensorDetectAnalysisQuery(condition, siteID);

            const res = await fetch('History/History/RequestSensorDetectAnalysisQuery', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestSensorDetectCondition(beginTime, endTime, facilityType, buildingGroupID, buildingID, zoneID) {
        try {
            const jsonData = JsonManager.makeRequestSensorDetectCondition(beginTime, endTime, facilityType, buildingGroupID, buildingID, zoneID);

            const res = await fetch('History/History/RequestSensorDetectCondition', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestSensorAnalysisCondition(beginTime, endTime, facilityType, buildingGroupID, buildingID, zoneID) {
        try {
            const jsonData = JsonManager.makeRequestSensorDetectCondition(beginTime, endTime, facilityType, buildingGroupID, buildingID, zoneID);
