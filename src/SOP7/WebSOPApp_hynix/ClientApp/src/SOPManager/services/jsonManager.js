...
export default class JsonManager{
    ...
    static makeRequestDisasterCategories(isNormal, siteID) {
        const json = {
    ...
    static makeRequestStepMemberData(siteID) {
        const json = {
            "requestDefault":
            {
                "siteID": siteID,
    ...
    static makeRequestLinkedSopDatas(siteID) {
        const json = {
            "requestLinkedSopDatas": {
                "SiteID": siteID
            }
        };
    ...
    static makeRequestLoadLinkedSopVersions(siteID, versionIDs) {
        const json = {
            "RequestLoadLinkedSopVersions":
            {
                "siteID": siteID,
                "versionIDs": versionIDs
            }
    ...
    static makeCheckSectionValidation(sectionData, stepMemberID) {
        const json = {
            "checkSectionData": {
    ...
    static makeCheckSectionValidation(sectionData, stepMemberID, userID) {
        const json = {
            "checkSectionData": {
                "sectionData": sectionData,
                "stepMemberID": stepMemberID,
    ...
    static makeCheckArrowValidation(arrowData, stepMemberID, userID) {
        const json = {
            "checkSectionData": {
                "sectionData": {
                    "componentType": arrowData.componentType,
                    "text": arrowData.text
                },
                "stepMemberID": stepMemberID,
                "userID": userID
