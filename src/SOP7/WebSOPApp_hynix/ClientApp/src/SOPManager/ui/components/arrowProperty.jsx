        ...
        return (
            <div className={ArrowProperty.cssStyles.sprCont + " " + commonStyles.pt0}>
                <div className={ArrowProperty.cssStyles.sprmExp}>
                    <div>
                        <h4>{i18n.t('sopManager.formText.화살표 작성')}</h4>
                        <div className={"scroll-wrapper " + ArrowProperty.cssStyles.sprmExTxt + " scrollbar-outer scroll-textarea"} id="pos_relative">
                            <div className="scroll-content" id="annotation_scrollContent">
                                <textarea ref={this.refText} name="" id="" cols="30" rows="10" className={ArrowProperty.cssStyles.sprmExTxt + " scrollbar-outer"} defaultValue={i18nUtil.convertText(this.state.arrowData?.text)} onChange={this.onChangeText}></textarea>
                            </div>
                ...
                <div className={ArrowProperty.cssStyles.sprBot}>
                    <a className={ArrowProperty.cssStyles.clickable} onClick={() => this.onClickApply(true)}>{i18n.t('common.확인')}</a>
                    <a className={ArrowProperty.cssStyles.clickable} onClick={() => this.onClickApply(false)}>{i18n.t('common.취소')}</a>
                </div>
            </div>
        );
    }
...
export default withTranslation()(ArrowProperty);