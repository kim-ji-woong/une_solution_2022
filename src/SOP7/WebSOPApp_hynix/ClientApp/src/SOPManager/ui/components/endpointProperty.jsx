...
class EndpointProperty extends Component {
    ...
    onChange(isBegin) {
        ...
        this.props.onApplyComponentProperty(sectionData, this.props.actionStep, false);
    }
        ...
        return (
            <div className={EndpointProperty.cssStyles.sprCont + " " + commonStyles.pt0}>
                <div className={EndpointProperty.cssStyles.sprmExp + " " + EndpointProperty.cssStyles.stend}>
                    <div>
                        <h4>{i18n.t('sopManager.formText.시작/끝 작성')}</h4>
                        <div className={"scroll-wrapper " + EndpointProperty.cssStyles.sprmExTxt + " scrollbar-outer scroll-textarea"} id="pos_relative">
                            <div className="scroll-content" id="endpoint_scrollContent">
                                <textarea ref={this.refTitle} name="" id="" cols="30" rows="10" className={EndpointProperty.cssStyles.sprmExTxt + " scrollbar-outer"} defaultValue={i18nUtil.convertText(this.state.sectionData?.text)} onChange={this.onChangeText}></textarea>
                            </div>
                ...
                <div className={EndpointProperty.cssStyles.sprBot}>
                    <a className={EndpointProperty.cssStyles.clickable} onClick={() => this.onClickApply(false)}>{i18n.t('common.취소')}</a>
                    <a className={EndpointProperty.cssStyles.clickable} onClick={() => this.onClickApply(true)}>{i18n.t('common.확인')}</a>                    
                </div>
				</div>
            );
    }
...
export default withTranslation()(EndpointProperty);