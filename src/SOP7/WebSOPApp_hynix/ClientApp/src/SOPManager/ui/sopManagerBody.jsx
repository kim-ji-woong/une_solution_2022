...
import { SopManagerBodyComponent } from '../styled/sopManagerStyled';
...
class SopManagerBody extends Component {
	...
	getBodyContents() {
		if (this.props.menu === SopManagerResource.menu.SOP_편집||
			this.props.menu === SopManagerResource.menu.열기) {
			return <SopManagerBodyMain sopData={this.props.menuDatas} loginUser={this.props.loginUser} showCascading={this.props.showCascading} content={this.props.content} changeCascadingMode={this.props.changeCascadingMode} showConfirmDialog={this.props.showConfirmDialog} selectedSiteID={this.props.selectedSiteID} />;
		}
		else if (this.props.menu === SopManagerResource.menu.새_SOP) {
			return <NewSOPOptions content={this.props.content} sopData={this.props.sopData} loginUser={this.props.loginUser} selectedSiteID={this.props.selectedSiteID} onChangeSite={this.props.onChangeSite} />;
		}
		else if (this.props.menu === SopManagerResource.menu.저장) {
	...
	render() {
		return (
			<SopManagerBodyComponent className={'sopCont'}>
				<h2 id={'sopTitle'}>{i18n.t('sopManager.menu.SOP 편집')}</h2>
				{
...
export default withTranslation()(SopManagerBody);