...
class SMMainNavMenu extends Component {
    constructor(props) {
        ...
        this.state = {
            menuButtons:
                [
                    { isActive: false, dataType: "newSOP", menuName: SopManagerResource.menu.새_SOP },
                    { isActive: false, dataType: "openSOP", menuName: SopManagerResource.menu.열기 },
                    { isActive: false, dataType: "saveSOP", menuName: SopManagerResource.menu.저장 },
                    { isActive: false, dataType: "deleteSOP", menuName: SopManagerResource.menu.삭제 }
                ],
        };
    }
