    ...
    setAccountUserTable = () => {
        ...
        if (accountUsers != null) {
            for (let i = 0; i < accountUsers.length; i++) {
                ...
                accountLevelComboBax.push(<option key="-1" value="-1"> {i18n.t('account.선택')}</option >);
			...
			<>
                <div id={contents.popupConts} className="overScrollY">
                    ...
                    <div className={contents.popupBox} style={{ padding: "25px 30px" }}>
                        <div className={contents.popupBoxTitle}>{i18n.t('account.사용자 권한 등록')}</div>
                        <div className={contents.popupBoxX}><a onClick={this.onClickClosePopup}><img src={imgClose} alt={i18n.t('common.닫기')} /></a></div>
                            ...
                            <table className={contents.tblNone}>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" ref={this.refName} className={contents.blueInput + " " + contents.w90p} placeholder={i18n.t('account.이름을 입력하세요')} /></td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td rowSpan="2"><a onClick={this.onClickSearch} className={contents.searchBlueBtn}>{i18n.t('account.검색')}</a></td>
                                    </tr>
                                    <tr>
                        ...
                        <div className={uis.floatL}>{i18n.t('account.검색결과')}</div>
                        <div className={uis.floatR} >
                            <a onClick={this.onClickAdd} className={contents.lightSkyBtn}>{i18n.t('account.추가')}</a>
                        </div>
                        ...
                        <div className={uis.floatL}>{i18n.t('account.선택 결과')}</div>
                        <div className={uis.floatR}>
                            <a onClick={this.onClickRemove} className={contents.lightNaveBtn}>{i18n.t('common.삭제')}</a>
                        </div>
                        ...
                        <div className={uis.btnArea + " " + uis.alignC}>
                            <a onClick={this.onClickConfirm} className={contents.btnBlue}>{i18n.t('common.확인')}</a>
