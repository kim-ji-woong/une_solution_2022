...
export const _SectionGridComponent = {
    soulbrain: {
        ...
        waitComponentLineHeight: '20px !important',
    },
    Wonik: {
        sectionComponentProcessRoundLineHeight: '20px',
        sectionComponentInternalLineHeight: '20px',
    ...
    Hydrogen: {
        ...
        runComponentBackground: `#00AFFF`,
        runComponentBorder: `var(--sizeBorderLine) solid #00AFFF`,
        doneComponentBackground: `#000F15`,
        doneComponentBorder: `var(--sizeBorderLine) solid #000F15`,
        skipComponentBackground: `#000F15`,
        skipComponentBorder: `var(--sizeBorderLine) solid #00AFFF`,
        decisionOuterBackground: `#00AFFF`,
        internalOuterCurrentBackground: `#00AFFF`,
...
/* 
    ...
    .waitComponent {
        ...
        line-height: ${_SectionGridComponent[PR.styleMode].waitComponentLineHeight};
