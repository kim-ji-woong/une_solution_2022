...
import entrantInfoIcon from '../img/popup/entrantInfoIcon.svg';
import cctvIcon from '../img/popup/cctvIcon.svg';
import arrow_right from '../img/popup/arrow_right.svg';
import arrow_left from '../img/popup/arrow_left.svg';
...
export const EntrantInfoComponent = styled(PopupsCommon)`
    position: absolute;
    left: 10px;
    top: 245px;
    ...
    .dslTop {
        button {
            ...
            ${(props) => props.theme.variables.flex('center', 'center')};
            border-radius: 4px;
            background: #CECFD2 url(${entrantInfoIcon}) no-repeat center center;
            position: absolute;
            right: 40px;
            top: 4px;
            z-index: 1;
...
export const ForcedDoorOpenInfoComponent = styled(PopupsCommon)`
    position: absolute;
    left: 10px;
    top: 245px;
    ...
    .dslCont {
        ...
        .btnWrap {
            ...
            .navArrow {
                ...
                &.left {
                    background: transparent url(${arrow_left}) no-repeat center center;
                }

                &.right {
                    background: transparent url(${arrow_right}) no-repeat center center;
                }
                ...
                &:disabled {
                    ...
                    user-select: none;
                    cursor: default;
                    filter: brightness(0) saturate(100%) invert(50%) sepia(10%) saturate(120%) hue-rotate(182deg) brightness(80%) contrast(95%);
                }
            }
        }
    }
...
export const EntranRoutetInfoComponent = styled(PopupsCommon)`
    position: absolute;
    left: 10px;
    top: 245px;
    width: 328px !important;
    ...
    .dslCont {
        ...
        > ul {
            > li {
                ...
                > button {
                    text-indent: -9999px;
                    background: transparent url(${cctvIcon}) no-repeat center center;
                    width: 20px;
                    height: 20px;
                    ${(props) => props.theme.variables.flex('center', 'center')};
                    border-radius: 4px;
...
export const NotPermittedItemInfoComponent = styled(PopupsCommon)`
    position: absolute;
    left: 10px;
    top: 245px;
    width: 328px !important;
