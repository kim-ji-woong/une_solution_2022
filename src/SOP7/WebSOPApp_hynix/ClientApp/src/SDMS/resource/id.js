...
export default class SdmsResource {
    static menu = {
        ...
        // 하이닉스 -------------------------
        출입자_상세정보: "출입자 상세정보",
        출입자_경로_상세보기: "출입자 경로 상세보기",
        출입거부_이후_강제_문열림: "출입거부 이후 강제 문열림",
        물품_상세보기: "물품 상세보기",
        하이닉스_CCTV: "하이닉스_CCTV",
    }
    ...
    static facilityType = {
        ...
        ForcedDoorOpen: 951,                 // 강제 문열림 (출입거부 이후 강제 문열림)
        CheatedTagging: 952,                // 대리태깅
        Untagging: 953,                     // 꼬리물기
        StealCard: 954,                     // 사원증도용
        Stranger: 955,                      // 이상행위자
        EvasionItem: 956,                   // 무인 보안검색 우회
        NotPermittedPerson: 957,            // 비인가 구역 출입
        NotPermittedItem: 958,              // 비인가 구역 반입
        CardTag: 959,                       // 사원증 태깅
        SmartTag: 960,                      // 스마트태그 태깅
        CardReader: 961                     // 카드리더
    }
    ...
    static popupResetLocation = {
        ...
        hynixCCTV: {
            x: '70%', y: '57%', height: '380px', width: '360px'
        },
        workerInfo: {
        ...
        entrantInfo: {
            x: '76%', y: '15%', height: '256px', width: '328px'
        },
        entranRoutetInfo: {
            x: '76%', y: '15%', height: '256px', width: '328px'
        },
        forcedDoorOpenInfo: {
            x: '76%', y: '15%', height: '328px', width: '392px'
        },
    ...
    static popupLayer = {
        ...
        entranRoutetInfo: "entranRoutetInfo",
        forcedDoorOpenInfo: "forcedDoorOpenInfo",
        notPermittedItemInfo: "notPermittedItemInfo"
    }
