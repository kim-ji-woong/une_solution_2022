...
class Dashboard extends Component {
    ...
    getConnStateUI(facilityType) {
        ...
        if (facilityType === SDMSResource.facilityType.FIRE) {
            if (serverConnState.ServerConnState_Fire === "false" ||
                (ProjectResource.SiteID === ProjectResource.Site.GCC && (serverConnState.ServerConnState_Fire === "0" || serverConnState.ServerConnState_Fire === "1" || serverConnState.ServerConnState_Fire === "2"))) {
    ...
    makeConnErrorMsg = (serverConnState, data) => {
        ...
        if (serverConnState === null) {
            if (data.ServerConnState_Fire === "false"
                || (ProjectResource.SiteID === ProjectResource.Site.GCC && (data.ServerConnState_Fire === "0" || data.ServerConnState_Fire === "1" || data.ServerConnState_Fire === "2"))) {
                message = i18n.t('facilityType.화재센서');

                if (ProjectResource.SiteID === ProjectResource.Site.GCC) {
                    if (data.ServerConnState_Fire === "0") {
                        message = "동방";
                    } else if (data.ServerConnState_Fire === "1") {
                        message = "지멘스";
                    } else if (data.ServerConnState_Fire === "2") {
                        message = "동방, 지멘스";
                    }
                }
            ...
            if (serverConnState.ServerConnState_Fire !== data.ServerConnState_Fire &&
                (data.ServerConnState_Fire === "false" || (ProjectResource.SiteID === ProjectResource.Site.GCC && (data.ServerConnState_Fire === "0" || data.ServerConnState_Fire === "1" || data.ServerConnState_Fire === "2")))) {
                message = i18n.t('facilityType.화재센서');
    ...
    render() {
        ...
        if (ProjectResource.siteID === ProjectResource.Site.Soulbrain ||
            ...
            (ProjectResource.siteID === ProjectResource.Site.GG_A && this.props.selectSiteID === ProjectResource.Site.GG_A))
