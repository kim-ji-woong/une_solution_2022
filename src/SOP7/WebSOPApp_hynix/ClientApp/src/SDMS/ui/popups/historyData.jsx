...
class HistoryData extends Component {
    ...
    async LoadScoreData() {
        ...
        if (equipZoneID !== null) {
            const [suc, zoneScoresData] = await AssessmentController.LoadZoneAssessmentHistories(beginDate, endDate, zoneID, siteID, equipZoneID);

            if (suc)
                zoneScores = zoneScoresData;
        }

        this.setState({ scores, zoneScores });
    }
