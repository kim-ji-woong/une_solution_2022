...
export class BuildingInfoManager {
    static getBuildingInfo(type, id, siteID, _3dOptions, sensorList, currentView, poiManager) {
        ...
        else if (type === SDMSMainMenu.Hynix_SmartTagReader ||
            type === SDMSMainMenu.Hynix_CardReader ||
            type === SDMSMainMenu.Hynix_Door
        ) {
            return BuildingInfoManager.getHynixPOIInfo(type, id, _3dOptions, currentView);
        }

        return null;
    }

    static getHynixPOIInfo(type, id, _3dOptions, currentView, zoneIDs = null, index = null) {
    ...
    static getFirstAidEquipmentTypeName(type) {
        ...
        else if (type === SDMSMainMenu.Hynix_Door) {
            return "Door";
        }
        else if (type === SDMSMainMenu.Hynix_CardReader) {
            return "CardReader";
        }
        else if (type === SDMSMainMenu.Hynix_SmartTagReader) {
            return "SmartTagReader";
        }
