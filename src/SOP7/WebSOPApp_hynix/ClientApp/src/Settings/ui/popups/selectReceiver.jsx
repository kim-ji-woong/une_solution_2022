...
import { SelectReceiverComponent } from '../../styled/settingsStyled';
        ...
        return (
            <SelectReceiverComponent>
				<div id={'dshPop'}>
					<div>
						<div>
							<div className={'dspCont'}>
								<div className='dspTop'>
									<h4 className={'dspTitle'}>{i18n.t('setting.monitoring3D.수신자 편집')}</h4>
									<a className={'dspX'} onClick={this.onClickClose}></a>
								</div>
								<div className='dspBottom'>
									<div className={'stgmTo'}>
										<span>{i18n.t('setting.monitoring3D.유형')} : </span>
										<p>{facilityType}</p>
									</div>
									<div className={'stgmTo'}>
										<span>{i18n.t('common.위치')} : </span>
										<p>{location}</p>
									</div>
												...
												<div className={'stguTh'}>
													<table>
														...
														<thead className={'pointDefault'}>
															<tr>
																<th>No</th>
																<th>{i18n.t('setting.monitoring3D.팀원')}</th>
															</tr>
														</thead>
													</table>
												</div>
										...
										<div>
											<div className={'stguAdd'}>
												<div>
													<div>
														<ul>
															<li><a onClick={this.addReceiver}>{i18n.t('common.추가')}</a></li>
															<li><a onClick={this.deleteReceiver}>{i18n.t('common.삭제')}</a></li>
														</ul>
													</div>
												</div>
											</div>
												...
												<div className={'stguTh'}>
													<table>
														...
														<thead className={'pointDefault'}>
															<tr>
																<th>No</th>
																<th>{i18n.t('setting.monitoring3D.이름')}</th>
															</tr>
														</thead>
													</table>
												</div>
									...
									<ul className={'dspBtnNew'}>
										<li><a onClick={this.onClickConfirm}>{i18n.t('common.확인')}</a></li>
										<li><a onClick={this.onClickClose}>{i18n.t('common.취소')}</a></li>
									</ul>
								</div>
							</div>
						</div>
...
export default withTranslation()(SelectReceiver);