...
export default createStore(function (state, action) {
    if (state === undefined) {
        ...
        return {
            ...
            selectSiteID: state.selectSiteID,
    ...
    else if (action.type === 'SELECT_SITEID') {
        return {
            shortcutKey: state.shortcutKey,
            popupState: state.popupState,
            idleTime: state.idleTime,
            ...
            turnStart: state.turnStart,
            useAlarmTurn: state.useAlarmTurn,
            selectSiteID: action.selectSiteID,
            isEditMode: state.isEditMode,
            actionType: action.type
        }
    }
    else if (action.type === 'IS_EDIT_MODE') {
        return {
            shortcutKey: state.shortcutKey,
            popupState: state.popupState,
            idleTime: state.idleTime,
    ...
    else if (action.type === 'UPDATED_SENSOR_LIST') {
        return {
            shortcutKey: state.shortcutKey,
            popupState: state.popupState,
            idleTime: state.idleTime,
