export default class JsonManager{
    ...
    static makeSaveSettings(saveData, siteID) {
        const json = {
            "requestSaveSettings":
            {
                ...
                "usePropertyDatas": saveData.usePropertyDatas
            }
        };
    ...
    static makeRequestDownloadRegularTeams(siteIDs) {
        const json = {
            "requestDownloadRegularTeam":
            {
                "siteIDs": siteIDs
    ...
    static makeRequestLogDeletePolicy() {
        const json = {
        };
    ...
    static makeSaveLogDeletePolicy(deleteOption, siteID) {
        const json = {
