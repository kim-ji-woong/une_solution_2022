...
namespace WebSOPApp.Areas.SDMS.Controllers
{
    ...
    public class SDMSController : Controller
    {
        ...
        private Hynix.BLL.ProcessManager m_hynixProcessManager = null;

        public SDMSController(global::SDMS.IDAL.IDataManager sdmsDataManager, global::Common.IDAL.IDataManager commonDataManager, global::SOPManager.IDAL.IDataManager sopDataManager, global::TeamEditor.IDAL.IDataManager teamDataManager, global::Hynix.IDAL.IDataManager hynixDataManager)
        {          
            ...
            m_hynixProcessManager = new Hynix.BLL.ProcessManager(commonDataManager, hynixDataManager, sdmsDataManager, sopDataManager, teamDataManager);
        }

        [EnableCors("UnEPolicy")]
        [HttpPost]
        public Hynix.BLL.Response.ResponseAlarmEx DisplayAlarm()
        {
            ...
            //return alarms;
            return m_hynixProcessManager.ToResponseAlarmEx(alarms);
        }
        ...
        {
            ResponseSensorList result = m_processManager.GetLoadManager().GetSensorList(request);
            Hynix.BLL.Response.ResponseSensorListEx response = m_hynixProcessManager.ToResponseSensorListEx(result);
            return Ok(response);
        }
        ...
        {
            if (request.SensorType < (int)AgentFactory.BLL.Facility.FacilityType.Event_ForcedDoorOpen)
                m_processManager.GetAlarmManager().Malfunction(request);
            else
                m_hynixProcessManager.Malfunction(m_processManager.SOPWebServerURL, request.SensorType, request.SensorZoneID, request.AccessedUserID, request.IsMalfunction);
        ...
        private IActionResult RequestTodayAlarmData()
        {
            ...
            Hynix.BLL.Response.ResponseTodayAlarmDataEx response = m_hynixProcessManager.ToTodayAlarmDataEx(result);
            return Ok(response);
        }
