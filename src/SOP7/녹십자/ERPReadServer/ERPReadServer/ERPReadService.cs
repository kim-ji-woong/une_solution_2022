...
namespace ERPReadServer
{
    partial class ERPReadService : ServiceBase
    {
        ...
        {
            Logger.Instance.Write("LoadERPTable-1");
            ...
            Logger.Instance.Write("LoadERPTable-2");
            ...
            Logger.Instance.Write("LoadERPTable-3");
            ...
            if (dtTeam == null)
                return false;
            Logger.Instance.Write("LoadERPTable-4");
            return true;
        }
