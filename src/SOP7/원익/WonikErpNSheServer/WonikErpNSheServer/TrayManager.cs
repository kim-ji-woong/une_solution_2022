...
namespace WonikErpNSheServer
{
    public class TrayManager
    {
        ...
        private DirectDBManager m_dbBackup30 = null;
        private DirectDBManager m_dbBackup31 = null;

        private string m_backupFilePath = "";

        DBBackup m_dbBackup = null;
        ...
        public TrayManager()
        {
            try
            {
                ...
                this.Logger = Logger.Instance.Clone("LOG_TrayManager");

                Init();

                m_dbBackup = new DBBackup(m_dbBackup30, m_dbBackup31, m_backupFilePath);
            ...
            {
                this.Logger.Write($"[ERROR] {ex.Message}");
            }
        }
        ...
        private void CreateNotifyicon()
        {
            ...
            m_icon.Icon = global::WonikErpNSheServer.Properties.Resources.SDMS_BLUE;
        ...
        private void Init()
        {
            ...
            // 백업 관련
            m_backupFilePath = ConfigurationManager.AppSettings.Get("backupFilePath");

            string strDBName2 = ConfigurationManager.AppSettings.Get("DB_NAME2");
            if (strDBName2 == null || strDBName2.Length == 0)
                strDBName2 = "WSOP_31";

            m_dbBackup30 = new DirectDBManager(nDBType, strDBHost, strDBName, strDBId, strDBPw);
            m_dbBackup31 = new DirectDBManager(nDBType, strDBHost, strDBName2, strDBId, strDBPw);
        }
    }
}
