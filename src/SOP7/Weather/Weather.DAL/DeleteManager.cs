...
namespace Weather.DAL
{
    ...
    public class DeleteManager : QueryManager, IDelete
    {
        ...
        public bool DeleteCurrent2(int nWeatherSiteID, out string strErrorMessage)
        {
            bool isNullable;
            string strSQL = string.Format("Delete from {0} where {1} = {2}", Current2.TableName, Current2.GetFieldName(Current2.Fields.WeatherSiteID, out isNullable), nWeatherSiteID);
        ...
        public bool DeleteCurrent2(Dictionary<Current2.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            string strSQL = string.Format("Delete from {0}", Current2.TableName);
