    ...
    public class SelectManager : QueryManager, ISelect
    {
        ...
        private Weekly ReadWeekly(ArrayList arrResult, int index, out string strErrorMessage)
        {
            ...
            foreach (Weekly.Fields field in Weekly.Fields.GetValues(typeof(Weekly.Fields)))
            {
                ...
                else if (field == Weekly.Fields.OneDayMiniTemp)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                    ...
                    if (data == null)
                    {
                        ...
                        model.OneDayMiniTemp = data.Data;
                }
                else if (field == Weekly.Fields.TwoDayMiniTemp)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                    ...
                    if (data == null)
                    {
                        ...
                        model.TwoDayMiniTemp = data.Data;
                }
                else if (field == Weekly.Fields.ThreeDayMiniTemp)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                    ...
                    if (data == null)
                    {
                        ...
                        model.ThreeDayMiniTemp = data.Data;
                }
                else if (field == Weekly.Fields.FourDayMiniTemp)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                    ...
                    if (data == null)
                    {
                        ...
                        model.FourDayMiniTemp = data.Data;
                }
                else if (field == Weekly.Fields.FiveDayMiniTemp)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                    ...
                    if (data == null)
                    {
                        ...
                        model.FiveDayMiniTemp = data.Data;
                }
                else if (field == Weekly.Fields.SixDayMiniTemp)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                    ...
                    if (data == null)
                    {
                        ...
                        model.SixDayMiniTemp = data.Data;
                }
        ...
        public Current2 SelectCurrent2(int nWeatherSiteID, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;
            bool isNullable;

            string strSQL = string.Format("select {0} from {1} where {2} = {3}", GetFieldNames<Current2.Fields>(out nFieldCount), Current2.TableName, Current2.GetFieldName(Current2.Fields.WeatherSiteID, out isNullable), nWeatherSiteID);
            ArrayList arrResult = m_dbManager.GetResultData(strSQL);

            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                Current2 model = ReadCurrent2(arrResult, 0, out strErrorMessage);
        ...
        public List<Current2> SelectCurrent2s(Dictionary<Current2.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectCurrent2s(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<Current2> SelectCurrent2s(Dictionary<Current2.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<Current2.Fields>(out nFieldCount), Current2.TableName);

            string strCondition = "";

            if (SetCondition<Current2.Fields>(ref strCondition, dicConditions, Current2.GetFieldName, Current2.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<Current2> current2s = new List<Current2>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                Current2 model = ReadCurrent2(arrResult, i, out strErrorMessage);
        ...
        private Current2 ReadCurrent2(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            bool isNullable;
            Current2 model = new Current2();

            foreach (Current2.Fields field in Current2.Fields.GetValues(typeof(Current2.Fields)))
            {
                string strFieldName = Current2.GetFieldName(field, out isNullable);

                if (field == Current2.Fields.WeatherSiteID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Current2.Fields.Temperature)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Current2.Fields.State)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Current2.Fields.Rain)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Current2.Fields.Humidity)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Current2.Fields.WindSpeed)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Current2.Fields.WindDirection)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Current2.Fields.Atm)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Current2.Fields.UpdateTime)
                {
                    VariousData<DateTime> data = WebDBManager.GetDateTimeField(arrResult[index]);
                ...
                else if (field == Current2.Fields.TemperatureHigh)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                    ...
                    if (data == null)
                    {
                        ...
                        model.TemperatureHigh = data.Data;
                }
                else if (field == Current2.Fields.TemperatureLow)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                    ...
                    if (data == null)
                    {
                        ...
                        model.TemperatureLow = data.Data;
                }
