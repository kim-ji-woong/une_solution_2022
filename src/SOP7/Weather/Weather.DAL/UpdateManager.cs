...
namespace Weather.DAL
{
    ...
    public class UpdateManager : QueryManager, IUpdate
    {
        ...
        public bool UpdateWeekly(Weekly weekly, out string strErrorMessage)
        {
            ...
            dicSets[Weekly.Fields.OneDayMiniTemp] = weekly.OneDayMiniTemp;
            dicSets[Weekly.Fields.TwoDayMiniTemp] = weekly.TwoDayMiniTemp;
            dicSets[Weekly.Fields.ThreeDayMiniTemp] = weekly.ThreeDayMiniTemp;
            dicSets[Weekly.Fields.FourDayMiniTemp] = weekly.FourDayMiniTemp;
            dicSets[Weekly.Fields.FiveDayMiniTemp] = weekly.FiveDayMiniTemp;
            dicSets[Weekly.Fields.SixDayMiniTemp] = weekly.SixDayMiniTemp;
        ...
        public bool UpdateCurrent2(Current2 current2, out string strErrorMessage)
        {
            Dictionary<Current2.Fields, object> dicSets = new Dictionary<Current2.Fields, object>();
            dicSets[Current2.Fields.Atm] = current2.Atm;
            dicSets[Current2.Fields.Humidity] = current2.Humidity;
            dicSets[Current2.Fields.Rain] = current2.Rain;
            dicSets[Current2.Fields.State] = current2.State;
            dicSets[Current2.Fields.Temperature] = current2.Temperature;
            dicSets[Current2.Fields.UpdateTime] = current2.UpdateTime;
            dicSets[Current2.Fields.WindDirection] = current2.WindDirection;
            dicSets[Current2.Fields.WindSpeed] = current2.WindSpeed;
            dicSets[Current2.Fields.TemperatureHigh] = current2.TemperatureHigh;
            dicSets[Current2.Fields.TemperatureLow] = current2.TemperatureLow;

            Dictionary<Current2.Fields, object> dicConditions = new Dictionary<Current2.Fields, object>();
            dicConditions[Current2.Fields.WeatherSiteID] = current2.WeatherSiteID;

            return UpdateCurrent2(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateCurrent2(Dictionary<Current2.Fields, object> dicSets, Dictionary<Current2.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<Current2.Fields>(ref strSets, dicSets, Current2.GetFieldName, Current2.TableName, ref strErrorMessage) == false)
                return false;
            ...
            string strSQL = string.Format("Update {0} set {1} where {2}", Current2.TableName, strSets, strCondition);
