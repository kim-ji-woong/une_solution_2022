...
namespace Weather.IDAL
{
    ...
    public interface IDelete
    {
        ...
        bool DeleteCurrent2(int nWeatherSiteID, out string strErrorMessage);
        bool DeleteCurrent2(Dictionary<Current2.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
