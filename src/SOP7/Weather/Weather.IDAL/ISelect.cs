...
namespace Weather.IDAL
{
    ...
    public interface ISelect
    {
        ...
        Current2 SelectCurrent2(int nWeatherSiteID, out string strErrorMessage);
        List<Current2> SelectCurrent2s(Dictionary<Current2.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        List<Current2> SelectCurrent2s(Dictionary<Current2.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage);
