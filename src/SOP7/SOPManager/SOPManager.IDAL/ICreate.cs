...
namespace SOPManager.IDAL
{
    ...
    public interface ICreate
    {
        ...
        User CreateUser(int? nMemberID, int nUserLevel, string strUserID, string strPassword, string strNickName, int nSiteID, string strSalt, string strPasswordCode = null);
        ...
        Session CreateSession(int nAccountUserID, string strSessionKey, DateTime dtCreateDate, DateTime dtUpdateeDate, bool autoLogin, string browserID);
        ...
        Version CreateVersion(bool isNormal, DateTime dtCreate, DateTime dtLastAcess, string strVersionName, int? ownerID, int nSiteID, string strDescription = null);
        ...
        LinkedSop CreateLinkedSop(int nFacilityTypeID, int nDisasterCategoryID, int nSubDisasterCategoryID, string strDisasterName, int? nLinkedBuildingGroupID, int? nLinkedBuildingID, int? nLinkedZoneID, string strDescription, int nSiteID);
