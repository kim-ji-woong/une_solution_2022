...
namespace SOPManager.DAL
{
    ...
    public class UpdateManager : QueryManager, IUpdate
    {
        ...
        public bool UpdateVersion(Dictionary<Model.Sop.Category.Version.Fields, object> dicSets, string strCondition, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strSets = "";

            if (SetData<Model.Sop.Category.Version.Fields>(ref strSets, dicSets, Model.Sop.Category.Version.GetFieldName, Model.Sop.Category.Version.TableName, ref strErrorMessage) == false)
                return false;
            ...
            string strSQL = string.Format("Update {0} set {1} where {2}", Model.Sop.Category.Version.TableName, strSets, strCondition);
