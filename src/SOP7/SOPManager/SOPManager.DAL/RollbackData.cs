...
namespace SOPManager.DAL
{
    ...
    public class RollbackData : IRollbackData
    {
        ...
        {
            DataManager _dataManager = (DataManager)dataManager;
            DirectDBManager dbManager = _dataManager.GetDBManager() as DirectDBManager;
            ...
            if (m_insertRollbackQueries != null)
            {
                ...
                {
                    if (dbManager.GetResultData(strSQL) == null)
                        return false;
                }
            }
        ...
        public bool AddInsertRollback(IDataManager dataManager, string strSelectSQL, params object[] args)
        {
            ...
            ArrayList arrResult = dbManager.GetResultData(strSelectSQL);
