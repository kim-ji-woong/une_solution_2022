namespace SOPManager.DAL
{
    ...
    public class CreateManager : QueryManager, ICreate
    {
        ...
        public User CreateUser(int? nMemberID, int nUserLevel, string strUserID, string strPassword, string strNickName, int nSiteID, string strSalt, string strPasswordCode = null)
        {
            ...
            dicFieldDatas[User.Fields.Salt] = strSalt;
            ...
            if (arrResult != null)
            {
                ...
                if (IsSameUser(datas[0], nMemberID, nUserLevel, strUserID, strPassword, strNickName, nSiteID, strSalt, strPasswordCode))
                    return datas[0];

                return GetUser(nMemberID, nUserLevel, strUserID, strPassword, strNickName, nSiteID, strSalt, strPasswordCode, User.TableName, strPKFieldName, datas[0].ID, 2, FindCountLimit, out m_strErrorMessage);
            }
            else
            {
                m_strErrorMessage = m_dbManager.LastErrorMessage;
        ...
        private User GetUser(int? nMemberID, int nUserLevel, string strUserID, string strPassword, string strNickName, int nSiteID, string strSalt, string strPasswordCode, string tableName, string strPKFieldName, int id, int nCount, int nLimit, out string strErrorMessage)
        {
            string strCondition = string.Format("{0} < {1} order by {0} desc", strPKFieldName, id);
            ...
            {
                if (IsSameUser(data, nMemberID, nUserLevel, strUserID, strPassword, strNickName, nSiteID, strSalt, strPasswordCode))
                    return data;
            ...
            if (nCount < nLimit)
                return GetUser(nMemberID, nUserLevel, strUserID, strPassword, strNickName, nSiteID, strSalt, strPasswordCode, tableName, strPKFieldName, id, nCount * 2, nLimit, out strErrorMessage);

            strErrorMessage = GetInsertErrorMessage(tableName);
            return null;
        }

        private bool IsSameUser(User user, int? nMemberID, int nUserLevel, string strUserID, string strPassword, string strNickName, int nSiteID, string strSalt, string strPasswordCode)
        {
        ...
        {
            if (EqualsValue(internalTransmission.GridID, nGridID) &&
                EqualsValue(internalTransmission.GridRowIndex, nGridRowIndex) &&
                EqualsValue(internalTransmission.GridColumnIndex, nGridColumnIndex) &&
                IsSameFloatData2(internalTransmission.Width, fWidth) &&
                IsSameFloatData2(internalTransmission.Height, fHeight) &&
                EqualsValue(internalTransmission.Text, strText) &&
                EqualsValue(internalTransmission.ComponentID, strComponentID) &&
                EqualsValue(internalTransmission.UseSMS, useSMS) &&
                EqualsValue(internalTransmission.UseBroadcast, useBroadcast) &&
                EqualsValue(internalTransmission.UseEmail, useEmail) &&
                EqualsValue(internalTransmission.StepMemberID, nStepMemberID) &&
                EqualsValue(internalTransmission.AutoRun, autoRun) &&
                EqualsValue(internalTransmission.Message, strMessage) &&
                IsSameReceiverList(internalTransmission.TeamList, teamList) &&
                EqualsValue(internalTransmission.UseSiren, useSiren) &&
                EqualsValue(internalTransmission.OnlyTeamLeader, onlyTeamLeader) &&
                EqualsValue(internalTransmission.SectionNumber, nSectionNumber) &&
                EqualsValue(internalTransmission.VAlign, nVAlign) &&
                EqualsValue(internalTransmission.HAlign, nHAlign) &&
                EqualsValue(internalTransmission.FontName, strFontName) &&
                EqualsValue(internalTransmission.FontStyle, nFontStyle) &&
                IsSameFloatData(internalTransmission.FontSize, fFontSize) &&
                IsSameFloatData(internalTransmission.LineSpace, fLineSpace) &&
                EqualsValue(internalTransmission.FontColor, nFontColor))
                return true;
        ...
        {
            if (EqualsValue(process.GridID, nGridID) &&
                EqualsValue(process.GridRowIndex, nGridRowIndex) &&
                EqualsValue(process.GridColumnIndex, nGridColumnIndex) &&
                IsSameFloatData2(process.Width, fWidth) &&
                IsSameFloatData2(process.Height, fHeight) &&
                EqualsValue(process.Text, strText) &&
                IsSameReceiverList(process.TeamList, teamList) &&
                EqualsValue(process.ComponentID, strComponentID) &&
                EqualsValue(process.StepMemberID, nStepMemberID) &&
                EqualsValue(process.AutoRun, autoRun) &&
                EqualsValue(process.OnlyTeamLeader, onlyTeamLeader) &&
                EqualsValue(process.SectionNumber, nSectionNumber) &&
                EqualsValue(process.VAlign, nVAlign) &&
                EqualsValue(process.HAlign, nHAlign) &&
                EqualsValue(process.FontName, strFontName) &&
                EqualsValue(process.FontStyle, nFontStyle) &&
                IsSameFloatData(process.FontSize, fFontSize) &&
                IsSameFloatData(process.LineSpace, fLineSpace) &&
                EqualsValue(process.FontColor, nFontColor))
                return true;
        ...
        {
            strMissionText = strMissionText.Replace("․", ".");
        ...
        public Model.Sop.Category.Version CreateVersion(bool isNormal, DateTime dtCreate, DateTime dtLastAccess, string strVersionName, int? ownerID, int nSiteID, string strDescription = null)
        {
            ...
            dicFieldDatas[Model.Sop.Category.Version.Fields.OwnerID] = ownerID;
            ...
            if (arrResult != null)
            {
                ...
                if (IsSameVersion(datas[0], isNormal, dtCreate, dtLastAccess, strVersionName, ownerID, nSiteID, strDescription))
                    return datas[0];

                return GetVersion(isNormal, dtCreate, dtLastAccess, strVersionName, ownerID, nSiteID, strDescription, Model.Sop.Category.Version.TableName, strPKFieldName, datas[0].ID, 2, FindCountLimit, out m_strErrorMessage);
            }
            else
            {
                m_strErrorMessage = m_dbManager.LastErrorMessage;
        ...
        private Model.Sop.Category.Version GetVersion(bool isNormal, DateTime dtCreate, DateTime dtLastAccess, string strVersionName, int? ownerID, int nSiteID, string strDescription, string tableName, string strPKFieldName, int id, int nCount, int nLimit, out string strErrorMessage)
        {
            string strCondition = string.Format("{0} < {1} order by {0} desc", strPKFieldName, id);
            ...
            {
                if (IsSameVersion(data, isNormal, dtCreate, dtLastAccess, strVersionName, ownerID, nSiteID, strDescription))
                    return data;
            ...
            if (nCount < nLimit)
                return GetVersion(isNormal, dtCreate, dtLastAccess, strVersionName, ownerID, nSiteID, strDescription, tableName, strPKFieldName, id, nCount * 2, nLimit, out strErrorMessage);

            strErrorMessage = GetInsertErrorMessage(tableName);
            return null;
        }

        private bool IsSameVersion(Model.Sop.Category.Version version, bool isNormal, DateTime dtCreate, DateTime dtLastAccess, string strVersionName, int? ownerID, int nSiteID, string strDescription)
        {
        ...
        public Session CreateSession(int nAccountUserID, string strSessionKey, DateTime dtCreateDate, DateTime dtUpdateeDate, bool autoLogin, string browserID)
        {
            ...
            dicFieldDatas[Session.Fields.BrowserID] = browserID;
        ...
        public LinkedSop CreateLinkedSop(int nFacilityTypeID, int nDisasterCategoryID, int nSubDisasterCategoryID, string strDisasterName, int? nLinkedBuildingGroupID, int? nLinkedBuildingID, int? nLinkedZoneID, string strDescription, int nSiteID)
        {
            ...
            dicFieldDatas[LinkedSop.Fields.LinkedBuildingGroupID] = nLinkedBuildingGroupID;
            ...
            dicFieldDatas[LinkedSop.Fields.SiteID] = nSiteID;
            ...
            if (arrResult != null)
            {
                ...
                if (IsSameLinkedSop(datas[0], nFacilityTypeID, nDisasterCategoryID, nSubDisasterCategoryID, strDisasterName, nLinkedBuildingGroupID, nLinkedBuildingID, nLinkedZoneID, strDescription, nSiteID))
                    return datas[0];

                return GetLinkedSop(nFacilityTypeID, nDisasterCategoryID, nSubDisasterCategoryID, strDisasterName, nLinkedBuildingGroupID, nLinkedBuildingID, nLinkedZoneID, strDescription, nSiteID, LinkedSop.TableName, strPKFieldName, datas[0].ID, 2, FindCountLimit, out m_strErrorMessage);
            }
            else
            {
                m_strErrorMessage = m_dbManager.LastErrorMessage;
        ...
        private LinkedSop GetLinkedSop(int nFacilityTypeID, int nDisasterCategoryID, int nSubDisasterCategoryID, string strDisasterName, int? nLinkedBuildingGroupID, int? nLinkedBuildingID, int? nLinkedZoneID, string strDescription, int nSiteID, string tableName, string strPKFieldName, int id, int nCount, int nLimit, out string strErrorMessage)
        {
            string strCondition = string.Format("{0} < {1} order by {0} desc", strPKFieldName, id);
            ...
            {
                if (IsSameLinkedSop(data, nFacilityTypeID, nDisasterCategoryID, nSubDisasterCategoryID, strDisasterName, nLinkedBuildingGroupID, nLinkedBuildingID, nLinkedZoneID, strDescription, nSiteID))
                    return data;
            ...
            if (nCount < nLimit)
                return GetLinkedSop(nFacilityTypeID, nDisasterCategoryID, nSubDisasterCategoryID, strDisasterName, nLinkedBuildingGroupID, nLinkedBuildingID, nLinkedZoneID, strDescription, nSiteID, tableName, strPKFieldName, id, nCount * 2, nLimit, out strErrorMessage);

            strErrorMessage = GetInsertErrorMessage(tableName);
            return null;
        }

        private bool IsSameLinkedSop(LinkedSop sop, int nFacilityTypeID, int nDisasterCategoryID, int nSubDisasterCategoryID, string strDisasterName, int? nLinkedBuildingGroupID, int? nLinkedBuildingID, int? nLinkedZoneID, string strDescription, int nSiteID)
        {
            if (sop.FacilityTypeID == nFacilityTypeID &&
                ...
                sop.LinkedBuildingGroupID == nLinkedBuildingGroupID &&
