...
namespace SOPManager.BLL.Models.Request
{
    ...
    public class RequestData
    {
        ...
        private RequestLinkedSopDatas m_requestLinkedSopDatas = null;
        private RequestSaveLinkedSOPs m_requestSaveLinkedSOPs = null;
        ...
        public RequestLinkedSopDatas RequestLinkedSopDatas
        {
            get { return m_requestLinkedSopDatas; }
            set { m_requestLinkedSopDatas = value; }
        }

        public RequestSaveLinkedSOPs RequestSaveLinkedSOPs
        {
            get { return m_requestSaveLinkedSOPs; }
            set { m_requestSaveLinkedSOPs = value; }
        }
    ...
    public class RequestSaveLinkedSOPs
    {
        public int SiteID { get; set; }
        public List<LinkedSopData> LinkedSopDatas { get; set; }
    }
    public class RequestLinkedSopDatas
    {
        public int? SiteID { get; set; }
    }
