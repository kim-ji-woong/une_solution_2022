...
namespace XmlToExcel.Data.Sensor
{
    public class FireSensor : Fire
    {
        ...
        public static SensorType MakeSensorType(int id)
        {
            ...
            sensorType.SubType.Add(new SensorSubType(-1, "일반"));
            sensorType.SubType.Add(new SensorSubType(0, "열"));
            sensorType.SubType.Add(new SensorSubType(1, "연기"));
            sensorType.SubType.Add(new SensorSubType(2, "불꽃"));
