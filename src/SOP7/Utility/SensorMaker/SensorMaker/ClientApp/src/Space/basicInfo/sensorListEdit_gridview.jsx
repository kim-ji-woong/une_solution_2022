...
export class SensorListEdit_gridView extends Component {
    ...
    onRowClick = (sensor, index) => {
        ...
        this.props.parentFrm.lastSelectedControl = SensorListEdit.LastSelectedControlType.gridView;
            ...
            if (this.props.curSensorType === SpaceDataManager.FireSensorType) {
                ui.push(
                    <tr key={this.props.curSensorType + '_' + sensor.id} id={this.props.curSensorType + '_' + sensor.id} ref={this.refRow} draggable={true} className={selectedRowClassName} onClick={() => this.onRowClick(sensor, tempIndex)} onMouseDown={() => this.onRowMouseDown(sensor, tempIndex)}>
                        ...
                        <td className={space.fireTd4}><ColText sensor={sensor} valueType={'positionName'} value={this.props.getZoneName(sensor.zoneID)} isEditMode={this.props.isEditMode} onChangeSensor={this.onChangeSensor} /></td>
                        {
                ...
                ui.push(
                    <tr key={this.props.curSensorType + '_' + sensor.id} id={this.props.curSensorType + '_' + sensor.id} ref={this.refRow} draggable={true} className={selectedRowClassName} onClick={() => this.onRowClick(sensor, tempIndex)}>
                        ...
                        <td className={space.psmTd3}><ColText sensor={sensor} valueType={'materialType'} value={sensor.materialName} isEditMode={this.props.isEditMode} onChangeSensor={this.onChangeSensor} /></td>
                        <td className={space.psmTd4}><ColText sensor={sensor} valueType={'positionName'} value={this.props.getZoneName(sensor.zoneID)} isEditMode={this.props.isEditMode} onChangeSensor={this.onChangeSensor} /></td>
                        {
                ...
                ui.push(
                    <tr key={this.props.curSensorType + '_' + sensor.id} id={this.props.curSensorType + '_' + sensor.id} ref={this.refRow} draggable={true} className={selectedRowClassName} onClick={() => this.onRowClick(sensor, tempIndex)}>
                        ...
                        <td className={space.etcTd4}><ColText sensor={sensor} valueType={'positionName'} value={this.props.getZoneName(sensor.zoneID)} isEditMode={this.props.isEditMode} onChangeSensor={this.onChangeSensor} /></td>
                        {
            ...
            /* cctv type */
                ...
                ui.push(
                    <tr key={this.props.curSensorType + '_' + sensor.id} id={this.props.curSensorType + '_' + sensor.id} ref={this.refRow} draggable={true} className={selectedRowClassName} onClick={() => this.onRowClick(sensor, tempIndex)}>
                        ...
                        <td className={space.cctvTd7}><ColText sensor={sensor} valueType={'positionName'} value={this.props.getZoneName(sensor.zoneID)} isEditMode={this.props.isEditMode} onChangeSensor={this.onChangeSensor} /></td>
