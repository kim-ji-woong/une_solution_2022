        ...
        return (
            <div className={styles.navBarMenu}>
                ...
                <div className={styles.xmlArea}>
                    ...
                    <input type='file' style={{ display: "none" }} accept=".xml" ref={this.refXmlUpload} onChange={(e) => this.props.onOpenXML(e)} />
                    <span className={styles.xmlUpload} ref={this.refXmlUploadTemp}>XML 업로드</span>
