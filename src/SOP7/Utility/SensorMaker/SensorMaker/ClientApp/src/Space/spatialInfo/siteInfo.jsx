...
export class SiteInfo extends Component {
    ...
    enableButtons(enabled) {
        if (this.refBtnApply.current && this.refBtnCancel.current) {
            this.refBtnApply.current.disabled = !enabled;
            this.refBtnCancel.current.disabled = !enabled;
        }
    }
               ...
               <div className={styles.areaInfoContent}>
                    ...
                    </div>
                    {
                        ...
                        <div className={styles.modelBtnBox}>
                           {/* <button ref={this.refBtnCancel} className={styles.btnRightCancel} onClick={() => this.onClickCancel()}>취소</button>
                            <button ref={this.refBtnApply} className={styles.btnRightApply + " " + styles.leftMargin} onClick={() => this.onClickApply()}>적용</button> */}

                                <button ref={this.refBtnCancel} className={styles.btnRight + " " + styles.rightMargin} onClick={() => this.onClickCancel()}>취소</button>
                                <button ref={this.refBtnApply} className={styles.btnRight + " " + styles.leftMargin} onClick={() => this.onClickApply()}>적용</button> 
                        </div>
                    }
                 {/* </div> */} {/* dslCont */}
            </div>
