...
export class DeliveryManager {
    ...
    onChangeEquipZone = (e/*: ChangeEvent<HTMLInputElement> | any*/) => {        
        if (!this.object.props.parentFrm) {
            return;
        }

        if (this.object.props.parentFrm.lastSelectedControl === SensorListEdit.LastSelectedControlType.gridView) {
        ...
        else if (this.object.props.parentFrm.lastSelectedControl === SensorListEdit.LastSelectedControlType.treeView) {
            if (this.object.props.parentFrm.props.selectedNodes && this.object.props.parentFrm.props.selectedNodes.length > 0) {
                this.object.onChangeSensorZone(this.object.props.parentFrm.props.selectedNodes);
            }
        }
    }
