...
namespace SensorMaker
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string strDbHost = Configuration["AppConfig:Site:DbHost"];
            string strDbID = Configuration["AppConfig:Site:DbID"];
            string strDbPW = Configuration["AppConfig:Site:DbPw"];
                ...
                strDbPW.Trim().Length > 0)
            {
                ...
                {
                    services.AddTransient(service => new OptionManager(strSystemMail, strAdminMail, strSystemCode, strSiteURL, strSolutionName, strExternalLogin));
                }
            }
        }
