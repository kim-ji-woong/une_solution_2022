...
namespace SensorMaker.BLL
{
    ...
    public class ModelFileManager
    {
        ...
        public static MessageResult UploadTempFile(Stream stream, string strFileName, int nUserID, string strUserName, string strRootResource, IDataManager dataManager)
        {
            ...
            string strFolderPath = GetResourceFolder(nUserID, strUserName/*member.MemberName*/, strRootResource);
