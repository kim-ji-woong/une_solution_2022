...
namespace SensorMaker.BLL
{
    public class XmlManager
    {
        ...
        public XmlManager()
        {
            m_sensorTypes.Add(FireSensor.MakeSensorType((int)FacilityType.FIRE_SENSOR));
            m_sensorTypes.Add(PSMSensor.MakeSensorType((int)FacilityType.PSM_SENSOR));
            m_sensorTypes.Add(EtcSensor.MakeSensorType((int)FacilityType.ETC));
            m_sensorTypes.Add(CCTVSensor.MakeSensorType((int)FacilityType.CCTV));
        }
        ...
        private bool ReadEachSensor(XElement xe, string xName, out string strErrorMessage)
        {
            try
            {
                ...
                string strMaterialName = FindElementValue(xe, XmlKey.XName_MaterialName);
                ...
                else if (sensor is PSMSensor)
                {
                    ...
                    ps.MaterialName = strMaterialName;
                ...
                while (reader.Read())
                {
                    ...
                    switch (readerName)
                    {
                        ...
                        case XmlKey.XName_MaterialType:
                            ...
                            break;
                        case XmlKey.XName_MaterialName:
                            strMaterialName = reader.ReadInnerXml();
                            break;
                    }
                }
        ...
        private void MakeSensorInner(XElement parentEle, string strKey, object sensor)
        {
            try
            {
                ...
                else if (sensor is PSMSensor)
                {
                    ...
                    strMaterialName = ps.MaterialName;
                ...
                {
                    MakeElement(xFs, XmlKey.XName_MaterialName, strMaterialName);
