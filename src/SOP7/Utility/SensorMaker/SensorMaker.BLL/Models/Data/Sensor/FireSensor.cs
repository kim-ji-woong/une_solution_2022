...
namespace SensorMaker.BLL.Models.Data.Sensor
{
    ...
    public class FireSensor : Fire
    {
        ...
        public static SensorType MakeSensorType(int id)
        {
            SensorType sensorType = new SensorType(id, "화재");

            sensorType.SubType.Add(new Basic.SensorSubType(-1, "일반"));
            sensorType.SubType.Add(new Basic.SensorSubType(0, "열"));
            sensorType.SubType.Add(new Basic.SensorSubType(1, "연기"));
            sensorType.SubType.Add(new Basic.SensorSubType(2, "불꽃"));
