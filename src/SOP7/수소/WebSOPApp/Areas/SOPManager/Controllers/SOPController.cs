...
namespace WebSOPApp.Areas.SOPManager.Controllers
{
    ...
    public class SOPController : Controller
    {
        ...
        public SOPController(global::SOPManager.IDAL.IDataManager sopDataManager, global::Common.IDAL.IDataManager commonDataManager, global::TeamEditor.IDAL.IDataManager teamDataManager, global::SDMS.IDAL.IDataManager sdmsDataManager, global::Hydrogen.IDAL.IDataManager hyDataManager)
        {
        ...
        public IActionResult RequestClearLinkedSops()
        {
            Hydrogen.BLL.Models.MessageResult result = m_hydroProcessManager.LoadManager.ClearLinkedSops();
            return Ok(result);
        }
    }
}
