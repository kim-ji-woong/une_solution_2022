...
class SensorSimulator extends Component {
    ...
    async readSensorList() {
        ...
        if (result) {
            ...
            if (_3dOptions) {
                if (result.h2Sensors) {
                    this.setSensorList(result.h2Sensors, _3dOptions, sensorList, SdmsResource.facilityType.H2);
                }

                if (result.tempSensors) {
                    this.setSensorList(result.tempSensors, _3dOptions, sensorList, SdmsResource.facilityType.Temp);
                }
