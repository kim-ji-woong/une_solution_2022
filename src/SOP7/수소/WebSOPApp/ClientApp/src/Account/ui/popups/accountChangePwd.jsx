...
class accountChangePwd extends Component {
    ...
    onClick = () => {
        ...
        if (error.length > 0) {
            this.props.showConfirmDialog(i18n.t('account.에러'), [error], null, null);
            return;
        }
    ...
    async setPassword(pwd, newPwd) {
        ...
        if (user === null || user === undefined) {
            ...
            this.props.showConfirmDialog(i18n.t('account.에러'), [message], null, null);
        ...
        if (result === null) {
            ...
            this.props.showConfirmDialog(i18n.t('account.성공'), [i18n.t('account.비밀번호 변경 성공')], [i18n.t('common.확인')], this.onClickCancle);
