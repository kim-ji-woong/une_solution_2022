            ...
            this.props.buttons.map((button, index) => {
                if (this.props.onClickButton) {
                    if (button === "오작동") {
                        ...
                        buttons.push(
                            <button key={"button_" + index} className={'close'} onClick={() => this.props.onClickButton(index)} title="단축키(Enter)">{button}</button>
                        );
                    } else {
                        buttons.push(
                            <button key={"button_" + index} className={'close'} onClick={() => this.props.onClickButton(index)}>{button}</button>
                        );
                    }
