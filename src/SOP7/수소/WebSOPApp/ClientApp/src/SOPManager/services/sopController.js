...
export default class SopController {
    ...
    static async requestDefaultStepMemberData(actionStep, siteID) {
        try {
            const jsonData = JsonManager.makeRequestStepMemberData(siteID);
    ...
    static async requestLinkedSOPs(siteID) {
        try {
    ...
    static async requestLoadLinkedSopVersions(siteID, versionIDs) {
        try {
            const jsonData = JsonManager.makeRequestLoadLinkedSopVersions(siteID, versionIDs);
    ...
    static async requestClearLinkedSops() {
        try {
            const res = await fetch('SOPManager/SOP/RequestClearLinkedSops', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
