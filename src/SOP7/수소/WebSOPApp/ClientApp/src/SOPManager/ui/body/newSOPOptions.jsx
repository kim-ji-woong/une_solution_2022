...
class NewSOPOptions extends Component {
	...
	openManagerDrop = () => {
		const element = document.getElementById("openManagerDrop");
		const elementArrow = document.getElementById("managerArrow");
		const elementBtn = document.getElementById("managerBtn"); 
