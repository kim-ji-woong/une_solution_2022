...
class ComponentProperties extends Component {
    ...
    getComponentProperty() {
        if (this.props.sectionData.componentType === SectionDataEndpoint.getComponentType() || this.props.sectionData.componentType === SectionData.EndpointType) {
            ...
            return <ProcessProperty sectionData={this.props.sectionData} teamAllTreeDatas={this.props.sopData.teamAllTreeDatas} actionStep={this.props.actionStep} onApplyComponentProperty={this.props.onApplyComponentProperty} onClickCancel={this.onClickCancel} />
        }
            ...
            return <InternalProperty sectionData={this.props.sectionData} teamAllTreeDatas={this.props.sopData.teamAllTreeDatas} actionStep={this.props.actionStep} onApplyComponentProperty={this.props.onApplyComponentProperty} onClickCancel={this.onClickCancel} />
        }
        return <></>
    }
