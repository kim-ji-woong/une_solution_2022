...
import { SimulatorSBcallSection, AppContainer, SubSectionMenualListWrap, SubSectionBoardListWrap, Noti, CGreenNoti, DateStyle, InnerSection, NumList } from '../styled/sopSimulatorStyled';
                                ...
                                disaster.push(
                                    <li key={'disaster/' + lastAccessVersion.id}>
                                        <a key={d} onClick={() => this.onSelectVersion(lastAccessVersion.id)}>
                                            ...
                                            <DateStyle>{lastAccessTime}</DateStyle>
                                        </a>
                                    </li>
                                );
                            }
            ...
            <SimulatorSBcallSection>
                ...
                <AppContainer>
                    <SubSectionMenualListWrap className={'subSection menualListWrap'}>                        
                        <dl>
                            {
                                this.props.siteList && this.props.siteList.length > 1 &&
