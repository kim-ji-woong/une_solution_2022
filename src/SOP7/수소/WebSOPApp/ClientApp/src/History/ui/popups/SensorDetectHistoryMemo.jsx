...
class SensorDetectHistoryMemo extends Component {
    ...
    render() {
        ...
        memoUI =
                <>
                <div className={'dslTopHydrogen'}>
                    <h5 className={'dslTitle'}>
                        {i18n.t('history.memo.메모')}
                    </h5>
                    <a className={'dslTopX'} onClick={() => this.props.setPopupMemo(false)}></a>
                </div>
