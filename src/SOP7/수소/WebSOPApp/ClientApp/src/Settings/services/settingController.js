...
export class SettingController {
    ...
    static async WatchSettings() {
        const selectSiteID = SettingsStore?.getState()?.selectSiteID;
        if (!selectSiteID)
            return;
    ...
    static async requestSettings(userID, siteID) {
        try {
            ...
            const res = await fetch('Settings/Settings/RequestSettings_Hydrogen', {
                method: 'post',
                headers: {
            ...
            const jsonData = JSON.stringify(
                {
                    ...
                    "useReceiveH2": saveData.useReceiveH2,
                    "useReceiveFlow": saveData.useReceiveFlow,
                    "useReceiveConductivity": saveData.useReceiveConductivity,
                    "useReceiveTemp": saveData.useReceiveTemp,
                    "useReceivePressure": saveData.useReceivePressure,
                    "useReceiveGAS": saveData.useReceiveGAS,
                    ...
                    "alarmAutoEnd": saveData.alarmAutoEnd,
                    "sopWaitEndTime": saveData.sopWaitEndTime
                }
            );

            const res = await fetch('Settings/Settings/RequestSaveSettings_Hydrogen', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestResetPopup(id, popupState) {
        try {
            ...
            const res = await fetch('Settings/Settings/RequestResetPopup_Hydrogen', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
