...
// 	└> TeamEditorStyled/TeamEditorComponent 로 옮김 (css 우선순위 문제로)
...
class TreeView extends Component {
	...
	render() {
		...
		if (this.props.teamTreeData && this.props.teamTreeData.length > 0) {
			return (
				<div id={this.props.treeViewID} className={ProjectResource.SiteID === ProjectResource.Site.GG_A ? 'scrollbar-outerGG' : 'scrollbar-outer'}>
