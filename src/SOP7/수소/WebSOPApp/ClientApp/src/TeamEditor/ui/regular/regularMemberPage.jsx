...
class RegularMemberPage extends Component {
	...
	async onAddMember(addIndex) {
		...
		member.MemberName = i18n.t('teamEditor.formText.새 인원');
				...
				<div className={'scrollbar'} /* style={{ height: menuHeight }} */>
					<div className={'scWrap'}>
						<div className={'scCont'}>
							...
							{/*		<ul>*/}
							{/*			<li key={'pageIndex_'} className={'on'}><a onClick={() => this.setPageIndex()}>1</a></li>*/}
							{/*			<li key={'pageIndex_'}><a onClick={() => this.setPageIndex()}>2</a></li>*/}
							{/*			<li key={'pageIndex_'}><a onClick={() => this.setPageIndex()}>3</a></li>*/}
							{/*			<li key={'pageIndex_'}><a onClick={() => this.setPageIndex()}>4</a></li>*/}
							{/*			<li key={'pageIndex_'}><a onClick={() => this.setPageIndex()}>5</a></li>*/}
							{/*		</ul>*/}
