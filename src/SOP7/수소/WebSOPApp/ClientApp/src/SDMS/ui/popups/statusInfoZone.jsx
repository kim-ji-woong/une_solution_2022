...
class StatusInfoZone extends Component {
    ...
    onClickSensorList = () => {
        console.log('복합센서창');
        this.props.onClickOpenCompound();
    }
        ...
        return (            
            <li>
                ...
                </div>
                {
                    ...
                    <ul ref={this.refZoneNameList} id={'zoneArea_' + this.props.zone.id} className={zoneShowChild === 'true' ? 'viewList3Depth on' : 'viewList3Depth'} onClick={this.onClickSensorList} /* onClick={() => this.setVisiblePopups(SDMS.menu.compoundData)} */>  {/* compoundData 팝업창 열려야함 */}
                        <li>
