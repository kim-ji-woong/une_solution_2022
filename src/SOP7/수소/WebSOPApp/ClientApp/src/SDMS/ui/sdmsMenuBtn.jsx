...
class SDMSMenuBtn extends Component {
    ...
    keysPressed(e, target) {
        ...
        //}
            ...
            target.onClickMenu(SDMSResource.menu.위험성_평가_예측);
                ...
                <ul ref={this.refMain}>
                    {
                        ProjectResource.styleMode === ProjectResource.StyleType.Hydrogen 
                            ? <>
                                <li><a onClick={() => this.onClickMenu(SDMSResource.menu.현황정보)}>{i18n.t('sdms.menu.설비리스트')}</a></li>      {/*현황정보*/}
                                ...
                                <li><a onClick={() => this.onClickMenu(SDMSResource.menu.위험성_평가_예측)}>{i18n.t('sdms.menu.위험성 평가 예측')}</a></li> {/*위험성 평가 예측*/}
                            </>
                            : <>
                                <li><a onClick={() => this.onClickMenu(SDMSResource.menu.현황정보)}>{i18n.t('sdms.menu.설비리스트')}</a></li>       {/*현황정보*/}
