...
import CompoundData from '../../../SDMS/ui/popups/compoundData';    


class StatusInfoNew extends Component {
    constructor(props) {
        super(props);
        this.state = {
            searchText: '',
            compoundDataPop: false,
        }
    ...
    getBuildingGroupUI() {
        ...
        for (var i = 0; i < buildingGroupList.length; i++) {
            ...
            ui.push(<StatusInfoBuildingGroup
                ...
                onClickOpenCompound={this.props.onClickOpenCompound}
                onClickCloseCompound={this.props.onClickCloseCompound}
            />);
        }
    ...
    onClickOpenCompound = () => {
        this.setState({ compoundDataPop: true });
    }
    ...
    render() {
        ...
        else if (ProjectResource.SiteID === ProjectResource.Site.Wonik && (userInfo?.levelID === AccountResource.accountLevelID.wonikSafety || userInfo?.levelID === AccountResource.accountLevelID.wonikSafeAdmin)) {
            poiSensorList.push(
                <ul ref={this.refLayer} key="poiSensorList">
                    {typeUI}
        ...
        return (
            ...
            <StatusInfoNewComponent id={this.props.popupType} className={'viewDashboardBoxD viewDashboard'} $siteID={userInfo.siteID}>
                ...
                >
                    ...
                    <div className={'statusInfoTitle'}>
                        <span>Lists of the facility</span>
                        <span className={'colseX'} onClick={() => this.props.setVisiblePopups(SDMS.menu.statusInfoNew, false)}><a><img src={imgClose} alt={i18n.t('common.닫기')} /></a></span>
                    </div>
                    ...
                    <div className={'dslContStatus'}>
                        ...
                        <div className={'searchWrap'}>
                            <input type="text" id="txtSearch" onKeyUp={this.searchEnterKey} placeholder='Enter your search word.'/>
            ...
            {/* {
                this.state.compoundDataPop &&
                <CompoundData onClickOpenCompound={this.state.onClickOpenCompound}
                            onClickCloseCompound={this.state.onClickCloseCompound} />
            } */}
            {/* <CompoundData /> */}
            </>
        );
...
export default withTranslation()(StatusInfoNew);