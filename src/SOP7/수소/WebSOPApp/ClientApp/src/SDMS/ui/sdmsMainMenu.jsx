...
class SDMSMainMenu extends Component {
    ...
    static H2_Sensor = "h2";                                        // 수소 고농도 - 수소
    static H2Low_Sensor = "h2low";
    static O2_Sensor = "o2";
    static Temp_Sensor = "temp";                                    // 온도센서 - 수소
    static Flow_Sensor = "flow";
    static Conduct_Sensor = "conduct";
    static GAS_Sensor = "gas";
    static H2JAG_Sensor = "h2jag";
    static O2JAG_Sensor = "o2jag";
    static PRESSURE_Sensor = "pressure";
    static PV_Panel = "pvPanel";
    static Use3DRotation = "use3DRotation";
