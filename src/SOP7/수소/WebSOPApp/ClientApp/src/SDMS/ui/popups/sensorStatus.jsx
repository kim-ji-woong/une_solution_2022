...
class SensorStatus extends Component {
    ...
    */
    ...
    getChartItems(range, values, sensor) {
        ...
        let sensorInfoBox = 'sensorInfoBox';
        let sizeLevel = 0;
    ...
    getSensorItems() {
        ...
        for (let i = 0; i < sensorCount; i++) {
            ...
            const [chartItems, sensorInfoBox] = this.getChartItems(range, values, sensor);                          // 사이즈 별 임계치 눈금 UI 가져오기
            ...
            if ((isAlarm || fullSizeIndex !== -1) && isFullPage === false) {
                ...
                if (num === 4 || index === sensorCount) {
                    items.push(
                        <div key={"sensorInfoBoxUIkey_" + sensor.id} className={'sensorInfoGrid'}> {/* 클래스 변동해야함 : sensorInfoNoGrid */}
                            {_items}
                        </div>
                    );
                }
    ...
    getDangerStepUI = () => {
        ...
        let dangerStepUI = <div className={'dangerSteps'}>
            ...
            <span className={'serious'}><span className={'seriousCircle'}></span>{actionStep._4st}</span>
        </div>;
        ...
        if (element) {
            ...
            if (clientWidth > 1300 && clientHeight > 1300) {
                dangerStepUI = <div className={'dangerSteps'}>
                    ...
                    <span className={'serious5L'}><span className={'seriousCircle5L'}></span>{actionStep._4st}</span>
                </div>;
            } else if (clientWidth > 1040 && clientHeight > 1040) {
                dangerStepUI = <div className={'dangerSteps'}>
                    ...
                    <span className={'serious4L'}><span className={'seriousCircle4L'}></span>{actionStep._4st}</span>
                </div>;
                ...
                dangerStepUI = <div className={'dangerSteps'}>
                    ...
                    <span className={'serious3L'}><span className={'seriousCircle3L'}></span>{actionStep._4st}</span>
                </div>;
            } else if (clientWidth > 520 && clientHeight > 540) {
                dangerStepUI = <div className={'dangerSteps'}>
                    ...
                    <span className={'serious2L'}><span className={'seriousCircle2L'}></span>{actionStep._4st}</span>
                </div>;
            }
        }
        ...
        return (
                ...
                {/* <div id="effect" class={contentsClassName}> */}
                        ...
                        <div className={'sensorContsBox'}>  
                          <div className={'sensorConts'}>  {/* 클래스 변동해야함 : sensorContsSmall */}
