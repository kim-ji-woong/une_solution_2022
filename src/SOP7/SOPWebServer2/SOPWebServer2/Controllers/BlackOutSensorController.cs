...
namespace SOPWebServer2.Controllers
{
    ...
    public class BlackOutSensorController : Controller
    {
        ...
        public BlackOutSensorController(SDMS.IDAL.IDataManager sdmsDataManager, Common.IDAL.IDataManager commonDataManager, TeamEditor.IDAL.IDataManager teamDataManager)
        {
        ...
        public IActionResult Post(SensorParameter param)
        {
            ...
            Result result = m_mainManager.SensorManager.OnReceive(Facility.FacilityType.BLACKOUT, param.Header, param.ClientInfo, arrDatas);
            return Ok(result);
        }
    }
}
