...
namespace SOPWebServer2.Controllers
{
    ...
    public class EnvironmentSensorController : Controller
    {
        ...
        public EnvironmentSensorController(SDMS.IDAL.IDataManager sdmsDataManager, Common.IDAL.IDataManager commonDataManager, TeamEditor.IDAL.IDataManager teamDataManager)
        {
        ...
        public IActionResult Post(SensorParameter param)
        {
            ...
            Result result = m_mainManager.SensorManager.OnReceive(Facility.FacilityType.Environment, param.Header, param.ClientInfo, arrDatas);
            return Ok(result);
        }
    }
}
