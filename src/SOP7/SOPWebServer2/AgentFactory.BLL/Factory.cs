namespace AgentFactory.BLL
{
    ...
    {
        public enum AgentType { Fire, PSM, Security, Earthquake, SDMS, LogIn, TemperatureHumidity, SOPSimulator, SOPManager, SOPCommander, Etc, StrongWind, BlackOut, Beacon, Environment, Manufacture, Door, Laser, LowBattery, HighTemp, Tilt, H2, Flow, Conductivity, Temp, Pressure, Gas, Anomaly, H2Low, O2, H2JAG, O2JAG };
