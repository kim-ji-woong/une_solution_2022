...
namespace SDMS.IDAL
{
    ...
    public interface IDelete
    {
        ...
        bool DeleteGltfPrivateModelData(int modelDataID, int userID, out string strErrorMessage);
        bool DeleteGltfPrivateModelData(Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        bool DeleteGltfPrivateModelOrthoData(int modelDataID, int userID, out string strErrorMessage);
        bool DeleteGltfPrivateModelOrthoData(Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        ...
        bool DeleteSdms2DImage(int id, out string strErrorMessage);
        bool DeleteSdms2DImage(Dictionary<Sdms2DImage.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        bool DeleteSdmsSensorETC(int id, out string strErrorMessage);
        bool DeleteSdmsSensorETC(Dictionary<ETC.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool DeleteElevator(int id, out string strErrorMessage);
        bool DeleteElevator(Dictionary<Elevator.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool DeleteWorkerInfo(int id, out string strErrorMessage);
        bool DeleteWorkerInfo(Dictionary<WorkerInfo.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        #region 안전구역평가
        bool DeleteAssessment(int id, out string strErrorMessage);
        bool DeleteAssessment(Dictionary<Assessment.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool DeleteAssessmentA(int id, out string strErrorMessage);
        bool DeleteAssessmentA(Dictionary<AssessmentA.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool DeleteAssessmentAItem(int assessmentID, int aID, int memberID, out string strErrorMessage);
        bool DeleteAssessmentAItem(Dictionary<AssessmentAItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool DeleteAssessmentAMember(int assessmentID, int memberID, out string strErrorMessage);
        bool DeleteAssessmentAMember(Dictionary<AssessmentAMember.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool DeleteAssessmentQ(int id, out string strErrorMessage);
        bool DeleteAssessmentQ(Dictionary<AssessmentQ.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool DeleteAssessmentQItem(int id, out string strErrorMessage);
        bool DeleteAssessmentQItem(Dictionary<AssessmentQItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        #endregion
    }
}
