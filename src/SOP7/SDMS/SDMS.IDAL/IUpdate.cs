...
namespace SDMS.IDAL
{
    ...
    public interface IUpdate
    {
        ...
        bool UpdateGltfPrivateModelData(Model.GLTF.PrivateModelData modelData, out string strErrorMessage);
        bool UpdateGltfPrivateModelData(Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicSets, Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        bool UpdateGltfPrivateModelOrthoData(Model.GLTF.PrivateModelOrthoData modelData, out string strErrorMessage);
        bool UpdateGltfPrivateModelOrthoData(Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicSets, Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        ...
        bool UpdateETCSensor(Dictionary<ETC.Fields, object> dicSets, Dictionary<ETC.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        ...
        bool UpdateSdms2DImage(Sdms2DImage obj, out string strErrorMessage);
        bool UpdateSdms2DImage(Dictionary<Sdms2DImage.Fields, object> dicSets, Dictionary<Sdms2DImage.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool UpdateElevator(Elevator obj, out string strErrorMessage);
        bool UpdateElevator(Dictionary<Elevator.Fields, object> dicSets, Dictionary<Elevator.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool UpdateWorkerInfo(WorkerInfo obj, out string strErrorMessage);
        bool UpdateWorkerInfo(Dictionary<WorkerInfo.Fields, object> dicSets, Dictionary<WorkerInfo.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        #region 안전구역평가
        bool UpdateAssessment(Assessment obj, out string strErrorMessage);
        bool UpdateAssessment(Dictionary<Assessment.Fields, object> dicSets, Dictionary<Assessment.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool UpdateAssessmentA(AssessmentA obj, out string strErrorMessage);
        bool UpdateAssessmentA(Dictionary<AssessmentA.Fields, object> dicSets, Dictionary<AssessmentA.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool UpdateAssessmentAItem(AssessmentAItem obj, out string strErrorMessage);
        bool UpdateAssessmentAItem(Dictionary<AssessmentAItem.Fields, object> dicSets, Dictionary<AssessmentAItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool UpdateAssessmentAMember(AssessmentAMember obj, out string strErrorMessage);
        bool UpdateAssessmentAMember(Dictionary<AssessmentAMember.Fields, object> dicSets, Dictionary<AssessmentAMember.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool UpdateAssessmentQ(AssessmentQ obj, out string strErrorMessage);
        bool UpdateAssessmentQ(Dictionary<AssessmentQ.Fields, object> dicSets, Dictionary<AssessmentQ.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);

        bool UpdateAssessmentQItem(AssessmentQItem obj, out string strErrorMessage);
        bool UpdateAssessmentQItem(Dictionary<AssessmentQItem.Fields, object> dicSets, Dictionary<AssessmentQItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage);
        #endregion
    }
}
