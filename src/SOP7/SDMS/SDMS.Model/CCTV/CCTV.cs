...
namespace SDMS.Model.CCTV
{
    ...
    {
        public enum Fields { ID, CameraName, PositionName, UniqueKey, X, Y, Z, ZoneID, IsIndoor, Type, Channel, UserID, Password, URL, BigURL, SmallURL, Enabled, CameraIP, CameraCompanyName, CameraModelName, Description, SiteID };
