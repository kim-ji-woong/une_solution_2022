...
namespace SDMS.BLL.Excel.Reader
{
    public abstract class ExcelReader
    {
        ...
        public bool Run(out string strErrorMessage, int? siteID)
        {
            ...
            try
            {
                ...
                //writer.Close();
                return UpdateData(sheetDatas, siteID, out strErrorMessage);
            }
        ...
        protected abstract bool UpdateData(List<SheetData> sheetDatas, int? siteID, out string strErrorMessage);

        public static ExcelReader MakeInstance(DataMode mode, string strFilePath, IDataManager dataManager, TeamEditor.IDAL.IDataManager teamDataManager, SOPManager.IDAL.IDataManager sopDataManager, int? siteID)
        {
            if (mode == DataMode.FacilityInfo)
                ...
                return new RegularMemberReader(strFilePath, dataManager, teamDataManager, sopDataManager, siteID);
