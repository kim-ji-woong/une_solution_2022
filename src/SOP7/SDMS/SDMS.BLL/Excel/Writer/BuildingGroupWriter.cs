...
namespace SDMS.BLL.Excel.Writer
{
    ...
    {
        public BuildingGroupWriter(IDataManager dataManager, TeamEditor.IDAL.IDataManager teamDataManager)
        ...
        protected override ICollection<SheetData> ReadSheetDatas(List<int> siteIDs, out string strErrorMessage)
        {
            ...
            Dictionary<string, List<BuildingGroupData>> dicBuildingGroupDatas = BuildingGroupReader.ReadDB(m_dataManager, out dicBuildingGroups, out dicBuildingGroupNames, out strErrorMessage, siteIDs);
