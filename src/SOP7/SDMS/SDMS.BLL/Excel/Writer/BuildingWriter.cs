...
namespace SDMS.BLL.Excel.Writer
{
    ...
    {
        public BuildingWriter(IDataManager dataManager, TeamEditor.IDAL.IDataManager teamDataManager)
        ...
        protected override ICollection<SheetData> ReadSheetDatas(List<int> siteIDs, out string strErrorMessage)
        {
            ...
            // Key : Building Name
            Dictionary<string, List<BuildingData>> dicBuildingDatas = BuildingReader.ReadDB(m_dataManager, out dicBuildings, out dicBuildingNames, out strErrorMessage, siteIDs);
