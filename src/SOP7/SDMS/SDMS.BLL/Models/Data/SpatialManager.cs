...
namespace SDMS.BLL.Models.Data
{
    ...
    public class ZoneSensors
    {
        ...
        private List<EtcSensor> m_emergencySensors = null;
        ...
        public ZoneSensors(List<FireSensor> fireSensors, List<PSMSensor> psmSensors, List<EtcSensor> etcSensors, List<CCTVSensor> cctvs, List<EtcSensor> earthquakeSensors, List<EtcSensor> strongWindSensors, List<EtcSensor> emergencyBellSensors)
        {
            m_fireSensors = fireSensors;
            m_psmSensors = psmSensors;
            m_etcSensors = etcSensors;
            m_cctvs = cctvs;
            m_earthquakeSensors = earthquakeSensors;
            m_strongWindSensors = strongWindSensors;
            m_emergencySensors = emergencyBellSensors;
        }
    }
}
