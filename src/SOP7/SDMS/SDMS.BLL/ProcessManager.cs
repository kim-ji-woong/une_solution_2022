...
namespace SDMS.BLL
{
    public class ProcessManager
    {
        ...
        private static string m_strLocalServerURL = "";
        ...
        private AssessmentManager m_assessmentManager = null;

        private static bool m_bUseEquipZoneAssess = false;
        public bool UseEquipZoneAssess
        {
            get { return m_bUseEquipZoneAssess; }
            set { m_bUseEquipZoneAssess = value; }
        }
        public bool UseWorkerInfo { get; set; }
        ...
        public ProcessManager(Common.IDAL.IDataManager commonDataManager, SDMS.IDAL.IDataManager sdmsDataManager, SOPManager.IDAL.IDataManager sopDataManager, TeamEditor.IDAL.IDataManager teamDataManager)
        {
            ...
            m_excelManager = new ExcelManager(m_sdmsDataManager, m_teamDataManager, m_sopDataManager, this);
            m_assessmentManager = new AssessmentManager(m_sdmsDataManager, this);
        }
