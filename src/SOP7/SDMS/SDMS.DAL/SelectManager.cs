    ...
    public class SelectManager : QueryManager, ISelect
    {
        ...
        private ETC ReadETCSensor(ArrayList arrResult, int index, out string strErrorMessage)
        {
            ...
            foreach (ETC.Fields field in ETC.Fields.GetValues(typeof(ETC.Fields)))
            {
                ...
                else if (field == ETC.Fields.LimitBase)
                {
                ...
                else if (field == ETC.Fields.LimitType)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == ETC.Fields.LimitValue)
                {
                    string str = WebDBManager.GetStringField(arrResult[index].ToString());
                ...
                else if (field == ETC.Fields.SiteID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
        ...
        private Fire ReadFireSensor(ArrayList arrResult, int index, out string strErrorMessage)
        {
            ...
            foreach (Fire.Fields field in Fire.Fields.GetValues(typeof(Fire.Fields)))
            {
                ...
                else if (field == Fire.Fields.SiteID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
        ...
        private PSM ReadPSMSensor(ArrayList arrResult, int index, out string strErrorMessage)
        {
            ...
            foreach (PSM.Fields field in PSM.Fields.GetValues(typeof(PSM.Fields)))
            {
                ...
                else if (field == PSM.Fields.LimitBase)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                    ...
                    if (data == null)
                    {
                        ...
                        model.LimitBase = data.Data;
                }
                else if (field == PSM.Fields.LimitType)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == PSM.Fields.LimitValue)
                {
                    string str = WebDBManager.GetStringField(arrResult[index].ToString());
                ...
                else if (field == PSM.Fields.SiteID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
        ...
        private ServerInfo ReadSensorServerInfo(ArrayList arrResult, int index, out string strErrorMessage)
        {
            ...
            foreach (ServerInfo.Fields field in ServerInfo.Fields.GetValues(typeof(ServerInfo.Fields)))
            {
                ...
                else if (field == ServerInfo.Fields.ServerType)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == ServerInfo.Fields.Port)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == ServerInfo.Fields.Status)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    if (data == null)
                        ...
                        model.Status = data.Data == 1 ? true : false;
                }
                else if (field == ServerInfo.Fields.SOPWebServerURL)
                {
                    string str = WebDBManager.GetStringField(arrResult[index]);

                    if (str == null)
                        model.SOPWebServerURL = "";                        
                    else
                        model.SOPWebServerURL = str;
                }
                else if (field == ServerInfo.Fields.bUse)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    if (data == null)
                        ...
                        model.bUse = data.Data == 1 ? true : false;
                }
                else if (field == ServerInfo.Fields.SiteID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
        ...
        public TagInfo SelectSensorTagInfo(int id, out string strErrorMessage)
        {
            ...
            string strSQL = string.Format("select {0} from {1} where ID = {2}", GetFieldNames<TagInfo.Fields>(out nFieldCount), TagInfo.TableName, id);
            ArrayList arrResult = m_dbManager.GetResultData(strSQL);
        ...
        public Model.GLTF.PrivateModelData SelectGltfPrivateModelData(int modelDataID, int userID, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where {2} = {3} and {4} = {5}",
                GetFieldNames<Model.GLTF.PrivateModelData.Fields>(out nFieldCount),
                Model.GLTF.PrivateModelData.TableName,
                Model.GLTF.PrivateModelData.Fields.ModelDataID, modelDataID,
                Model.GLTF.PrivateModelData.Fields.UserID, userID);
            ArrayList arrResult = m_dbManager.GetResultData(strSQL);

            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                Model.GLTF.PrivateModelData modelData = ReadGltfPrivateModelData(arrResult, 0, out strErrorMessage);
        ...
        public List<Model.GLTF.PrivateModelData> SelectGltfPrivateModelDatas(Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectGltfPrivateModelDatas(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<Model.GLTF.PrivateModelData> SelectGltfPrivateModelDatas(Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<Model.GLTF.PrivateModelData.Fields>(out nFieldCount), Model.GLTF.PrivateModelData.TableName);

            string strCondition = "";

            if (SetCondition<Model.GLTF.PrivateModelData.Fields>(ref strCondition, dicConditions, Model.GLTF.PrivateModelData.GetFieldName, Model.GLTF.PrivateModelData.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<Model.GLTF.PrivateModelData> modelDatas = new List<Model.GLTF.PrivateModelData>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                Model.GLTF.PrivateModelData modelData = ReadGltfPrivateModelData(arrResult, i, out strErrorMessage);
        ...
        private Model.GLTF.PrivateModelData ReadGltfPrivateModelData(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            Model.GLTF.PrivateModelData model = new Model.GLTF.PrivateModelData();
            bool isNullable;

            foreach (Model.GLTF.PrivateModelData.Fields field in Model.GLTF.PrivateModelData.Fields.GetValues(typeof(Model.GLTF.PrivateModelData.Fields)))
            {
                string strFieldName = Model.GLTF.PrivateModelData.GetFieldName(field, out isNullable);

                if (field == Model.GLTF.PrivateModelData.Fields.ModelDataID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.ModelDataID = data.Data;
                    }
                }
                else if (field == Model.GLTF.PrivateModelData.Fields.UserID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraPositionX)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraPositionY)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraPositionZ)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraQuaternionX)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraQuaternionY)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraQuaternionZ)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraQuaternionW)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraRotationX)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraRotationY)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraRotationZ)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraFov)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraNear)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.CameraFar)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.OrbitTargetX)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.OrbitTargetY)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelData.Fields.OrbitTargetZ)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
        ...
        public Model.GLTF.PrivateModelOrthoData SelectGltfPrivateModelOrthoData(int modelDataID, int userID, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where {2} = {3} and {4} = {5}",
                GetFieldNames<Model.GLTF.PrivateModelOrthoData.Fields>(out nFieldCount),
                Model.GLTF.PrivateModelOrthoData.TableName,
                Model.GLTF.PrivateModelOrthoData.Fields.ModelDataID, modelDataID,
                Model.GLTF.PrivateModelOrthoData.Fields.UserID, userID);
            ArrayList arrResult = m_dbManager.GetResultData(strSQL);

            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                Model.GLTF.PrivateModelOrthoData modelData = ReadGltfPrivateModelOrthoData(arrResult, 0, out strErrorMessage);
        ...
        public List<Model.GLTF.PrivateModelOrthoData> SelectGltfPrivateModelOrthoDatas(Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectGltfPrivateModelOrthoDatas(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<Model.GLTF.PrivateModelOrthoData> SelectGltfPrivateModelOrthoDatas(Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<Model.GLTF.PrivateModelOrthoData.Fields>(out nFieldCount), Model.GLTF.PrivateModelOrthoData.TableName);

            string strCondition = "";

            if (SetCondition<Model.GLTF.PrivateModelOrthoData.Fields>(ref strCondition, dicConditions, Model.GLTF.PrivateModelOrthoData.GetFieldName, Model.GLTF.PrivateModelOrthoData.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<Model.GLTF.PrivateModelOrthoData> modelDatas = new List<Model.GLTF.PrivateModelOrthoData>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                Model.GLTF.PrivateModelOrthoData modelData = ReadGltfPrivateModelOrthoData(arrResult, i, out strErrorMessage);
        ...
        private Model.GLTF.PrivateModelOrthoData ReadGltfPrivateModelOrthoData(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            Model.GLTF.PrivateModelOrthoData model = new Model.GLTF.PrivateModelOrthoData();
            bool isNullable;

            foreach (Model.GLTF.PrivateModelOrthoData.Fields field in Model.GLTF.PrivateModelOrthoData.Fields.GetValues(typeof(Model.GLTF.PrivateModelOrthoData.Fields)))
            {
                string strFieldName = Model.GLTF.PrivateModelOrthoData.GetFieldName(field, out isNullable);

                if (field == Model.GLTF.PrivateModelOrthoData.Fields.ModelDataID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.UserID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraPositionX)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraPositionY)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraPositionZ)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraQuaternionX)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraQuaternionY)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraQuaternionZ)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraQuaternionW)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraRotationX)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraRotationY)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.CameraRotationZ)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.TargetX)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.TargetY)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.TargetZ)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
                ...
                else if (field == Model.GLTF.PrivateModelOrthoData.Fields.Zoom)
                {
                    VariousData<float> data = WebDBManager.GetFloatField(arrResult[index].ToString());
        ...
        public Sdms2DImage SelectSdms2DImage(int zoneID, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where ZoneID = {2} ",
                GetFieldNames<Sdms2DImage.Fields>(out nFieldCount), Sdms2DImage.TableName
                , zoneID);
            ...
            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                Sdms2DImage model = ReadSdms2DImage(arrResult, 0, out strErrorMessage);
        ...
        public List<Sdms2DImage> SelectSdms2DImages(Dictionary<Sdms2DImage.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectSdms2DImages(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<Sdms2DImage> SelectSdms2DImages(Dictionary<Sdms2DImage.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<Sdms2DImage.Fields>(out nFieldCount), Sdms2DImage.TableName);

            string strCondition = "";

            if (SetCondition<Sdms2DImage.Fields>(ref strCondition, dicConditions, Sdms2DImage.GetFieldName, Sdms2DImage.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<Sdms2DImage> datas = new List<Sdms2DImage>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                Sdms2DImage model = ReadSdms2DImage(arrResult, i, out strErrorMessage);
        ...
        private Sdms2DImage ReadSdms2DImage(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            Sdms2DImage model = new Sdms2DImage();
            bool isNullable;

            foreach (Sdms2DImage.Fields field in Sdms2DImage.Fields.GetValues(typeof(Sdms2DImage.Fields)))
            {
                string strFieldName = Sdms2DImage.GetFieldName(field, out isNullable);

                if (field == Sdms2DImage.Fields.ID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Sdms2DImage.Fields.ZoneID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Sdms2DImage.Fields.FilePath)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
                ...
                else if (field == Sdms2DImage.Fields.SiteID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
        ...
        public WorkerInfo SelectWorkerInfo(int id, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where ID = {2} ",
                GetFieldNames<WorkerInfo.Fields>(out nFieldCount), WorkerInfo.TableName
                , id);
            ...
            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                WorkerInfo model = ReadWorkerInfo(arrResult, 0, out strErrorMessage);
        ...
        public List<WorkerInfo> SelectWorkerInfos(Dictionary<WorkerInfo.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectWorkerInfos(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<WorkerInfo> SelectWorkerInfos(Dictionary<WorkerInfo.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<WorkerInfo.Fields>(out nFieldCount), WorkerInfo.TableName);

            string strCondition = "";

            if (SetCondition<WorkerInfo.Fields>(ref strCondition, dicConditions, WorkerInfo.GetFieldName, WorkerInfo.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<WorkerInfo> datas = new List<WorkerInfo>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                WorkerInfo model = ReadWorkerInfo(arrResult, i, out strErrorMessage);
        ...
        private WorkerInfo ReadWorkerInfo(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            WorkerInfo model = new WorkerInfo();
            bool isNullable;

            foreach (WorkerInfo.Fields field in WorkerInfo.Fields.GetValues(typeof(WorkerInfo.Fields)))
            {
                string strFieldName = WorkerInfo.GetFieldName(field, out isNullable);

                if (field == WorkerInfo.Fields.ID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == WorkerInfo.Fields.SpatialType)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == WorkerInfo.Fields.SpatialID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == WorkerInfo.Fields.WorkerCount)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == WorkerInfo.Fields.WorkerType)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == WorkerInfo.Fields.Comment)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
        ...
        public Elevator SelectElevator(int id, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where ID = {2} ",
                GetFieldNames<Elevator.Fields>(out nFieldCount), Elevator.TableName
                , id);
            ...
            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                Elevator model = ReadElevator(arrResult, 0, out strErrorMessage);
        ...
        public List<Elevator> SelectElevators(Dictionary<Elevator.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectElevators(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<Elevator> SelectElevators(Dictionary<Elevator.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<Elevator.Fields>(out nFieldCount), Elevator.TableName);

            string strCondition = "";

            if (SetCondition<Elevator.Fields>(ref strCondition, dicConditions, Elevator.GetFieldName, Elevator.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<Elevator> datas = new List<Elevator>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                Elevator model = ReadElevator(arrResult, i, out strErrorMessage);
        ...
        private Elevator ReadElevator(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            Elevator model = new Elevator();
            bool isNullable;

            foreach (Elevator.Fields field in Elevator.Fields.GetValues(typeof(Elevator.Fields)))
            {
                string strFieldName = Elevator.GetFieldName(field, out isNullable);

                if (field == Elevator.Fields.ID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Elevator.Fields.Door)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.Door = data.Data;
                    }
                }
                else if (field == Elevator.Fields.Direction)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Elevator.Fields.Run)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Elevator.Fields.Floor)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.Floor = data.Data;
                    }
                }
                else if (field == Elevator.Fields.MaxFloor)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Elevator.Fields.MinFloor)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Elevator.Fields.IsNormal)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.IsNormal = data.Data == 1;
                    }
                }
                else if (field == Elevator.Fields.Name)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
                ...
                else if (field == Elevator.Fields.GroupNo)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.GroupNo = data.Data;
                    }
                }
                else if (field == Elevator.Fields.SiteID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
        ...
        public ArrayList JoinEquipmentZoneSensorReactionHistorySensorZoneSensorZoneHistory(Dictionary<EquipmentZone.Fields, object> dicConditions1, Dictionary<SensorReactionHistory.Fields, object> dicConditions2, Dictionary<SensorZone.Fields, object> dicConditions3, Dictionary<SensorZoneHistory.Fields, object> dicConditions4, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            ...
            if (SetCondition<EquipmentZone.Fields>(ref strCondition1, dicConditions1, EquipmentZone.GetFieldName, EquipmentZone.TableName, ref strErrorMessage) == false)
                return null;

            if (strCondition1.Length > 0)
                strSQL += string.Format(" and {0}", strCondition1);

            string strCondition2 = "";
            if (SetCondition<SensorReactionHistory.Fields>(ref strCondition2, dicConditions2, SensorReactionHistory.GetFieldName, SensorReactionHistory.TableName, ref strErrorMessage) == false)
                return null;

            if (strCondition2.Length > 0)
                strSQL += string.Format(" and {0}", strCondition2);
            ...
            if (strCondition3.Length > 0)
                strSQL += string.Format(" and {0}", strCondition3);

            string strCondition4 = "";
            if (SetCondition<SensorZoneHistory.Fields>(ref strCondition4, dicConditions4, SensorZoneHistory.GetFieldName, SensorZoneHistory.TableName, ref strErrorMessage) == false)
                return null;

            if (strCondition4.Length > 0)
                strSQL += string.Format(" and {0}", strCondition4);
        ...
        public ArrayList GetCountSensorReactionHistory(string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;

            StringBuilder sb = new StringBuilder();
            sb.Append("Select SdmsHistorySensorZone.ID");
            sb.Append("  From SdmsSpatialZone, SdmsHistorySensorZone, SdmsHistorySensorReaction");
            sb.Append(" Where SdmsSpatialZone.ID = SdmsHistorySensorZone.ZoneID");
            sb.Append("   And SdmsHistorySensorZone.ID=SdmsHistorySensorReaction.SensorZoneHistoryID");            
            ...
            sb.Append("   Group by SdmsHistorySensorZone.ID");
            ...
            ArrayList arrResult2 = new ArrayList();
            arrResult2.Add(arrResult.Count);
        ...
        public ArrayList JoinSensorZoneETCSensor(Dictionary<SensorZone.Fields, object> dicConditions1, Dictionary<ETC.Fields, object> dicConditions2, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            ...
            sb.AppendFormat("   And {0}.{1} in (Select {2} from {3} where {4} = '{5}') ", strSensorZoneTableName, SensorZone.Fields.SensorType,
                FacilityType.GetFieldName(FacilityType.Fields.ID, out isNullable),
                FacilityType.TableName,
                FacilityType.GetFieldName(FacilityType.Fields.LinkedTableName, out isNullable),
                ETC.TableName);
        ...
        public ArrayList JoinSensorZoneSensors(Dictionary<SensorZone.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            ...
            sb.AppendFormat("            when {0} in ({1}) then(select name from {2} as p Where p.ID = sz.OrgSensorID)"
                , SensorZone.Fields.SensorType, string.Join(",", Facility.GetLaserTypeAllNumberToList()), ETC.TableName);
            sb.AppendFormat("            when {0} in ({1}) then(select name from {2} as p Where p.ID = sz.OrgSensorID)"
                , SensorZone.Fields.SensorType, string.Join(",", Facility.GetEnvironmentTypeAllNumberToList()), ETC.TableName);
            sb.AppendFormat("            when {0} in ({1}) then(select name from {2} as p Where p.ID = sz.OrgSensorID)"
                , SensorZone.Fields.SensorType, string.Join(",", Facility.GetManufactureTypeAllNumberToList()), ETC.TableName);
            sb.AppendFormat("            when {0} in ({1}) then(select name from {2} as p Where p.ID = sz.OrgSensorID)"
                , SensorZone.Fields.SensorType, string.Join(",", Facility.GetHydrogenTypeAllNumberToList()), ETC.TableName);
        ...
        public ArrayList JoinCurrentAlarmSensorZoneHistory(string strAdditionalConditions, out string strErrorMessage)
        {
            return JoinCurrentAlarmSensorZoneHistory(strAdditionalConditions, null, out strErrorMessage);
        }

        public ArrayList JoinCurrentAlarmSensorZoneHistory(string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            ...
            int nCurrentAlarmFieldCount, nSensorZoneHistoryFieldCount;

            string strCurrentAlarmFields = GetFieldNames<CurrentAlarm.Fields>(strCurrentAlarmTableName, out nCurrentAlarmFieldCount);
            string strSensorZoneHistoryFields = GetFieldNames<SensorZoneHistory.Fields>(strSensorZoneHistoryTableName, out nSensorZoneHistoryFieldCount);

            int nFieldsCount = nCurrentAlarmFieldCount + nSensorZoneHistoryFieldCount;

            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("Select {0}, {1} ", strCurrentAlarmFields, strSensorZoneHistoryFields);
            sb.AppendFormat("  From {0}, {1} ", strCurrentAlarmTableName, strSensorZoneHistoryTableName);
            sb.AppendFormat(" Where {0}.{1} = {2}.{3}", strCurrentAlarmTableName, CurrentAlarm.Fields.SensorZoneHistoryID, strSensorZoneHistoryTableName, SensorZoneHistory.Fields.ID);
        ...
        public ArrayList JoinSensorZoneTagInfoFireSensor(string strAdditionalConditions, out string strErrorMessage)
        {
            return JoinSensorZoneTagInfoFireSensor(strAdditionalConditions, null, out strErrorMessage);
        }

        public ArrayList JoinSensorZoneTagInfoFireSensor(string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            ...
            int nSensorZoneFieldCount, nTagInfoFieldCount, nFireFieldCount;

            string strSensorZoneFields = GetFieldNames<SensorZone.Fields>(strSensorZoneTableName, out nSensorZoneFieldCount);
            string strTagInfoFields = GetFieldNames<TagInfo.Fields>(strTagInfoTableName, out nTagInfoFieldCount);
            string strFireFields = GetFieldNames<Fire.Fields>(strFireTableName, out nFireFieldCount);

            int nFieldsCount = nSensorZoneFieldCount + nTagInfoFieldCount + nFireFieldCount;

            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("Select {0}, {1}, {2} ", strSensorZoneFields, strTagInfoFields, strFireFields);
            sb.AppendFormat("  From {0}, {1}, {2} ", strSensorZoneTableName, strTagInfoTableName, strFireTableName);
            sb.AppendFormat(" Where {0}.{1} = {2}.{3} ", strSensorZoneTableName, SensorZone.Fields.ID, strTagInfoTableName, TagInfo.Fields.SensorZoneID);
            sb.AppendFormat("   And {0}.{1} = {2} ", strSensorZoneTableName, SensorZone.Fields.SensorType, (int)Facility.FacilityType.FIRE_SENSOR);
            sb.AppendFormat("   And {0}.{1} = {2}.{3} ", strSensorZoneTableName, SensorZone.Fields.OrgSensorID, strFireTableName, Fire.Fields.ID);
            ...
            for (int i = 0; i < nResultCount - (nFieldsCount - 1); i += nFieldsCount)
            {
                ...
                Fire fire = ReadFireSensor(arrResult, i + nSensorZoneFieldCount + nTagInfoFieldCount, out strErrorMessage);
        ...
        public ArrayList JoinSensorZoneTagInfoMaterialEarthquakeStrongWindSensor(string strAdditionalConditions, out string strErrorMessage)
        {
            return JoinSensorZoneTagInfoMaterialEarthquakeStrongWindSensor(strAdditionalConditions, null, out strErrorMessage);
        }

        public ArrayList JoinSensorZoneTagInfoMaterialEarthquakeStrongWindSensor(string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            ...
            int nSensorZoneFieldCount, nTagInfoFieldCount, nMaterialFieldCount, nETCFieldCount;
            ...
            int nFieldsCount = nSensorZoneFieldCount + nTagInfoFieldCount + nMaterialFieldCount + nETCFieldCount;

            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("Select {0}, {1}, {2}, {3} ", strSensorZoneFields, strTagInfoFields, strMaterialFields, strETCFields);
            sb.AppendFormat("  From {0}, {1}, {2}, {3} ", strSensorZoneTableName, strTagInfoTableName, strMaterialTableName, strETCTableName);
            sb.AppendFormat(" Where {0}.{1} = {2}.{3} ", strSensorZoneTableName, SensorZone.Fields.ID, strTagInfoTableName, TagInfo.Fields.SensorZoneID);
            //sb.AppendFormat("   And {0}.{1} = {2} ", strSensorZoneTableName, SensorZone.Fields.SensorType, (int)Facility.FacilityType.ETC);   // 지진 또는 강풍 또한 조회
            sb.AppendFormat("   And {0}.{1} = {2}.{3} ", strSensorZoneTableName, SensorZone.Fields.OrgSensorID, strETCTableName, ETC.Fields.ID);
            sb.AppendFormat("   And {0}.{1} = {2}.{3} ", strETCTableName, ETC.Fields.MaterialType, strMaterialTableName, Material.Fields.ID);
            ...
            for (int i = 0; i < nResultCount - (nFieldsCount - 1); i += nFieldsCount)
            {
                ...
                ETC etc = ReadETCSensor(arrResult, i + nSensorZoneFieldCount + nTagInfoFieldCount + nMaterialFieldCount, out strErrorMessage);
        ...
        {
            return JoinZoneBuilding(strAdditionalConditions, null, out strErrorMessage);
        }

        public ArrayList JoinZoneBuilding(string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            ...
            int nZoneFieldCount, nBuildingFieldCount;

            string strZoneFields = GetFieldNames<Zone.Fields>(strZoneTableName, out nZoneFieldCount);
            string strBuildingFields = GetFieldNames<Building.Fields>(strBuildingTableName, out nBuildingFieldCount);

            int nFieldsCount = nZoneFieldCount + nBuildingFieldCount;

            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("Select {0}, {1} ", strZoneFields, strBuildingFields);
            sb.AppendFormat("  From {0} left outer join {1} ", strZoneTableName, strBuildingTableName);
            sb.AppendFormat(" on {0}.{1} = {2}.{3} ", strZoneTableName, Zone.Fields.BuildingID, strBuildingTableName, Building.Fields.ID);
            ...
            for (int i = 0; i < nResultCount - (nFieldsCount - 1); i += nFieldsCount)
            {
                Zone zone = ReadZone(arrResult, i, out strErrorMessage);
                ...
                Building building = ReadBuilding(arrResult, i + nZoneFieldCount, out strErrorMessage);
                arrDatas.Add(building);
            }
        ...
        #region 안전구역평가
        public Assessment SelectAssessment(int id, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where ID = {2} ",
                GetFieldNames<Assessment.Fields>(out nFieldCount), Assessment.TableName
                , id);
            ...
            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                Assessment model = ReadAssessment(arrResult, 0, out strErrorMessage);
        ...
        public List<Assessment> SelectAssessments(Dictionary<Assessment.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectAssessments(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<Assessment> SelectAssessments(Dictionary<Assessment.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<Assessment.Fields>(out nFieldCount), Assessment.TableName);

            string strCondition = "";

            if (SetCondition<Assessment.Fields>(ref strCondition, dicConditions, Assessment.GetFieldName, Assessment.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<Assessment> datas = new List<Assessment>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                Assessment model = ReadAssessment(arrResult, i, out strErrorMessage);
        ...
        private Assessment ReadAssessment(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            Assessment model = new Assessment();
            bool isNullable;

            foreach (Assessment.Fields field in Assessment.Fields.GetValues(typeof(Assessment.Fields)))
            {
                string strFieldName = Assessment.GetFieldName(field, out isNullable);

                if (field == Assessment.Fields.ID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Assessment.Fields.EquipmentZoneID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.EquipmentZoneID = data.Data;
                    }
                }
                else if (field == Assessment.Fields.SendDate)
                {
                    VariousData<DateTime> data = WebDBManager.GetDateTimeField(arrResult[index]);
                    ...
                    {
                        model.SendDate = data.Data;
                    }
                }
                else if (field == Assessment.Fields.SendUserID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.SendUserID = data.Data;
                    }
                }
                else if (field == Assessment.Fields.Title)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
                ...
                else if (field == Assessment.Fields.Score)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == Assessment.Fields.ResultDate)
                {
                    VariousData<DateTime> data = WebDBManager.GetDateTimeField(arrResult[index]);

                    if (data == null)
                    {
                        model.ResultDate = null;
                    }
                    else
                    {
                        model.ResultDate = data.Data;
                    }
                }
                else if (field == Assessment.Fields.UpdateDate)
                {
                    VariousData<DateTime> data = WebDBManager.GetDateTimeField(arrResult[index]);
                ...
                else if (field == Assessment.Fields.IsPass)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.IsPass = data.Data == 1;
                    }
                }
                else if (field == Assessment.Fields.Type)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
        ...
        public AssessmentA SelectAssessmentA(int id, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where ID = {2} ",
                GetFieldNames<AssessmentA.Fields>(out nFieldCount), AssessmentA.TableName
                , id);
            ...
            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                AssessmentA model = ReadAssessmentA(arrResult, 0, out strErrorMessage);
        ...
        public List<AssessmentA> SelectAssessmentAs(Dictionary<AssessmentA.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectAssessmentAs(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<AssessmentA> SelectAssessmentAs(Dictionary<AssessmentA.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<AssessmentA.Fields>(out nFieldCount), AssessmentA.TableName);

            string strCondition = "";

            if (SetCondition<AssessmentA.Fields>(ref strCondition, dicConditions, AssessmentA.GetFieldName, AssessmentA.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<AssessmentA> datas = new List<AssessmentA>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                AssessmentA model = ReadAssessmentA(arrResult, i, out strErrorMessage);
        ...
        private AssessmentA ReadAssessmentA(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            AssessmentA model = new AssessmentA();
            bool isNullable;

            foreach (AssessmentA.Fields field in AssessmentA.Fields.GetValues(typeof(AssessmentA.Fields)))
            {
                string strFieldName = AssessmentA.GetFieldName(field, out isNullable);

                if (field == AssessmentA.Fields.ID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentA.Fields.AssessmentID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.AssessmentID = data.Data;
                    }
                }
                else if (field == AssessmentA.Fields.Contents)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
        ...
        public AssessmentAItem SelectAssessmentAItem(int assessmentID, int aID, int memberID, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where AssessmentID = {2} and AID = {3} and MemberID = {4} ",
                GetFieldNames<AssessmentAItem.Fields>(out nFieldCount), AssessmentAItem.TableName
                , assessmentID
                , aID
                , memberID);
            ...
            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                AssessmentAItem model = ReadAssessmentAItem(arrResult, 0, out strErrorMessage);
        ...
        public List<AssessmentAItem> SelectAssessmentAItems(Dictionary<AssessmentAItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectAssessmentAItems(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<AssessmentAItem> SelectAssessmentAItems(Dictionary<AssessmentAItem.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<AssessmentAItem.Fields>(out nFieldCount), AssessmentAItem.TableName);

            string strCondition = "";

            if (SetCondition<AssessmentAItem.Fields>(ref strCondition, dicConditions, AssessmentAItem.GetFieldName, AssessmentAItem.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<AssessmentAItem> datas = new List<AssessmentAItem>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                AssessmentAItem model = ReadAssessmentAItem(arrResult, i, out strErrorMessage);
        ...
        private AssessmentAItem ReadAssessmentAItem(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            AssessmentAItem model = new AssessmentAItem();
            bool isNullable;

            foreach (AssessmentAItem.Fields field in AssessmentAItem.Fields.GetValues(typeof(AssessmentAItem.Fields)))
            {
                string strFieldName = AssessmentAItem.GetFieldName(field, out isNullable);

                if (field == AssessmentAItem.Fields.AssessmentID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentAItem.Fields.AID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentAItem.Fields.MemberID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentAItem.Fields.Score)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentAItem.Fields.Memo)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
        ...
        public AssessmentAMember SelectAssessmentAMember(int assessmentID, int memberID, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where AssessmentID = {2} and MemberID = {3} ",
                GetFieldNames<AssessmentAMember.Fields>(out nFieldCount), AssessmentAMember.TableName
                , assessmentID
                , memberID);
            ...
            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                AssessmentAMember model = ReadAssessmentAMember(arrResult, 0, out strErrorMessage);
        ...
        public List<AssessmentAMember> SelectAssessmentAMembers(Dictionary<AssessmentAMember.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectAssessmentAMembers(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<AssessmentAMember> SelectAssessmentAMembers(Dictionary<AssessmentAMember.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<AssessmentAMember.Fields>(out nFieldCount), AssessmentAMember.TableName);

            string strCondition = "";

            if (SetCondition<AssessmentAMember.Fields>(ref strCondition, dicConditions, AssessmentAMember.GetFieldName, AssessmentAMember.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<AssessmentAMember> datas = new List<AssessmentAMember>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                AssessmentAMember model = ReadAssessmentAMember(arrResult, i, out strErrorMessage);
        ...
        private AssessmentAMember ReadAssessmentAMember(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            AssessmentAMember model = new AssessmentAMember();
            bool isNullable;

            foreach (AssessmentAMember.Fields field in AssessmentAMember.Fields.GetValues(typeof(AssessmentAMember.Fields)))
            {
                string strFieldName = AssessmentAMember.GetFieldName(field, out isNullable);

                if (field == AssessmentAMember.Fields.AssessmentID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentAMember.Fields.MemberID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentAMember.Fields.Score)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentAMember.Fields.IsPass)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentAMember.Fields.Memo)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
        ...
        public AssessmentQ SelectAssessmentQ(int id, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where ID = {2} ",
                GetFieldNames<AssessmentQ.Fields>(out nFieldCount), AssessmentQ.TableName
                , id);
            ...
            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                AssessmentQ model = ReadAssessmentQ(arrResult, 0, out strErrorMessage);
        ...
        public List<AssessmentQ> SelectAssessmentQs(Dictionary<AssessmentQ.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectAssessmentQs(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<AssessmentQ> SelectAssessmentQs(Dictionary<AssessmentQ.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<AssessmentQ.Fields>(out nFieldCount), AssessmentQ.TableName);

            string strCondition = "";

            if (SetCondition<AssessmentQ.Fields>(ref strCondition, dicConditions, AssessmentQ.GetFieldName, AssessmentQ.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<AssessmentQ> datas = new List<AssessmentQ>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                AssessmentQ model = ReadAssessmentQ(arrResult, i, out strErrorMessage);
        ...
        private AssessmentQ ReadAssessmentQ(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            AssessmentQ model = new AssessmentQ();
            bool isNullable;

            foreach (AssessmentQ.Fields field in AssessmentQ.Fields.GetValues(typeof(AssessmentQ.Fields)))
            {
                string strFieldName = AssessmentQ.GetFieldName(field, out isNullable);

                if (field == AssessmentQ.Fields.ID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentQ.Fields.Title)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
                ...
                else if (field == AssessmentQ.Fields.CreateDate)
                {
                    VariousData<DateTime> data = WebDBManager.GetDateTimeField(arrResult[index]);
                ...
                else if (field == AssessmentQ.Fields.UpdateDate)
                {
                    VariousData<DateTime> data = WebDBManager.GetDateTimeField(arrResult[index]);
                ...
                else if (field == AssessmentQ.Fields.RegisterUserID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                    ...
                    {
                        model.RegisterUserID = data.Data;
                    }
                }
                else if (field == AssessmentQ.Fields.EquipZoneID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentQ.Fields.MemberIDs)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
                    ...
                    {
                        model.MemberIDs = data;
                    }
                }
                else if (field == AssessmentQ.Fields.Type)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
        ...
        public AssessmentQItem SelectAssessmentQItem(int id, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1} where ID = {2} ",
                GetFieldNames<AssessmentQItem.Fields>(out nFieldCount), AssessmentQItem.TableName
                , id);
            ...
            if (arrResult != null && arrResult.Count >= nFieldCount)
            {
                AssessmentQItem model = ReadAssessmentQItem(arrResult, 0, out strErrorMessage);
        ...
        public List<AssessmentQItem> SelectAssessmentQItems(Dictionary<AssessmentQItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            return SelectAssessmentQItems(dicConditions, strAdditionalConditions, null, out strErrorMessage);
        }

        public List<AssessmentQItem> SelectAssessmentQItems(Dictionary<AssessmentQItem.Fields, object> dicConditions, string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;
            int nFieldCount;

            string strSQL = string.Format("select {0} from {1}", GetFieldNames<AssessmentQItem.Fields>(out nFieldCount), AssessmentQItem.TableName);

            string strCondition = "";

            if (SetCondition<AssessmentQItem.Fields>(ref strCondition, dicConditions, AssessmentQItem.GetFieldName, AssessmentQItem.TableName, ref strErrorMessage) == false)
                return null;
            ...
            int nResultCount = arrResult.Count;
            List<AssessmentQItem> datas = new List<AssessmentQItem>();

            for (int i = 0; i < nResultCount - (nFieldCount - 1); i += nFieldCount)
            {
                AssessmentQItem model = ReadAssessmentQItem(arrResult, i, out strErrorMessage);
        ...
        private AssessmentQItem ReadAssessmentQItem(ArrayList arrResult, int index, out string strErrorMessage)
        {
            strErrorMessage = null;
            AssessmentQItem model = new AssessmentQItem();
            bool isNullable;

            foreach (AssessmentQItem.Fields field in AssessmentQItem.Fields.GetValues(typeof(AssessmentQItem.Fields)))
            {
                string strFieldName = AssessmentQItem.GetFieldName(field, out isNullable);

                if (field == AssessmentQItem.Fields.ID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentQItem.Fields.QID)
                {
                    VariousData<int> data = WebDBManager.GetIntField(arrResult[index].ToString());
                ...
                else if (field == AssessmentQItem.Fields.Contents)
                {
                    string data = WebDBManager.GetStringField(arrResult[index]);
        ...
        public ArrayList JoinAssessmentQItemQ(string strAdditionalConditions, out string strErrorMessage)
        {
            return JoinAssessmentQItemQ(strAdditionalConditions, null, out strErrorMessage);
        }

        public ArrayList JoinAssessmentQItemQ(string strAdditionalConditions, int? topNCount, out string strErrorMessage)
        {
            strErrorMessage = null;

            string strAssessmentQItemTableName = AssessmentQItem.TableName;
            string strAssessmentQTableName = AssessmentQ.TableName;

            int nAssessmentQItemFieldCount, nAssessmentQFieldCount;

            string strAssessmentQItemFields = GetFieldNames<AssessmentQItem.Fields>(strAssessmentQItemTableName, out nAssessmentQItemFieldCount);
            string strAssessmentQFields = GetFieldNames<AssessmentQ.Fields>(strAssessmentQTableName, out nAssessmentQFieldCount);

            int nFieldsCount = nAssessmentQItemFieldCount + nAssessmentQFieldCount;

            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("Select {0}, {1} ", strAssessmentQItemFields, strAssessmentQFields);
            sb.AppendFormat("  From {0}, {1} ", strAssessmentQItemTableName, strAssessmentQTableName);
            sb.AppendFormat(" Where {0}.{1} = {2}.{3} ", strAssessmentQItemTableName, AssessmentQItem.Fields.QID, strAssessmentQTableName, AssessmentQ.Fields.ID);
            ...
            for (int i = 0; i < nResultCount - (nFieldsCount - 1); i += nFieldsCount)
            {
                AssessmentQItem qItem = ReadAssessmentQItem(arrResult, i, out strErrorMessage);
                ...
                AssessmentQ q = ReadAssessmentQ(arrResult, i + nAssessmentQItemFieldCount, out strErrorMessage);
