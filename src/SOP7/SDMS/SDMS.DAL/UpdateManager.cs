...
namespace SDMS.DAL
{
    ...
    public class UpdateManager : QueryManager, IUpdate
    {
        ...
        public bool UpdateSensorZone(Dictionary<SensorZone.Fields, object> dicSets, Dictionary<SensorZone.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            ...
            if (m_dbManager.GetResultData(strSQL) == null)
            {
                strErrorMessage = m_dbManager.LastErrorMessage + " 쿼리 실패 / " + m_dbManager.DbHost;
        ...
        public bool UpdatePSMSensor(PSM sensor, out string strErrorMessage)
        {
            ...
            dicSets[PSM.Fields.LimitBase] = sensor.LimitBase;
            dicSets[PSM.Fields.LimitType] = sensor.LimitType;
            dicSets[PSM.Fields.LimitValue] = sensor.LimitValue;
            dicSets[PSM.Fields.SiteID] = sensor.SiteID;
        ...
        public bool UpdateFireSensor(Fire sensor, out string strErrorMessage)
        {
            ...
            dicSets[Fire.Fields.Enabled] = sensor.Enabled;
            dicSets[Fire.Fields.SensorSubType] = sensor.SensorSubType;            
            dicSets[Fire.Fields.SiteID] = sensor.SiteID;            
        ...
        public bool UpdateGltfPrivateModelData(Model.GLTF.PrivateModelData modelData, out string strErrorMessage)
        {
            Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicSets = new Dictionary<Model.GLTF.PrivateModelData.Fields, object>();
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraPositionX] = modelData.CameraPositionX;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraPositionY] = modelData.CameraPositionY;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraPositionZ] = modelData.CameraPositionZ;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraQuaternionX] = modelData.CameraQuaternionX;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraQuaternionY] = modelData.CameraQuaternionY;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraQuaternionZ] = modelData.CameraQuaternionZ;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraQuaternionW] = modelData.CameraQuaternionW;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraRotationX] = modelData.CameraRotationX;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraRotationY] = modelData.CameraRotationY;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraRotationZ] = modelData.CameraRotationZ;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraFov] = modelData.CameraFov;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraNear] = modelData.CameraNear;
            dicSets[Model.GLTF.PrivateModelData.Fields.CameraFar] = modelData.CameraFar;
            dicSets[Model.GLTF.PrivateModelData.Fields.OrbitTargetX] = modelData.OrbitTargetX;
            dicSets[Model.GLTF.PrivateModelData.Fields.OrbitTargetY] = modelData.OrbitTargetY;
            dicSets[Model.GLTF.PrivateModelData.Fields.OrbitTargetZ] = modelData.OrbitTargetZ;

            Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicConditions = new Dictionary<Model.GLTF.PrivateModelData.Fields, object>();
            dicConditions[Model.GLTF.PrivateModelData.Fields.ModelDataID] = modelData.ModelDataID;
            dicConditions[Model.GLTF.PrivateModelData.Fields.UserID] = modelData.UserID;

            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<Model.GLTF.PrivateModelData.Fields>(ref strSets, dicSets, Model.GLTF.PrivateModelData.GetFieldName, Model.GLTF.PrivateModelData.TableName, ref strErrorMessage) == false)
                return false;
            ...
            string strSQL = string.Format("Update {0} set {1} where {2}", Model.GLTF.PrivateModelData.TableName, strSets, strCondition);
        ...
        public bool UpdateGltfPrivateModelData(Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicSets, Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";
        ...
        public bool UpdateGltfPrivateModelOrthoData(Model.GLTF.PrivateModelOrthoData modelData, out string strErrorMessage)
        {
            Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicSets = new Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object>();
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraPositionX] = modelData.CameraPositionX;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraPositionY] = modelData.CameraPositionY;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraPositionZ] = modelData.CameraPositionZ;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraQuaternionX] = modelData.CameraQuaternionX;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraQuaternionY] = modelData.CameraQuaternionY;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraQuaternionZ] = modelData.CameraQuaternionZ;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraQuaternionW] = modelData.CameraQuaternionW;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraRotationX] = modelData.CameraRotationX;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraRotationY] = modelData.CameraRotationY;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.CameraRotationZ] = modelData.CameraRotationZ;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.TargetX] = modelData.TargetX;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.TargetY] = modelData.TargetY;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.TargetZ] = modelData.TargetZ;
            dicSets[Model.GLTF.PrivateModelOrthoData.Fields.Zoom] = modelData.Zoom;

            Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicConditions = new Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object>();
            dicConditions[Model.GLTF.PrivateModelOrthoData.Fields.ModelDataID] = modelData.ModelDataID;
            dicConditions[Model.GLTF.PrivateModelOrthoData.Fields.UserID] = modelData.UserID;

            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<Model.GLTF.PrivateModelOrthoData.Fields>(ref strSets, dicSets, Model.GLTF.PrivateModelOrthoData.GetFieldName, Model.GLTF.PrivateModelOrthoData.TableName, ref strErrorMessage) == false)
                return false;
            ...
            string strSQL = string.Format("Update {0} set {1} where {2}", Model.GLTF.PrivateModelOrthoData.TableName, strSets, strCondition);
        ...
        public bool UpdateGltfPrivateModelOrthoData(Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicSets, Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";
        ...
        public bool UpdateETCSensor(ETC sensor, out string strErrorMessage)
        {
            ...
            dicSets[ETC.Fields.LimitBase] = sensor.LimitBase;
            dicSets[ETC.Fields.LimitType] = sensor.LimitType;
            dicSets[ETC.Fields.LimitValue] = sensor.LimitValue;
            dicSets[ETC.Fields.SiteID] = sensor.SiteID;
        ...
        public bool UpdateETCSensor(Dictionary<ETC.Fields, object> dicSets,
            Dictionary<ETC.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";
        ...
        public bool UpdateSdms2DImage(Sdms2DImage obj, out string strErrorMessage)
        {
            Dictionary<Sdms2DImage.Fields, object> dicSets = new Dictionary<Sdms2DImage.Fields, object>();
            dicSets[Sdms2DImage.Fields.ZoneID] = obj.ZoneID;
            dicSets[Sdms2DImage.Fields.FilePath] = obj.FilePath;

            Dictionary<Sdms2DImage.Fields, object> dicConditions = new Dictionary<Sdms2DImage.Fields, object>();
            dicConditions[Sdms2DImage.Fields.ID] = obj.ID;

            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<Sdms2DImage.Fields>(ref strSets, dicSets, Sdms2DImage.GetFieldName, Sdms2DImage.TableName, ref strErrorMessage) == false)
                return false;
            ...
            string strSQL = string.Format("Update {0} set {1} where {2}", Sdms2DImage.TableName, strSets, strCondition);
        ...
        public bool UpdateSdms2DImage(Dictionary<Sdms2DImage.Fields, object> dicSets, Dictionary<Sdms2DImage.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";
        ...
        public bool UpdateWorkerInfo(WorkerInfo obj, out string strErrorMessage)
        {
            Dictionary<WorkerInfo.Fields, object> dicSets = new Dictionary<WorkerInfo.Fields, object>();
            dicSets[WorkerInfo.Fields.SpatialType] = obj.SpatialType;
            dicSets[WorkerInfo.Fields.SpatialID] = obj.SpatialID;
            dicSets[WorkerInfo.Fields.WorkerCount] = obj.WorkerCount;
            dicSets[WorkerInfo.Fields.WorkerType] = obj.WorkerType;
            dicSets[WorkerInfo.Fields.Comment] = obj.Comment;

            Dictionary<WorkerInfo.Fields, object> dicConditions = new Dictionary<WorkerInfo.Fields, object>();
            dicConditions[WorkerInfo.Fields.ID] = obj.ID;

            return UpdateWorkerInfo(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateWorkerInfo(Dictionary<WorkerInfo.Fields, object> dicSets, Dictionary<WorkerInfo.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<WorkerInfo.Fields>(ref strSets, dicSets, WorkerInfo.GetFieldName, WorkerInfo.TableName, ref strErrorMessage) == false)
                return false;
            ...
            return UpdateFromCondition(WorkerInfo.TableName, strSets, strCondition, strAdditionalConditions, out strErrorMessage);
        }

        public bool UpdateElevator(Elevator obj, out string strErrorMessage)
        {
            Dictionary<Elevator.Fields, object> dicSets = new Dictionary<Elevator.Fields, object>();
            dicSets[Elevator.Fields.Door] = obj.Door;
            dicSets[Elevator.Fields.Direction] = obj.Direction;
            dicSets[Elevator.Fields.Run] = obj.Run;
            dicSets[Elevator.Fields.Floor] = obj.Floor;
            dicSets[Elevator.Fields.IsNormal] = obj.IsNormal;
            dicSets[Elevator.Fields.Name] = obj.Name;
            dicSets[Elevator.Fields.GroupNo] = obj.GroupNo;
            dicSets[Elevator.Fields.SiteID] = obj.SiteID;

            Dictionary<Elevator.Fields, object> dicConditions = new Dictionary<Elevator.Fields, object>();
            dicConditions[Elevator.Fields.ID] = obj.ID;

            return UpdateElevator(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateElevator(Dictionary<Elevator.Fields, object> dicSets, Dictionary<Elevator.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<Elevator.Fields>(ref strSets, dicSets, Elevator.GetFieldName, Elevator.TableName, ref strErrorMessage) == false)
                return false;
        ...
        #region 안전구역평가
        public bool UpdateAssessment(Assessment obj, out string strErrorMessage)
        {
            Dictionary<Assessment.Fields, object> dicSets = new Dictionary<Assessment.Fields, object>();
            dicSets[Assessment.Fields.EquipmentZoneID] = obj.EquipmentZoneID;
            dicSets[Assessment.Fields.SendDate] = obj.SendDate;
            dicSets[Assessment.Fields.SendUserID] = obj.SendUserID;
            dicSets[Assessment.Fields.Score] = obj.Score;
            dicSets[Assessment.Fields.Title] = obj.Title;
            dicSets[Assessment.Fields.ResultDate] = obj.ResultDate;
            dicSets[Assessment.Fields.UpdateDate] = obj.UpdateDate;
            dicSets[Assessment.Fields.IsPass] = obj.IsPass;
            dicSets[Assessment.Fields.Type] = obj.Type;

            Dictionary<Assessment.Fields, object> dicConditions = new Dictionary<Assessment.Fields, object>();
            dicConditions[Assessment.Fields.ID] = obj.ID;

            return UpdateAssessment(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateAssessment(Dictionary<Assessment.Fields, object> dicSets, Dictionary<Assessment.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<Assessment.Fields>(ref strSets, dicSets, Assessment.GetFieldName, Assessment.TableName, ref strErrorMessage) == false)
                return false;
            ...
            return UpdateFromCondition(Assessment.TableName, strSets, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool UpdateAssessmentA(AssessmentA obj, out string strErrorMessage)
        {
            Dictionary<AssessmentA.Fields, object> dicSets = new Dictionary<AssessmentA.Fields, object>();
            dicSets[AssessmentA.Fields.AssessmentID] = obj.AssessmentID;
            dicSets[AssessmentA.Fields.Contents] = obj.Contents;

            Dictionary<AssessmentA.Fields, object> dicConditions = new Dictionary<AssessmentA.Fields, object>();
            dicConditions[AssessmentA.Fields.ID] = obj.ID;

            return UpdateAssessmentA(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateAssessmentA(Dictionary<AssessmentA.Fields, object> dicSets, Dictionary<AssessmentA.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<AssessmentA.Fields>(ref strSets, dicSets, AssessmentA.GetFieldName, AssessmentA.TableName, ref strErrorMessage) == false)
                return false;
            ...
            return UpdateFromCondition(AssessmentA.TableName, strSets, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool UpdateAssessmentAItem(AssessmentAItem obj, out string strErrorMessage)
        {
            Dictionary<AssessmentAItem.Fields, object> dicSets = new Dictionary<AssessmentAItem.Fields, object>();
            dicSets[AssessmentAItem.Fields.Score] = obj.Score;
            dicSets[AssessmentAItem.Fields.Memo] = obj.Memo;

            Dictionary<AssessmentAItem.Fields, object> dicConditions = new Dictionary<AssessmentAItem.Fields, object>();
            dicConditions[AssessmentAItem.Fields.AssessmentID] = obj.AssessmentID;
            dicConditions[AssessmentAItem.Fields.AID] = obj.AID;
            dicConditions[AssessmentAItem.Fields.MemberID] = obj.MemberID;

            return UpdateAssessmentAItem(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateAssessmentAItem(Dictionary<AssessmentAItem.Fields, object> dicSets, Dictionary<AssessmentAItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<AssessmentAItem.Fields>(ref strSets, dicSets, AssessmentAItem.GetFieldName, AssessmentAItem.TableName, ref strErrorMessage) == false)
                return false;
            ...
            return UpdateFromCondition(AssessmentAItem.TableName, strSets, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool UpdateAssessmentAMember(AssessmentAMember obj, out string strErrorMessage)
        {
            Dictionary<AssessmentAMember.Fields, object> dicSets = new Dictionary<AssessmentAMember.Fields, object>();
            dicSets[AssessmentAMember.Fields.Score] = obj.Score;

            Dictionary<AssessmentAMember.Fields, object> dicConditions = new Dictionary<AssessmentAMember.Fields, object>();
            dicConditions[AssessmentAMember.Fields.AssessmentID] = obj.AssessmentID;
            dicConditions[AssessmentAMember.Fields.MemberID] = obj.MemberID;
            dicConditions[AssessmentAMember.Fields.IsPass] = obj.IsPass;
            dicConditions[AssessmentAMember.Fields.Memo] = obj.Memo;

            return UpdateAssessmentAMember(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateAssessmentAMember(Dictionary<AssessmentAMember.Fields, object> dicSets, Dictionary<AssessmentAMember.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<AssessmentAMember.Fields>(ref strSets, dicSets, AssessmentAMember.GetFieldName, AssessmentAMember.TableName, ref strErrorMessage) == false)
                return false;
            ...
            return UpdateFromCondition(AssessmentAMember.TableName, strSets, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool UpdateAssessmentQ(AssessmentQ obj, out string strErrorMessage)
        {
            Dictionary<AssessmentQ.Fields, object> dicSets = new Dictionary<AssessmentQ.Fields, object>();
            dicSets[AssessmentQ.Fields.Title] = obj.Title;
            dicSets[AssessmentQ.Fields.CreateDate] = obj.CreateDate;
            dicSets[AssessmentQ.Fields.UpdateDate] = obj.UpdateDate;
            dicSets[AssessmentQ.Fields.RegisterUserID] = obj.RegisterUserID;
            dicSets[AssessmentQ.Fields.EquipZoneID] = obj.EquipZoneID;
            dicSets[AssessmentQ.Fields.MemberIDs] = obj.MemberIDs;
            dicSets[AssessmentQ.Fields.Type] = obj.Type;

            Dictionary<AssessmentQ.Fields, object> dicConditions = new Dictionary<AssessmentQ.Fields, object>();
            dicConditions[AssessmentQ.Fields.ID] = obj.ID;

            return UpdateAssessmentQ(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateAssessmentQ(Dictionary<AssessmentQ.Fields, object> dicSets, Dictionary<AssessmentQ.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<AssessmentQ.Fields>(ref strSets, dicSets, AssessmentQ.GetFieldName, AssessmentQ.TableName, ref strErrorMessage) == false)
                return false;
            ...
            return UpdateFromCondition(AssessmentQ.TableName, strSets, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool UpdateAssessmentQItem(AssessmentQItem obj, out string strErrorMessage)
        {
            Dictionary<AssessmentQItem.Fields, object> dicSets = new Dictionary<AssessmentQItem.Fields, object>();
            dicSets[AssessmentQItem.Fields.QID] = obj.QID;
            dicSets[AssessmentQItem.Fields.Contents] = obj.Contents;

            Dictionary<AssessmentQItem.Fields, object> dicConditions = new Dictionary<AssessmentQItem.Fields, object>();
            dicConditions[AssessmentQItem.Fields.ID] = obj.ID;

            return UpdateAssessmentQItem(dicSets, dicConditions, null, out strErrorMessage);
        }

        public bool UpdateAssessmentQItem(Dictionary<AssessmentQItem.Fields, object> dicSets, Dictionary<AssessmentQItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            string strSets = "";

            if (SetData<AssessmentQItem.Fields>(ref strSets, dicSets, AssessmentQItem.GetFieldName, AssessmentQItem.TableName, ref strErrorMessage) == false)
                return false;
            ...
            return UpdateFromCondition(AssessmentQItem.TableName, strSets, strCondition, strAdditionalConditions, out strErrorMessage);
        }
        #endregion
    }
}
