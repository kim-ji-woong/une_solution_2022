...
namespace SDMS.DAL
{
    ...
    public class DeleteManager : QueryManager, IDelete
    {
        ...
        public bool DeleteGltfPrivateModelData(int modelDataID, int userID, out string strErrorMessage)
        {
        ...
        public bool DeleteGltfPrivateModelData(Dictionary<Model.GLTF.PrivateModelData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            string strSQL = string.Format("Delete from {0}", Model.GLTF.PrivateModelData.TableName);
        ...
        public bool DeleteGltfPrivateModelOrthoData(int modelDataID, int userID, out string strErrorMessage)
        {
            string strSQL = string.Format("Delete from {0} where {1} = {2} and {3} = {4}",
        ...
        public bool DeleteGltfPrivateModelOrthoData(Dictionary<Model.GLTF.PrivateModelOrthoData.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            string strSQL = string.Format("Delete from {0}", Model.GLTF.PrivateModelOrthoData.TableName);
        ...
        public bool DeleteSdms2DImage(int id, out string strErrorMessage)
        {
            bool isNullable;
            string strSQL = string.Format("Delete from {0} where ID = {1}", Sdms2DImage.TableName, Sdms2DImage.GetFieldName(Sdms2DImage.Fields.ZoneID, out isNullable), id);
        ...
        public bool DeleteSdms2DImage(Dictionary<Sdms2DImage.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            string strSQL = string.Format("Delete from {0}", Sdms2DImage.TableName);
        ...
        public bool DeleteSdmsSensorETC(int id, out string strErrorMessage)
        {
            return DeleteFromID(ETC.TableName, id, out strErrorMessage);
        }

        public bool DeleteSdmsSensorETC(Dictionary<ETC.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
        ...
        public bool DeleteWorkerInfo(int id, out string strErrorMessage)
        {
            return DeleteFromID(WorkerInfo.TableName, id, out strErrorMessage);
        }

        public bool DeleteWorkerInfo(Dictionary<WorkerInfo.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            return DeleteFromCondition(WorkerInfo.TableName, strCondition, strAdditionalConditions, out strErrorMessage);
        }

        public bool DeleteElevator(int id, out string strErrorMessage)
        {
            return DeleteFromID(Elevator.TableName, id, out strErrorMessage);
        }

        public bool DeleteElevator(Dictionary<Elevator.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            return DeleteFromCondition(Elevator.TableName, strCondition, strAdditionalConditions, out strErrorMessage);
        }
        ...
        #region 안전구역평가
        public bool DeleteAssessment(int id, out string strErrorMessage)
        {
            return DeleteFromID(Assessment.TableName, id, out strErrorMessage);
        }

        public bool DeleteAssessment(Dictionary<Assessment.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            return DeleteFromCondition(Assessment.TableName, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool DeleteAssessmentA(int id, out string strErrorMessage)
        {
            return DeleteFromID(AssessmentA.TableName, id, out strErrorMessage);
        }

        public bool DeleteAssessmentA(Dictionary<AssessmentA.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            return DeleteFromCondition(AssessmentA.TableName, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool DeleteAssessmentAItem(int assessmentID, int aID, int memberID, out string strErrorMessage)
        {
            Dictionary<AssessmentAItem.Fields, object> dicConditions = new Dictionary<AssessmentAItem.Fields, object>();
            dicConditions[AssessmentAItem.Fields.AssessmentID] = assessmentID;
            dicConditions[AssessmentAItem.Fields.AID] = aID;
            dicConditions[AssessmentAItem.Fields.MemberID] = memberID;

            return DeleteAssessmentAItem(dicConditions, null, out strErrorMessage);
        }

        public bool DeleteAssessmentAItem(Dictionary<AssessmentAItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            return DeleteFromCondition(AssessmentAItem.TableName, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool DeleteAssessmentAMember(int assessmentID, int memberID, out string strErrorMessage)
        {
            Dictionary<AssessmentAMember.Fields, object> dicConditions = new Dictionary<AssessmentAMember.Fields, object>();
            dicConditions[AssessmentAMember.Fields.AssessmentID] = assessmentID;
            dicConditions[AssessmentAMember.Fields.MemberID] = memberID;

            return DeleteAssessmentAMember(dicConditions, null, out strErrorMessage);
        }

        public bool DeleteAssessmentAMember(Dictionary<AssessmentAMember.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            return DeleteFromCondition(AssessmentAMember.TableName, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool DeleteAssessmentQ(int id, out string strErrorMessage)
        {
            return DeleteFromID(AssessmentQ.TableName, id, out strErrorMessage);
        }

        public bool DeleteAssessmentQ(Dictionary<AssessmentQ.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            return DeleteFromCondition(AssessmentQ.TableName, strCondition, strAdditionalConditions, out strErrorMessage);
        }


        public bool DeleteAssessmentQItem(int id, out string strErrorMessage)
        {
            return DeleteFromID(AssessmentQItem.TableName, id, out strErrorMessage);
        }

        public bool DeleteAssessmentQItem(Dictionary<AssessmentQItem.Fields, object> dicConditions, string strAdditionalConditions, out string strErrorMessage)
        {
            strErrorMessage = null;
            string strCondition = "";
            ...
            return DeleteFromCondition(AssessmentQItem.TableName, strCondition, strAdditionalConditions, out strErrorMessage);
        }
        #endregion
    }
}
