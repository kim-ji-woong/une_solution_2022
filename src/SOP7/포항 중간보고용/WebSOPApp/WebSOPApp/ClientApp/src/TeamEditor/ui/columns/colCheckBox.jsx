...
import { LabelInputCheckbox } from '../../../SOPManager/styled/componentsStyled';
...
class ColCheckBox extends Component {
    ...
    render() {
        return (
            <div className={uneStyles.editCheckBox}>
                <input type="checkbox" checked={this.state.check} onChange={(e) => this.onChangeCheck(e.target)} />
            </div>
        );
