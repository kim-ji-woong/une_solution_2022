        ...
        if (this.state.content === HistoryResource.menu.센서_탐지_이력) {
            ...
            return (
                <ReportHistoryComponent>
                    {leftMenu}
                    <ReportHistory key='history_ReportHistory' changeContent={this.changeContent} />
                </ReportHistoryComponent>
            );
        } else if (this.state.content === HistoryResource.menu.센서_탐지_차트) {
            return (
                <StatisticsHistoryComponent>
                    {leftMenu}
                    <StatisticsHistory key='history_StatisticsHistory' changeContent={this.changeContent} selectedSiteID={this.state.selectedSiteID} />
                </StatisticsHistoryComponent>
            );
        } 
    }
