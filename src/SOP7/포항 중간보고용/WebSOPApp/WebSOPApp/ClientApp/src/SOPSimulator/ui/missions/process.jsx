...
class Process extends Component {
    ...
    showConfirmDialogExternal(mission) {
        ...
        this.props.showConfirmDialog(ProjectResource.dialogTypes.QUESTION, ['외부 프로그램을 실행할까요?'], ['취소', '실행'], this.onProgress);
    }
    ...
    showConfirmDialog(onClickType, mission) {
        ...
        if (this.props.sectionData.receivers === null || this.props.sectionData.receivers.length === 0) {
            ...
            this.props.showConfirmDialog(ProjectResource.dialogTypes.ERROR, [strMessage], null, null);
            return;
        }
        ...
        //}
        //else {
        this.props.showConfirmDialog(ProjectResource.dialogTypes.QUESTION, [strMessage],  ['취소', '상황 전파'], this.onProgress);
        //}
    }
