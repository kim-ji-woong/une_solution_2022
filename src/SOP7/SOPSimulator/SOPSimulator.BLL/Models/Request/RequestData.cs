...
namespace SOPSimulator.BLL.Models.Request
{
    ...
    public class RequestProgressInternalSpread
    {
        ...
        private List<Receiver> m_teams = null;
        public List<Receiver> Teams
        {
            get { return m_teams; }
            set { m_teams = value; }
        }
    ...
    /// 외부 프로그램 실행
    /// </summary>
    public class RequestExcuteExternalProgram
    {
        private string m_strSopKey = "";
        public string SopKey
        {
    ...
    public class RequestSensorMaterials
    {
        private int m_nSensorZoneHistoryID = -1;
    ...
    {
        public string SopKey { get; set; }
        public int NextActionStepID { get; set; }
        public int PrevActionStepID { get; set; }
