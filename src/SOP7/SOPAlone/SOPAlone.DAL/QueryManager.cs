...
namespace SOPAlone.DAL
{
    public class QueryManager
    {
        ...
        protected bool SetCondition<DataType>(ref string strCondition, Dictionary<DataType, object> dicConditions, GetFieldNameMethod<DataType> method, string strTableName, ref string strErrorMessage)
        {
            ...
            {
                //Dictionary<string, string> dicColumnInfo = new Dictionary<string, string>(); //GetColumnInfoDictionaryToLower(strTableName);
        ...
        protected string GetFieldNames<EnumType>(bool isParam = false)
        {
            string strFields = "";
