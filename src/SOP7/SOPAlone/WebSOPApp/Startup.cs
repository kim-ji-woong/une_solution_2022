    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            if (m_configManager.Site.SiteID != null && m_configManager.Site.DBType != null)
            {
                ...
                services.AddTransient<global::SOPAlone.IDAL.IDataManager>(service => new global::SOPAlone.DAL.DataManager(nDBType, strDbHost, strDBName, strDbID, strDbPW, nSiteID));
