...
namespace WebSOPApp.Areas.SOPManager.Controllers
{
    ...
    public class SOPController : Controller
    {
        ...
        public SOPController(global::SOPManager.IDAL.IDataManager sopDataManager, global::Common.IDAL.IDataManager commonDataManager, global::TeamEditor.IDAL.IDataManager teamDataManager)
        {
        ...
        public IActionResult SaveLinkedSops([FromBody] RequestSaveLinkedSOPs req)
        {
