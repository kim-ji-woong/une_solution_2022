...
class SopManager extends Component {
    ...
    getPopup() {
        if (this.state.content === SopManager.menu.open) {
            ...
            return <DeleteSOPOptions sopData={this.state.sopData} content={this.changeContent} showConfirmDialog={this.showConfirmDialog} onCloseConfirmDialog={this.onCloseConfirmDialog} />;
        }
    ...
    render() {
        return (
            <div id="subPage">
                ...
                <SubAside /* id={styles.subAside} className={styles.sop} */>
