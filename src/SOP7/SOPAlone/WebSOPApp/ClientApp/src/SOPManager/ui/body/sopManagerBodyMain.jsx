...
import ProcessShape from '../../../SOPManager/image/process.png';
import DecisionShape from '../../../SOPManager/image/judgment.png'; 
import AnnotationShape from '../../../SOPManager/image/explanation.png'; 
import EndPointShape from '../../../SOPManager/image/startEnd.png';
import InternalShape from '../../../SOPManager/image/internal.png';
...
import { SopProcessWrap, SopProcessLeft, SopAcdn, SopAcdnDt, SopAcdnDD } from '../../../SOPManager/styled/managerStyled';
import { SopEdt1, SopEdtTitle, SopEdtRdo, SopEdtRdo2 } from '../../../SOPManager/styled/managerStyled';
import { SopEdt2, SopEdtCpnt /* , ProcessShape, DecisionShape, AnnotationShape, EndpointShape, InternalShape */ } from '../../../SOPManager/styled/managerStyled';
import { SopEdt3, SopEdtTpy } from '../../../SOPManager/styled/managerStyled';
import { SopCent, SpcTop, SopTopUndo, SopTopRedo, SopTopCopy, SopTopCut, SopTopPaste, SopTopDel, SopTopFileOpen, SopTopFileSave } from '../../../SOPManager/styled/managerStyled';
import { SpcWrap, SopTitle, SpcCont } from '../../../SOPManager/styled/managerStyled';
import { SpRht } from '../../../SOPManager/styled/managerStyled';
import { LabelInputRadio } from '../../../SOPManager/styled/componentsStyled.js';
//import $ from 'jquery';
...
class SopManagerBodyMain extends Component {
	...
	onApplyComponentProperty = async (sectionData, actionStep, shouldUpdate) => {
		...
		if (stepMember !== null) {
			...
			if (!success) {
				this.props.showConfirmDialog('에러', [errorMessage], null, this.onClickCancle);
				return;
			}
	...
	render() {
		...
		return (
			<>
				<SopProcessWrap>
					<SopProcessLeft ref={this.refSpLft}>
						<div className={SopManagerBodyMain.cssStyles.scrollbarOuter}>
							<div className={SopManagerBodyMain.cssStyles.sopAcdn}>
								...
								<dd ref={this.refDDActionStep} className={cascadingActionStep}>
									<SopEdt1>
										<div className={styles.sopEdtTitle}>
								...
								<dd ref={this.refDDComponent} className={cascadingAddComponent}>
									 <SopEdt2>
										<SopEdtCpnt>
											<li><img ref={this.refProcessImage} className={SopManagerBodyMain.cssStyles.clickable} src={ProcessShape} alt="" /></li>
											<li><img ref={this.refAnnotationImage} className={SopManagerBodyMain.cssStyles.clickable} src={AnnotationShape} alt="" /></li>
											<li><img ref={this.refDecisionImage} className={SopManagerBodyMain.cssStyles.clickable} src={DecisionShape} alt="" /></li>
											<li><img ref={this.refEndpointImage} className={SopManagerBodyMain.cssStyles.clickable} src={EndPointShape} alt="" /></li>
											<li><img ref={this.refInternalImage} className={SopManagerBodyMain.cssStyles.clickable} src={InternalShape} alt="" /></li>
										</SopEdtCpnt>
								     </SopEdt2>
								</dd>
								...
								<dd ref={this.refDDSpecialCharacter} className={cascadingSpecialCharacter}>
									 <SopEdt3>
										...
										<textarea cols="30" rows="6" className={SopManagerBodyMain.cssStyles.sopEdtText + " " + SopManagerBodyMain.cssStyles.scrollbarOuter} value={this.state.specialMessage.currentMessage} onChange={() => { }}>
										</textarea>
								     </SopEdt3>
							    </dd>
							</div>
					...
					<SopCent>
					   ...
					   {/*  <li><a className={SopManagerBodyMain.cssStyles.spctUndo + " " + SopManagerBodyMain.cssStyles.clickable} onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.undo, null)}>{SopManagerResource.ID.editMenu.undo}</a></li>
							...
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.undo, null)}><SopTopUndo></SopTopUndo><span>{SopManagerResource.ID.editMenu.undo}</span></li>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.redo, null)}><SopTopRedo></SopTopRedo><span>{SopManagerResource.ID.editMenu.redo}</span></li>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.copy, null)}><SopTopCopy></SopTopCopy><span>{SopManagerResource.ID.editMenu.copy}</span></li>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.cut, null)}><SopTopCut></SopTopCut><span>{SopManagerResource.ID.editMenu.cut}</span></li>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.paste, null)}><SopTopPaste></SopTopPaste><span>{SopManagerResource.ID.editMenu.paste}</span></li>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.delete, null)}><SopTopDel></SopTopDel><span>{SopManagerResource.ID.editMenu.delete}</span></li>
							{/* <li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.paste, null)}><SopTopFileOpen></SopTopFileOpen><span>파일열기</span></li>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.delete, null)}><SopTopFileSave></SopTopFileSave><span>파일저장</span></li> */}
						</SpcTop>
						<SpcWrap>
							<SopTitle>{sopName}</SopTitle>
							<SpcCont>
