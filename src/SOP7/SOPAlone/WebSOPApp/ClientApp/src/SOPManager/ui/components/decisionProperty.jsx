...
import { ScrollWrapper, ScrollContent, ScrollContentModify, ScrollContentDecision, ScrollContentJudgment, TableTitle, SprBot } from '../../../SOPManager/styled/componentsStyled';
						...
						<SprmCont>
							<dl className={DecisionProperty.cssStyles.sprmAcdn}>
								...
								<dd ref={this.refVariableDD} className={this.getVariableClassName()}>
									<ScrollWrapper>
									   <ScrollContentModify>
									      <textarea name="" id="" cols="30" rows="10" /* className={DecisionProperty.cssStyles.sprtTxtara + " scrollbar-outer"} */></textarea>
									   </ScrollContentModify>
									</ScrollWrapper>
