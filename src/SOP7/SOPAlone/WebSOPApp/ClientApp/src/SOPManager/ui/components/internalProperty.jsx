...
import { SprCont, SprTop, SprtTitle, SprtIpt, SprtIptTitleInter } from '../../../SOPManager/styled/componentsStyled';
import { ScrollWrapper, ScrollContent, ScrollContentInternal, ScrollContentReci, ScrollContentSpread, ScrollContentView } from '../../../SOPManager/styled/componentsStyled';
import { SprMidInternal, SprmCont, SprmSms, LabelInput, LabelInputRadio, SprmTeam, SprmRdo, SprBot } from '../../../SOPManager/styled/componentsStyled';
import { SprmSprd, SprmSpBtn } from '../../../SOPManager/styled/componentsStyled';
									...
									<dd className={this.getReceiversClassName()}>
										<SprmSms>
											<label>
												...
												{
													(ProjectResource.SiteID !== ProjectResource.Site.Cleannara) ? '문자발송' : '카카오톡'
												}
											</label>
											<label>
												<LabelInput>
