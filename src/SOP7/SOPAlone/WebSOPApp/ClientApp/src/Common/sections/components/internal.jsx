...
class Internal extends SectionComponent {
    ...
    getTranstypeElement() {
        console.log(ProjectResource.Site.Cleannara);
        return (
            <div className={sectionStyles.sectionMarkArea}>
                ...
                {
                    this.props.sectionData.isSMS && ProjectResource.SiteID === ProjectResource.Site.Cleannara
                        ? <div className={sectionStyles.sectionMark + " " + sectionStyles.sms + " " + sectionStyles.internal}>{SopManagerResource.ID.sectionMark.kakaoTalk}</div>
    ...
    render() {
        ...
        if (this.props.status === SectionData.Status_Run) {
            ...
            statusClass = " " + sectionStyles.runComponent;
            sectionClassName += " " + sectionStyles.exec;
        }
