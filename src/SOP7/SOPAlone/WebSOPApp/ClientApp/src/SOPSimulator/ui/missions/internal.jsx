        ...
        if (this.props.sectionData.isSMS)
            tagUI.push(
                <span key='sms' className={uis.flag + " " + uis.flagSms}>
                    {ProjectResource.SiteID === ProjectResource.Site.Cleannara ? '카톡' : '문자'}
                </span>
            );
            ...
            <div className={uis.sectionBox + boxClassName + " " + uneStyles.sectionBox} id={this.props.id}>
                    ...
                    </div>
                    {
                        (this.props.sectionData.isSMS) ?
                            ProjectResource.SiteID === ProjectResource.Site.Cleannara ?
                                <div><button type="button" onClick={() => this.showConfirmDialog(true, false, false, false)}><i className={uneStyles.talkBtnOff}></i></button></div>
                ...
                <dl className={uis.taskDetail + " " + uis.taskSubSection}>
                    <div className={uis.taskSub}>
                        <dt style={{ paddingLeft: '10px' }}>전파메시지</dt>
