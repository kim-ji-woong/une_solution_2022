...
class TeamMenu extends Component {
	...
	addRootTeam = async () => {
		...
		const nodeData = { ID: -1, TeamName: name, ParentTeam: null, ParentTeamID: null, Children: [], SiteID: ProjectResource.SiteID };
	...
	addTeam = async () => {
		...
		const nodeData = { ID: -1, TeamName: name, ParentTeam: null, ParentTeamID: this.props.selectedTeam.ID, Children: [], SiteID:ProjectResource.SiteID };
