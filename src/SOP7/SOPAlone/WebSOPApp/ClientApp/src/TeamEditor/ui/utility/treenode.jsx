	...
	getCheckBox() {
		if (this.props.useCheckBox === TreeNode.CheckBox_NormalUse) {
			if (this.props.teamTreeData.checked === TreeNode.CHECKED_ALL) {
				return <LabelInput><input type="checkbox" checked={true} onChange={this.onChecked} style={{ 'vertical-align': 'top' }} /></LabelInput>;
			}
			else {
				return <LabelInput><input type="checkbox" checked={false} onChange={this.onChecked} style={{ 'vertical-align': 'top' }} /></LabelInput>;
			}
		}
