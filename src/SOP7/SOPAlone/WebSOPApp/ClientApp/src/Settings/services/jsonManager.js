export default class JsonManager{
    ...
    static makeRequestSopCommonSetting(propertyName) {
        const json = {
            "RequestSopCommonSetting":
            {
    ...
    static makeSaveSettings(saveData) {
        const json = {
            "requestSaveSettings":
            {
                ...
                "sosSOPWaitEndTime": saveData.sosSOPWaitEndTime,

                "svmsSOPWaitEndTime": saveData.svmsSOPWaitEndTime,
                "earthquakeSOPWaitEndTime": saveData.earthquakeSOPWaitEndTime,
                "strongWindSOPWaitEndTime": saveData.strongWindSOPWaitEndTime,
                "blackoutSOPWaitEndTime": saveData.blackoutSOPWaitEndTime,
                "collapseSOPWaitEndTime": saveData.collapseSOPWaitEndTime,                
                "confinedSOPWaitEndTime": saveData.confinedSOPWaitEndTime,
                "virtualFenceSOPWaitEndTime": saveData.virtualFenceSOPWaitEndTime,
