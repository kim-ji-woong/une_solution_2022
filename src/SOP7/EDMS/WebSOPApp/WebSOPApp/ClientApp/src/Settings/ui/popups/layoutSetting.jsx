...
class LayoutSetting extends Component {
	...
	async init() {
		...
		this.setState({ settings: result, isLoading: false, buildingGroupList, teamTreeDatas, teams, members, disasterCategories, spreadMessages, linkedSOPs });
	...
	setMenuUI = () => {
		...
		if (this.state.isLoading === true) {
			...
			menuUI.push(
				<SystemInfo key="SystemInfo" settings={this.state.settings} />);
		}
