		...
		if (userInfo.level === AccountResource.ID.accountLevel.admin) {
			authorMenuUI.push(<React.Fragment>
				<div className={newStyles.stgName}>
					<h5>건물정보 업데이트</h5>
					<span className={newStyles.stgTltp} data-tooltip="건물 정보를 엑셀로 업로드/다운로드 (최대 10MB 가능)"></span>
	...
	render() {
		...
		if (ProjectResource.isGSMode !== true) {
			receiveTypeUI = <React.Fragment>
				<li><p>누출</p><input ref={this.refUseReceivePSM} type="checkbox" name="stgAlt" id="stgAlt02" onChange={(e) => this.onChangeReceivePSM(e.target)} /><label htmlFor="stgAlt02">수신</label></li>
				<li><p>기타</p><input ref={this.refUseReceiveETC} type="checkbox" name="stgAlt" id="stgAlt03" onChange={(e) => this.onChangeReceiveETC(e.target)} /><label htmlFor="stgAlt03">수신</label></li>
				<li><p>SVMS</p><input ref={this.refUseReceiveSVMS} type="checkbox" name="stgAlt" id="stgAlt04" onChange={(e) => this.onChangeReceiveSVMS(e.target)} /><label htmlFor="stgAlt04">수신</label></li>
			</React.Fragment>;
			...
			broadcastUI =
				<div className={newStyles.stgName}>
					...
					<input ref={this.refUseBroadcast} type="checkbox" name="" id="" onChange={this.onChangeAlarmBroadcast} /><span className={settings.white}>&nbsp;&nbsp;사용 &nbsp;&nbsp;</span>
					<input ref={this.refNotUseBroadcast} type="checkbox" name="" id="" onChange={this.onChangeAlarmBroadcast} /><span className={settings.white}>&nbsp;&nbsp;사용안함 &nbsp;&nbsp;</span>
				</div>;
		}
