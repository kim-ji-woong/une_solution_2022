...
import edmsLogo from '../../Common/image/common/edmsLogo.png';
...
class LoginPageSB extends Component {
	...
	getLogo(){
		if (ProjectResource.SiteID === ProjectResource.Site.Edms) {
			return <div className={contents.indexLoginTitlee}><img className={accounts.logoSize} src={edmsLogo} alt="edms" /></div>
		}
