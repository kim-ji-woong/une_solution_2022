...
class TitleBarSB extends Component {
    ...
    keysPressed(e, target) {
        ...
        // GS인증에 따른 단축키 설정 
        else if (TitleBarSB.keys[commonKey] && TitleBarSB.keys[parseInt(shortcutKey.sop)] && ProjectResource.isGSMode !== true) {
            console.log("sop 단축키");
            ...
            // prevent default browser behavior
            e.preventDefault();
        } else if (TitleBarSB.keys[commonKey] && TitleBarSB.keys[parseInt(shortcutKey.sopMgr)] && ProjectResource.isGSMode !== true) {
            // sopMgr 단축키
            ...
            // prevent default browser behavior
            e.preventDefault();
        } else if (TitleBarSB.keys[commonKey] && TitleBarSB.keys[parseInt(shortcutKey.dashboard)] && ProjectResource.isGSMode !== true) {
            // dashboard 단축키
            ...
            // prevent default browser behavior
            e.preventDefault();
        } else if (TitleBarSB.keys[commonKey] && TitleBarSB.keys[parseInt(shortcutKey.history)] && ProjectResource.isGSMode !== true) {
            // history 단축키
