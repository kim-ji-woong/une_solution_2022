...
class SDMSMainMenu extends Component {
    ...
    static Electric_Sensor = "electric";
    static FireControl_Sensor = "fireControl";
    static FireAlarm_Sensor = "fireAlarm";
    static Formal_Sensor = "formal";
    static ExitLight_Sensor = "exitLight";
    static AirFan = "airFan";
    static Panel1 = "panel_1";
    static Panel2 = "panel_2";
    static Escape = "escape";
    static Escape_02 = "escape_02";
    static Escape_03 = "escape_03";
    static Escape_04 = "escape_04";
    static Escape_05 = "escape_05";
    ...
    // FireSensor SubType
    static FireControl_TypeID = 1;
    static FireAlarm_TypeID = 2;
    static Formal_Typeid = 3;

    // EtcSensor Material Type
    static Electric_TypeID = 1;
    static ExitLight_TypeID = 2;
    static AirFan_TypeID = 3;
    ...
    static getSensorType(sensorTypeID) {
        if (sensorTypeID === SdmsResource.facilityType.FIRE) {
            return SDMSMainMenu.Fire_Sensor;
        }
        else if (sensorTypeID === SdmsResource.facilityType.PSM_SENSOR) {
            return SDMSMainMenu.PSM_Sensor;
        }
        else if (sensorTypeID === SdmsResource.facilityType.ETC) {
