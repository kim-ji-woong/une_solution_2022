...
export default class SdmsResource {
    ...
    static getFacilityTypeString(nType) {
        if (nType === SdmsResource.facilityType.FIRE)
            ...
            return "지능형영상(화재)";
        else if (nType === SdmsResource.materialType.FireFacility)
            return "소화설비";
        else if (nType === SdmsResource.materialType.AirFacility)
            return "공조설비";
        else if (nType === SdmsResource.materialType.ElectricFacility)
            return "전기설비";
        else if (nType === SdmsResource.materialType.PanelFacility)
            return "Panel";
        else if (nType === SdmsResource.materialType.ExitLight)
            return "유도등";
    ...
    static popupResetLocation = {
        ...
        workerInfo: {
            x: '20%', y: '60%', height: '380px', width: '600px'
        },
        sensorStatus: {
