...
class Toolbar extends Component {
    ...
    render() {
        ...
        const viewModeClassName = this.props.xRayView ? styles.xray : styles.normal;
        ...
        return (
            <>
                    ...
                    <div>
                        <ul className={styles.dsnMenu}>
                            ...
                            */}
                            ...
                            <li><a className={viewModeClassName} onClick={() => this.props.toggleViewMode()}> </a></li>
                        </ul>
                ...
                </div>
                {
                    ...
                    <div id={styles.dsBack2Origin}>
                        <button onClick={() => this.props.goBackPrevOutdoor()}>외부공간으로 가기</button>
                    </div>
                }
            </>
        );
