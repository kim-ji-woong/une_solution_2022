...
class StatusInfoBuilding extends Component {
    ...
    setZoneUI(zoneDatas, ui) {
        ...
        for (var i = 0; i < zoneDatas.length; i++) {
            ...
            let fireSensors = null, psmSensors = null, etcSensors = null, cctvs = null, facilityInfos = null, exitLights = null;
            ...
            if (this.props.sensorList) {
                ...
                const _exitLights = this.props.sensorList['exitLights'];
                ...
                if (_exitLights) {
                    exitLights = _exitLights.filter(x => x.zoneID === zone.id && (x.visible === true || this.props.searchText === ''));
                }
    ...
    render() {
        ...
        const buildingName = this.props.building.displayText ? this.props.building.displayText : SDMSResource.ID.buildingInfo.outdoor;
