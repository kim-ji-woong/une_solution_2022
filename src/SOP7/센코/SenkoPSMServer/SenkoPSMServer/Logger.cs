...
namespace SenkoPSMServer
{
    public class Logger
    {
        ...
        private Logger()
        {
            m_strLogFolder = ConfigurationManager.AppSettings["logFolder"].ToString();
            m_strLogTag = ConfigurationManager.AppSettings["logFileTag"].ToString();

            string strLifeTime = ConfigurationManager.AppSettings["logLifeTime"].ToString();
