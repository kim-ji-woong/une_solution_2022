...
namespace SVMSServer
{
    public class SVMSEventReceiver : IDisposable
    {
        ...
        {
            int nSiteID, nDBType;
            string strDBName, strHost, strID, strPW;
            ...
            if (ReadConfig(out nSiteID, out nDBType, out strDBName, out strHost, out strID, out strPW, svmsIPs, svmsPorts, svmsIDs, svmsPWs))
            {
                ...
                for (int i=0;i<nCount;i++)
                {
                    ...
                    receiver.m_dataManager = new DataManager(nDBType, strHost, strDBName, strID, strPW, nSiteID);
                    receiver.m_commonDataManager = new Common.DAL.DataManager(nDBType, strHost, strDBName, strID, strPW, nSiteID);
        ...
        private static bool ReadConfig(out int nSiteID, out int nDBType, out string strDBName, out string strHost, out string strID, out string strPW, List<string> svmsIPs, List<int> svmsPorts, List<string> svmsIDs, List<string> svmsPWs)
        {
            nSiteID = nDBType = 0;
            strHost = strID = strPW = strDBName = null;
