    ...
    public class WeeklyReader
    {
            ...
            try
            {
                ...
                if (weeklyData == null)
                {
                    if (m_dataManager.GetCreateManager().CreateWeekly(site.ID, weekly.OneDayLaterTemp, weekly.OneDayLaterState, weekly.TwoDayLaterTemp, weekly.TwoDayLaterState,
                        ...
                        weekly.SixDayLaterTemp, weekly.SixDayLaterState, DateTime.Now, 
                        weekly.OneDayLaterTemp, weekly.TwoDayLaterTemp, weekly.ThreeDayLaterTemp, weekly.FourDayLaterTemp, weekly.FiveDayLaterTemp, weekly.SixDayLaterTemp) == null)
                    {
                ...
                Current current = m_dataManager.GetSelectManager().SelectCurrent(site.ID, out strErrorMessage);
                    ...
                    nTodayState != (int)Current.WeatherState.Unknown)
                {
                    ...
                    if (m_dataManager.GetUpdateManager().UpdateCurrent(current, out strErrorMessage) == false)
                    {
        ...
        private Weekly MakeWeeklyData(CityData city, out int nTodayState, out string strErrorMessage)
        {
            ...
            try
            {
                ...
                if (city.VilageWeatherDatas.Count == 0)
                    return weekly;
