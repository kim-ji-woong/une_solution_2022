    ...
    */
    ...
    public static bool IsPSMSensorType(string strType)
    {
        ...
        if (strType == CommonString.PSM_HF ||
            ...
            strType == CommonString.PSM_ETHA ||
            strType == CommonString.PSM_DCS ||
            strType == CommonString.PSM_HI ||
            strType == CommonString.PSM_TMED ||
            strType == CommonString.PSM_DAP1 ||
            strType == CommonString.PSM_ANHY ||
            strType == CommonString.PSM_S1)
            return true;
        else
            return false;
    }
