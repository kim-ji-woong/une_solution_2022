export class GghJsonManager {
    ...
    static makeRequestUseParkingUplock() {
        const json = {
            "requestUseParkingUplock": true
        };

        return JSON.stringify(json);
    }

    static makeUpdateParkingUplock(use) {
        const json = {
            "updateParkingUplock": {
                "use": use
            }
    ...
    static makeRequestDownloadAlarmReport(sensorZoneHistoryIDs) {
        const json = {
            "requestAlarmReport": {
    ...
    static makeRequestDownloadSopReport(actionStepHistoryIDs) {
        const json = {
            "requestSopReport": {
                "actionStepHistoryIDs": actionStepHistoryIDs
            }
        };
