...
import sopManager_arrow_up from "../../Common/img/imgGyeonggi/sopManager_arrow_up.svg";
import sopManager_arrow_down from "../../Common/img/imgGyeonggi/sopManager_arrow_down.svg";
...
export const SopManagerContentComponent = styled(SopManagerCommon)`
    ...
    .aslWrap.typeC .salCont dd:nth-child(6) a:hover {
        background: ${(props) => props.$disabled === null ? 'none !important' : '#0c2159'};
        cursor: ${(props) => props.$disabled === null ? 'default !important' : 'pointer'};
    }

    .aslWrap.typeC .salCont dd {
        border: ${(props) => props.$menu === SopManagerResource.menu.새_SOP ? '1px solid #3764BA !important' : 'none'};
    }

    .aslWrap.typeC .salCont dd a {
        user-select: ${(props) => props.$menu === SopManagerResource.menu.새_SOP ? 'none !important' : 'all'};
        color: ${(props) => props.$menu === SopManagerResource.menu.새_SOP ? '#3764BA !important' : '#fff'};
        background: ${(props) => props.$menu === SopManagerResource.menu.새_SOP ? 'transparent !important' : 'rgba(0, 0, 0, 0.2)'};
    }

    .aslWrap.typeC .salCont dd a:hover {
        background: ${(props) => props.$menu === SopManagerResource.menu.새_SOP ? 'transparent !important' : '#0c2159'};
        cursor: ${(props) => props.$menu === SopManagerResource.menu.새_SOP ? 'default !important' : 'pointer'};
    }
...
export const NewSOPOptionsComponent = styled(SopManagerCommon)`
    ...
    .sopManagerDrop{
        ...
        button {
            ...
            &.on {
                border-bottom: solid 1px #345BBF;
            }
            ...
            span{
                ...
                width: 24px;
                height: 18px;
                background: url(${sopManager_arrow_down}) 95% 49% no-repeat;
