...
class SMComponentNavMenu extends Component {
    constructor(props)
    {
        ...
        this.state = {
            menuButtons:
                [
                    { isActive: true, dataType: "endpoint", menuName: SopManagerResource.component.endpoint },
                    { isActive: false, dataType: "process", menuName: SopManagerResource.component.process },
                    { isActive: false, dataType: "decision", menuName: SopManagerResource.component.decision },
                    { isActive: false, dataType: "annotation", menuName: SopManagerResource.component.annotation },
                    { isActive: false, dataType: "internal", menuName: SopManagerResource.component.internal },
                    { isActive: false, dataType: "none", menuName: SopManagerResource.common.none },
                    { isActive: false, dataType: "delete", menuName: SopManagerResource.delete }
                ],
        };
