...
import { SchedulePageConponent } from '../styled/TeamEditorStyled';
...
class SchedulePage extends Component {
	...
	render() {
		...
		if (this.props.scheduleType == TeamEditorResource.menu.고정_근무표) {

			return (
				<SchedulePageConponent id={'subCont'} >
					...
					<div className={'scWrap'}>
						<div className={'scCont'}>
							<div className={'scTop'}>
								...
								<div className={'scSec'}>
									...
									<div className={'scsRht'}>
										...
										<div className={'scAtcl' + " " + /*defaults.mt60*/"mt60"}>
										<h5>당직실 근무표</h5>
											<table className={'scTb'}>
							...
							<div className={'scCont' + " " + /*defaults.mt20*/"mt20" + " " + /*defaults.pd0*/"pd0"}>
		...
		} else if (this.props.scheduleType == TeamEditorResource.menu.실시간_근무표) {
			return null;
		} else {
			return null;
        }
...
export default withTranslation()(SchedulePage);