								...
								<div className={styles.scpRht}>
									<div className={styles.scprTop + " " + uneStyles.scprTop}>
										...
										<div className={teamEditors.scprTopForm}>
											<input id="searchManager" type="text" placeholder={i18n.t('teamEditor.formText.검색어 입력')} title={i18n.t('teamEditor.formText.검색어 입력')} onKeyPress={(e) => this.onKeyPressSearch(e)} />
									...
									<div className={teamEditors.scrollbar} style={{ height: menuHeight }} >
										<div className={styles.scprCont}>
											<table className={styles.scprTb}>
												...
												<thead>
													<tr>
														<th>{i18n.t('teamEditor.formText.선택')}</th>
														...
														<th>{i18n.t('teamEditor.formText.사번')}</th>
													</tr>
												</thead>
												<tbody>
									...
									<div className={styles.scprBot + " " + uneStyles.scprBot}>
										<a onClick={this.onClickSelect} className={styles.red + " " + uneStyles.navy}>{i18n.t('teamEditor.formText.선택')}</a>
										<a onClick={this.onClickClose}>{i18n.t('common.취소')}</a>
									</div>
								</div>
							</div>
						</div>
