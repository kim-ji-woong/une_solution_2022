...
export class AccountController {
    ...
    */
    ...
    static async checkSSOLogin(code) {
        try {
            const res = await fetch('/Account/Account/CheckSSOLogin', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [false, "checkSSOLogin 호출이 실패하였습니다."];
    }

    static async requestSSOUrl() {
        try {
            const res = await fetch('/Account/Account/RequestSSOUrl', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [false, "requestSSOUrl 호출이 실패하였습니다."];
    }
