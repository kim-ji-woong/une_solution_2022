...
class SensorDetectHistory extends Component {
	...
	async display() {
		...
		const result = await HistoryController.DisplaySensorDetectAnalysis(beginDate, endDate, this.state.facilityType, buildingGroupID, buildingID, zoneID, this.props.selectedSiteID, this.getSearchOption(this.props.selectedSiteID));
		if (!result) {
			$("body").css("cursor", "default");
