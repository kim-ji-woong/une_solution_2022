...
const SopCommon = {
    ...
    Hydrogen: {
        ...
        backgroundColor3: '#0E212A',
        backgroundColor4: '#00AFFF',
        backgroundColor5: '#0E212A',
        backgroundColor6: '#000F15',
        listLiAFontSize: '14px',
        listddBorderBottom: 'dashed 1px #525868',
        listDDpadding: '0',
        sectionSkipBorder: 'solid 3px #00AFFF',
        numListBackgroundColor: '#0E212A',
        innerSectionnnBackground: '#0E212A',
    },
    Gyeonggi: {
        textColor1: '#5398FF',
        textColor2: '#5398FF',
...
export const _AppContainer = {
    ...
    Hydrogen: {
        divHeight: '100%',
        divPadding: '0 40px',
        divBackground: '#2D3E46',
        appContainerdivPaddingTop: '10px',
...
export const _SubSectionMenualListWrap = {
    ...
    Hydrogen: {
        ...
        sectionBorder: 'none',
        sectionMenualListWrapBackground: '#0E212A',
...
export const SubSectionMenualListWrap = styled.section`
    ...
    height: ${_SubSectionMenualListWrap[PR.styleMode].sectionHeight};
...
export const _SubSectionBoardListWrap = {
    ...
    Hydrogen: {
        ...
        sectionBoardListWrapHeight: 'calc(100% - 60px) !important',
        sectionBorderRadius: '0',
        sectionBoardListWrapMarginTop: '33px',
        sectionBoardListWrapWidth: 'calc(100% - 340px)',
        sectionBoardListWrapPadding: '13px 35px',
        sectionBoardListWrapFontWeight: '200',
        ...
        sectionBoardListWrapBackground: '#0E212A',
    },
    Gyeonggi: {
        sectionFloat: 'left',
        sectionHeight: 'calc(100% + 5px)',
...
export const SubSectionProgressHistoryWrap = styled.section`
    ...
    .numList .btnList:after {
        ...
        border-color:#8b919a transparent transparent transparent;
...
export const _SectionPanelComponent = {
    ...
    Hydrogen: {
        selectedComponentBackground: `#00AFFF`,
        selectedComponentBorder: `var(--sizeBorderLine) solid #00AFFF`,
    },
    Gyeonggi: {
        selectedComponentBackground: `#5398FF`,
        selectedComponentBorder: `var(--sizeBorderLine) solid #5398FF`,
...
export const _SubSectionTaskListWrap = {
    ...
    Hydrogen: {
        sectionCurrentBackgroundColor: '#00AFFF',
        currentBoxBorderColor: 'solid 2px #00AFFF',
