...
import { DecisionSectionBox } from '../../styled/missionsStyled';
    ...
    render() {
        ...
        return (
            <DecisionSectionBox className={'sectionBox' + " "  + boxClassName} id={this.props.id}>
                <div className={'tit hasFire' + textClassName}>    
                    <select className={'choiceBox'} name="" id="" onChange={(e) => this.onChangeValue(e)} >
                        {arrowTexts}
                    </select>
                    <strong>{this.props.sectionData.sectionNumber}.{i18nUtil.convertText(this.props.sectionData.text)}</strong>
                    {
                        /*
...
export default withTranslation()(Decision);