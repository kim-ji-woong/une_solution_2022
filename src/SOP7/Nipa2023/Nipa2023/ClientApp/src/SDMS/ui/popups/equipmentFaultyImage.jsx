...
class EquipmentFaultyImage extends Component {
    constructor(props) {
        super(props);
    ...
    initPopupState() {
        var popup = document.getElementsByClassName('UI_Section equipmentFaultyImage')[0];
    ...
    getDisplayView = () => {
        let gridUI = [];
        const alarm = this.props.selectedFacilityAlarm;
    ...
    render() {
        ...
        return (
            <EquipmentFaultyImageComponent id={this.props.popupType} className='UI_Section equipmentFaultyImage'>
                <PopupDraggable
                ...
                >
                    <div className={'dslTop'}>
                        ...
                        <div className={'dslX'} onClick={() => this.props.setVisiblePopups(Monitoring.menu.equipmentFaultyImage, false)}>
                            <a href="#none">닫기버튼</a>
                        </div>
                    </div>
...
export default EquipmentFaultyImage;