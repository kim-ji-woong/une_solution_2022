...
/*    watermarkplay() {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.currentSection !== this.props.currentSection) {
            ...
            // 실행중인 컴포넌트로 자동 화면 이동
            if (this.props.optionSopNormal.useAutoMoveSOPScreen) {
    ...
    showConfirmDialog() {
        ...
        if(userInfo && userInfo !== null && (parseInt(userInfo.levelID) === AccountResource.accountLevelID.master || parseInt(userInfo.levelID) === AccountResource.accountLevelID.generalAdmin)) {
            this.props.showConfirmDialog(['실행중인 SOP는 종료 후 수정 할 수 있습니다.', '종료할까요 ?'], ['종료 후 열기', '종료하지 않고 열기', '취소'], this.onClickEditSOP, 'error');
        } 
        else {
