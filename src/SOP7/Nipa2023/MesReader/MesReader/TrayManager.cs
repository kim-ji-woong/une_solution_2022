...
namespace MesReader
{
    ...
    public class TrayManager
    {
        ...
        private void OnTimer(object sender, EventArgs e)
        {
            ...
            if (m_dataManager.Read(out strErrorMessage) == false)
                System.Diagnostics.Trace.WriteLine("DataManager.Read Fail : " + strErrorMessage);
        }
        ...
        private void CreateNotifyicon()
        {
            ...
            m_icon.Icon = global::MesReader.Resource1.SDMS_BLUE;
